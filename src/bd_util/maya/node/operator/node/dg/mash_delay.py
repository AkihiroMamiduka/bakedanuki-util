...
from ...attr.define.node_attr.mash_delay import (
    FalloffObjectField,
    MColourField,
    TranslateInPPField,
    TranslateOutPPField,
...
class DelayModeEnumField(
    EnumField[DelayModeEnumAttrOperator, DelayModeEnumPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = DelayModeEnumAttrOperator
