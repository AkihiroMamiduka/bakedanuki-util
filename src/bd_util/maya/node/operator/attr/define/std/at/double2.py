...
class Double2PlugOperator(FloatingPointBasePlugOperator[A]):
    __slots__ = ()
...
class Double2AttrOperator(FloatingPointBaseAttrOperator[P]):
    __slots__ = ()

    ATTR_TYPE = "double2"


class Double2Field(FloatingPointBaseField[A, P]):
    __slots__ = ()
