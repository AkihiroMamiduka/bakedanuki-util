...
class AltTranslateInPPPlugOperator(
    CompoundPlugOperator["AltTranslateInPPAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("altPositionInPP", "altPositionInPP"),
        ("altScaleInPP", "altScaleInPP"),
        ("altRotationInPP", "altRotationInPP"),
        ("altIdInPP", "altIdInPP"),
        ("altVisibilityInPP", "altVisibilityInPP"),
    )

    altPositionInPP = DataVectorArrayField()

    altScaleInPP = DataVectorArrayField()

    altRotationInPP = DataVectorArrayField()

    altIdInPP = DataVectorArrayField()

    altVisibilityInPP = DataVectorArrayField()


class AltTranslateInPPAttrOperator(
    CompoundAttrOperator[AltTranslateInPPPlugOperator]
):
    __slots__ = ()
...
class AltTranslateInPPField(
    CompoundField[AltTranslateInPPAttrOperator, AltTranslateInPPPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = AltTranslateInPPAttrOperator
    PLUG_CLS = AltTranslateInPPPlugOperator
