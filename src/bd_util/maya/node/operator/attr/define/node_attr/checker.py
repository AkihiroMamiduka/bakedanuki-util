...
class Color1PlugOperator(
    ...
    color1R = FloatField(default_value=1.0, min_value=0.0, max_value=1.0)
    c1r = color1R

    color1G = FloatField(default_value=1.0, min_value=0.0, max_value=1.0)
    c1g = color1G

    color1B = FloatField(default_value=1.0, min_value=0.0, max_value=1.0)
    c1b = color1B
...
class Color2PlugOperator(
    ...
    color2R = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    c2r = color2R

    color2G = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    c2g = color2G

    color2B = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    c2b = color2B
