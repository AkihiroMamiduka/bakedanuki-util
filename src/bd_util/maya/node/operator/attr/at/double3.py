...
class Double3PlugOperator(FloatingPointBasePlugOperator[A]):
    __slots__ = ()
...
class Double3AttrOperator(FloatingPointBaseAttrOperator[P]):
    __slots__ = ()

    ATTR_TYPE = "double3"


class Double3Field(FloatingPointBaseField[A, P]):
    __slots__ = ()
