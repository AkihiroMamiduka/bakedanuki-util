...
class Float3PlugOperator(FloatingPointBasePlugOperator[A]):
    __slots__ = ()
...
class Float3AttrOperator(FloatingPointBaseAttrOperator[P]):
    __slots__ = ()

    ATTR_TYPE = "float3"


class Float3Field(FloatingPointBaseField[A, P]):
    __slots__ = ()
