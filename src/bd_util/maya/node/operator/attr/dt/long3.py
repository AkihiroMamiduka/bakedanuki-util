...
class DataLong3PlugOperator(DataNumericBasePlugOperator[A]):
    __slots__ = ()
...
class DataLong3AttrOperator(DataNumericBaseAttrOperator[P]):
    __slots__ = ()

    DATA_TYPE = "long3"
    PLUG_CLS = cast(Type[P], DataLong3PlugOperator)
