...
from ....attr.define.node_attr_maya2026.hardware_rendering_globals import (
...
class GeneratedHardwareRenderingGlobals(DG):
    ...
    enableTextureIblMaxRes = BoolField(default_value=False)
    eimr = enableTextureIblMaxRes

    textureIblMaxResolution = LongField(
        default_value=2048, min_value=32, max_value=32768, soft_max_value=8192
    )
    tir = textureIblMaxResolution
