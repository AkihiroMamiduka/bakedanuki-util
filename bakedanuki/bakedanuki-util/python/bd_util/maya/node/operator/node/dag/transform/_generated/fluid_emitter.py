...
class EmitterTypeEnumPlugOperator(
    EnumPlugOperator["EmitterTypeEnumAttrOperator"]
):
    __slots__ = ()
...
class EmitterTypeEnumAttrOperator(
    EnumAttrOperator[EmitterTypeEnumPlugOperator]
):
    __slots__ = ()
...
class CycleEmissionEnumPlugOperator(
    EnumPlugOperator["CycleEmissionEnumAttrOperator"]
):
    __slots__ = ()
...
class CycleEmissionEnumAttrOperator(
    EnumAttrOperator[CycleEmissionEnumPlugOperator]
):
    __slots__ = ()
...
class HeatMethodEnumPlugOperator(
    EnumPlugOperator["HeatMethodEnumAttrOperator"]
):
    __slots__ = ()
...
class HeatMethodEnumAttrOperator(EnumAttrOperator[HeatMethodEnumPlugOperator]):
    __slots__ = ()
...
class SpeedMethodEnumPlugOperator(
    EnumPlugOperator["SpeedMethodEnumAttrOperator"]
):
    __slots__ = ()
...
class SpeedMethodEnumAttrOperator(
    EnumAttrOperator[SpeedMethodEnumPlugOperator]
):
    __slots__ = ()
...
class StartFrameEmissionEnumPlugOperator(
    EnumPlugOperator["StartFrameEmissionEnumAttrOperator"]
):
    __slots__ = ()
...
class StartFrameEmissionEnumAttrOperator(
    EnumAttrOperator[StartFrameEmissionEnumPlugOperator]
):
    __slots__ = ()
...
class StartFrameEmissionEnumField(
    EnumField[
        StartFrameEmissionEnumAttrOperator, StartFrameEmissionEnumPlugOperator
    ]
):
    __slots__ = ()
...
class GeneratedFluidEmitter(Transform):
    __slots__ = ()
    ...
    rate = DoubleField(
        default_value=100.0, min_value=0.0, soft_max_value=500.0
    )
    rat = rate
    ...
    speedRandom = DoubleField(
        default_value=0.0, min_value=0.0, soft_max_value=10.0
    )
    srnd = speedRandom

    tangentSpeed = DoubleField(
        default_value=0.0, soft_min_value=0.0, soft_max_value=10.0
    )
    tspd = tangentSpeed

    normalSpeed = DoubleField(
        default_value=1.0, soft_min_value=0.0, soft_max_value=10.0
    )
    nspd = normalSpeed
    ...
    fluidDensityEmission = DoubleField(
