...
from ....attr.define.node_attr_maya2026.ai_passthrough import (
    Eval10Field,
    Eval11Field,
    Eval12Field,
    Eval13Field,
...
class GeneratedAiPassthrough(DG):
    ...
    eval8A = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    eval8a = eval8A
    ...
    eval12A = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    eval12a = eval12A
    ...
    eval16A = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    eval16a = eval16A
    ...
    eval19A = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    eval19a = eval19A
    ...
    eval20A = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    eval20a = eval20A
