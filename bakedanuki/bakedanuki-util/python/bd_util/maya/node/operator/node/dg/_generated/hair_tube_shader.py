...
from ....attr.define.node_attr.hair_tube_shader import (
    AmbientColorField,
    ColorField,
    ColorScaleField,
    HardwareShaderField,
...
class GeneratedHairTubeShader(DG):
    ...
    specularShift = FloatField(
        default_value=5.0, soft_min_value=0.0, soft_max_value=20.0
    )
    ssh = specularShift

    scatterPower = FloatField(
        default_value=5.0, min_value=2.0, soft_max_value=50.0
    )
    scp = scatterPower
