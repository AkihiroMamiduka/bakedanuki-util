...
class CompositingFlagEnumPlugOperator(
    EnumPlugOperator["CompositingFlagEnumAttrOperator"]
):
    __slots__ = ()
...
class CompositingFlagEnumAttrOperator(
    EnumAttrOperator[CompositingFlagEnumPlugOperator]
):
    __slots__ = ()
