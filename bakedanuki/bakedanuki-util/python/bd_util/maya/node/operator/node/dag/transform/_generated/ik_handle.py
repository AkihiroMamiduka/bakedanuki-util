...
class StickinessEnumPlugOperator(
    EnumPlugOperator["StickinessEnumAttrOperator"]
):
    __slots__ = ()
...
class StickinessEnumAttrOperator(EnumAttrOperator[StickinessEnumPlugOperator]):
    __slots__ = ()
...
class TwistTypeEnumPlugOperator(EnumPlugOperator["TwistTypeEnumAttrOperator"]):
    __slots__ = ()
...
class TwistTypeEnumAttrOperator(EnumAttrOperator[TwistTypeEnumPlugOperator]):
    __slots__ = ()
...
class DWorldUpTypeEnumPlugOperator(
    EnumPlugOperator["DWorldUpTypeEnumAttrOperator"]
):
    __slots__ = ()
...
class DWorldUpTypeEnumAttrOperator(
    EnumAttrOperator[DWorldUpTypeEnumPlugOperator]
):
    __slots__ = ()
...
class DForwardAxisEnumPlugOperator(
    EnumPlugOperator["DForwardAxisEnumAttrOperator"]
):
    __slots__ = ()
...
class DForwardAxisEnumAttrOperator(
    EnumAttrOperator[DForwardAxisEnumPlugOperator]
):
    __slots__ = ()
...
class DWorldUpAxisEnumPlugOperator(
    EnumPlugOperator["DWorldUpAxisEnumAttrOperator"]
):
    __slots__ = ()
...
class DWorldUpAxisEnumAttrOperator(
    EnumAttrOperator[DWorldUpAxisEnumPlugOperator]
):
    __slots__ = ()
...
class DTwistValueTypeEnumPlugOperator(
    EnumPlugOperator["DTwistValueTypeEnumAttrOperator"]
):
    __slots__ = ()
...
class DTwistValueTypeEnumAttrOperator(
    EnumAttrOperator[DTwistValueTypeEnumPlugOperator]
):
    __slots__ = ()
...
class GeneratedIkHandle(Transform):
    __slots__ = ()
