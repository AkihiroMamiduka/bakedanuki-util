...
from ....attr.define.node_attr_maya2026.ai_standard_hair import (
    AiMatteColorField,
    AiTransparencyField,
    BaseColorField,
    DiffuseColorField,
...
class ScatteringModeEnumPlugOperator(
    EnumPlugOperator["ScatteringModeEnumAttrOperator"]
):
    __slots__ = ()
...
class ScatteringModeEnumAttrOperator(
    EnumAttrOperator[ScatteringModeEnumPlugOperator]
):
    __slots__ = ()
...
class ScatteringModeEnumField(
    EnumField[ScatteringModeEnumAttrOperator, ScatteringModeEnumPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = ScatteringModeEnumAttrOperator
    PLUG_CLS = ScatteringModeEnumPlugOperator
...
class GeneratedAiStandardHair(DG):
    ...
    scatteringMode = ScatteringModeEnumField(default_value=0)
