...
class _GeneratedPolyQuad(DG):
    ...
    keepGroupBorder = BoolField(default_value=True)
    kgb = keepGroupBorder

    keepTextureBorders = BoolField(default_value=True)
    ktb = keepTextureBorders

    keepHardEdges = BoolField(default_value=True)
    khe = keepHardEdges

    maya80 = BoolField(default_value=True)
    m80 = maya80
