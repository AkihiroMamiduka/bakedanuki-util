...
from ....attr.define.node_attr_maya2026.ai_ray_switch import (
    CameraField,
...
class GeneratedAiRaySwitch(DG):
    ...
    cameraA = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    cameraa = cameraA
    ...
    shadowA = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    shadowa = shadowA
    ...
    volumeA = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    volumea = volumeA
