...
from .....attr.define.node_attr_maya2026.ai_photometric_light import (
    AiShadowColorField,
    ColorField,
...
class GeneratedAiPhotometricLight(Shape):
    __slots__ = ()

    NODE_TYPE = "aiPhotometricLight"
    ...
    coneAngle = DoubleField(default_value=120.0)
    ca = coneAngle

    penumbraAngle = DoubleField(default_value=20.0)
    pa = penumbraAngle
