...
from .....attr.define.node_attr_maya2026.volume_light import (
    ColorField,
    ColorRangeField,
    FarPointWorldField,
    LightDataValueField,
...
class LightShapeEnumPlugOperator(
    EnumPlugOperator["LightShapeEnumAttrOperator"]
):
    __slots__ = ()
...
class LightShapeEnumAttrOperator(EnumAttrOperator[LightShapeEnumPlugOperator]):
    __slots__ = ()
...
class LightShapeEnumField(
    EnumField[LightShapeEnumAttrOperator, LightShapeEnumPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = LightShapeEnumAttrOperator
    PLUG_CLS = LightShapeEnumPlugOperator


class VolumeLightDirEnumPlugOperator(
    EnumPlugOperator["VolumeLightDirEnumAttrOperator"]
):
    __slots__ = ()
...
class VolumeLightDirEnumAttrOperator(
    EnumAttrOperator[VolumeLightDirEnumPlugOperator]
):
    __slots__ = ()
...
class VolumeLightDirEnumField(
    EnumField[VolumeLightDirEnumAttrOperator, VolumeLightDirEnumPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = VolumeLightDirEnumAttrOperator
    PLUG_CLS = VolumeLightDirEnumPlugOperator


class FaceAxisEnumPlugOperator(EnumPlugOperator["FaceAxisEnumAttrOperator"]):
    __slots__ = ()
...
class FaceAxisEnumAttrOperator(EnumAttrOperator[FaceAxisEnumPlugOperator]):
    __slots__ = ()
...
class FaceAxisEnumField(
    EnumField[FaceAxisEnumAttrOperator, FaceAxisEnumPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = FaceAxisEnumAttrOperator
    PLUG_CLS = FaceAxisEnumPlugOperator


class AiSamplingModeEnumPlugOperator(
    EnumPlugOperator["AiSamplingModeEnumAttrOperator"]
):
    __slots__ = ()
...
class AiSamplingModeEnumAttrOperator(
    EnumAttrOperator[AiSamplingModeEnumPlugOperator]
):
    __slots__ = ()
...
class AiSamplingModeEnumField(
    EnumField[AiSamplingModeEnumAttrOperator, AiSamplingModeEnumPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = AiSamplingModeEnumAttrOperator
    PLUG_CLS = AiSamplingModeEnumPlugOperator


class GeneratedVolumeLight(Shape):
    __slots__ = ()

    NODE_TYPE = "volumeLight"
    ...
    lightShape = LightShapeEnumField(default_value=1)
    lis = lightShape

    volumeLightDir = VolumeLightDirEnumField(default_value=0)
    vld = volumeLightDir

    faceAxis = FaceAxisEnumField(default_value=1)
    faxs = faceAxis

    arc = FloatField(default_value=360.0, min_value=0.0, max_value=360.0)
    ac = arc

    coneEndRadius = FloatField(
        default_value=0.0, soft_min_value=0.0, soft_max_value=2.0
    )
    cer = coneEndRadius

    colorRange = ColorRangeField(multi=True)
    crg = colorRange

    penumbra = PenumbraField(multi=True, default_value=(0.0, 0.0, 0))
    pen = penumbra

    emitAmbient = BoolField(default_value=False)
    ema = emitAmbient

    lightAngle = FloatField(
    ...
    aiSamplingMode = AiSamplingModeEnumField(
        default_value=0, category="arnold"
    )
    ai_sampling_mode = aiSamplingMode
