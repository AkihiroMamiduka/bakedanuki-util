...
from ....attr.define.node_attr_maya2026.open_pbr_surface import (
    AiId1Field,
    AiId2Field,
    AiId3Field,
    AiId4Field,
...
class GeneratedOpenPBRSurface(DG):
    __slots__ = ()
    ...
    sa = specularRoughnessAnisotropy

    transmissionWeight = FloatField(
        default_value=0.0, min_value=0.0, max_value=1.0
    )
    t = transmissionWeight
    ...
    tdi = transmissionDispersionScale
    ...
    tdan = transmissionDispersionAbbeNumber

    subsurfaceWeight = FloatField(
        default_value=0.0, min_value=0.0, max_value=1.0
    )
    sub = subsurfaceWeight
    ...
    suba = subsurfaceScatterAnisotropy
    ...
    aiTransmitAovs = BoolField(default_value=False, category="arnold")
    ai_transmit_aovs = aiTransmitAovs

    aiTransmissionShadowDensity = FloatField(
        default_value=0.5, min_value=0.0, max_value=1.0, category="arnold"
    )
    ai_transmission_shadow_density = aiTransmissionShadowDensity
