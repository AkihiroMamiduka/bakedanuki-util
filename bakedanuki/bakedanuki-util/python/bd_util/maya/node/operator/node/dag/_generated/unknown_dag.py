...
from ....attr.define.node_attr.unknown_dag import (
    BoundingBoxField,
    CenterField,
    DrawOverrideField,
    GhostColorPostField,
...
class GeneratedUnknownDag(DAG):
    __slots__ = ()

    NODE_TYPE = "unknownDag"
    ...
    renderInfo = RenderInfoField(default_value=(0, True, 0))
    ri = renderInfo
    ...
    renderLayerInfo = RenderLayerInfoField(
        multi=True, default_value=(0, True, 0)
    )
    ...
    ghostCustomSteps = GhostCustomStepsField(default_value=(3, 3, 1))
