...
from .....attr.define.node_attr_maya2026.ai_mesh_light import (
    AiShadowColorField,
    ColorField,
...
class GeneratedAiMeshLight(Shape):
    __slots__ = ()

    NODE_TYPE = "aiMeshLight"
    ...
    showOriginalMesh = BoolField(default_value=False)
    ...
    lightVisible = BoolField(default_value=False)
