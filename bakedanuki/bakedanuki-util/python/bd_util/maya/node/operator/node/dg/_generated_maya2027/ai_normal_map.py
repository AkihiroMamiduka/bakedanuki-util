...
from ....attr.define.node_attr_maya2027.ai_normal_map import (
    InputField,
    NormalField,
...
class TangentSpaceTypeEnumPlugOperator(
    EnumPlugOperator["TangentSpaceTypeEnumAttrOperator"]
):
    __slots__ = ()
...
class TangentSpaceTypeEnumAttrOperator(
    EnumAttrOperator[TangentSpaceTypeEnumPlugOperator]
):
    __slots__ = ()
...
class TangentSpaceTypeEnumField(
    EnumField[
        TangentSpaceTypeEnumAttrOperator, TangentSpaceTypeEnumPlugOperator
    ]
):
    __slots__ = ()

    ATTR_CLS = TangentSpaceTypeEnumAttrOperator
    PLUG_CLS = TangentSpaceTypeEnumPlugOperator
...
class GeneratedAiNormalMap(DG):
    ...
    tangentSpaceType = TangentSpaceTypeEnumField(default_value=0)
    tangent_space_type = tangentSpaceType
