...
class GeneratedWire(DG):
    ...
    wireLocatorPercentage = FloatField(
        multi=True,
        default_value=1.0,
        min_value=0.0,
        max_value=1.0,
    ...
    wireLocatorEnvelope = FloatField(
        multi=True, default_value=1.0, soft_min_value=0.0, soft_max_value=2.0
    )
    wle = wireLocatorEnvelope

    wireLocatorTwist = FloatAngleField(
        multi=True,
        default_value=0.0,
        soft_min_value=-10313.240312354817,
        soft_max_value=10313.240312354817,
    )
