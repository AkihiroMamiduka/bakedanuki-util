...
from .....attr.define.node_attr_maya2026.ai_volume import (
...
class PointsModeEnumPlugOperator(
    EnumPlugOperator["PointsModeEnumAttrOperator"]
):
    __slots__ = ()
...
class PointsModeEnumAttrOperator(EnumAttrOperator[PointsModeEnumPlugOperator]):
    __slots__ = ()
...
class PointsModeEnumField(
    EnumField[PointsModeEnumAttrOperator, PointsModeEnumPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = PointsModeEnumAttrOperator
    PLUG_CLS = PointsModeEnumPlugOperator
...
class GeneratedAiVolume(Shape):
    ...
    pointsAttributePoint = DataStringField()

    pointsAttributeRadius = DataStringField()

    pointsAttributeVelocity = DataStringField()

    pointsMode = PointsModeEnumField(default_value=0)

    pointsMinPixelWidth = FloatField(default_value=0.0)
