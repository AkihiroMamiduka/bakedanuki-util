...
from .....attr.define.node_attr_maya2027.bezier_curve import (
    AiCurveShaderField,
    ColorSetField,
...
class AnchorSmoothnessEnumPlugOperator(
    EnumPlugOperator["AnchorSmoothnessEnumAttrOperator"]
):
    __slots__ = ()
...
class AnchorSmoothnessEnumAttrOperator(
    EnumAttrOperator[AnchorSmoothnessEnumPlugOperator]
):
    __slots__ = ()
...
class AnchorSmoothnessEnumField(
    EnumField[
        AnchorSmoothnessEnumAttrOperator, AnchorSmoothnessEnumPlugOperator
    ]
):
    __slots__ = ()
...
class AnchorWeightingEnumPlugOperator(
    EnumPlugOperator["AnchorWeightingEnumAttrOperator"]
):
    __slots__ = ()
...
class AnchorWeightingEnumAttrOperator(
    EnumAttrOperator[AnchorWeightingEnumPlugOperator]
):
    __slots__ = ()
...
class GeneratedBezierCurve(Shape):
    __slots__ = ()
