...
class _GeneratedAnimBlendNodeAdditiveDA(DG):
    __slots__ = ()
    ...
    inputA = DoubleAngleField(default_value=0.0)
    ia = inputA

    inputB = DoubleAngleField(default_value=0.0)
    ib = inputB

    output = DoubleAngleField(default_value=0.0)
    o = output
