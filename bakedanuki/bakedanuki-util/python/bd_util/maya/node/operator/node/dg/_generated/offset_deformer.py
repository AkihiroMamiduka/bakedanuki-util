...
from ....attr.define.node_attr.offset_deformer import (
...
class _GeneratedOffsetDeformer(DG):
    __slots__ = ()

    NODE_TYPE = "offsetDeformer"
    ...
    numTasks = LongField(default_value=32, min_value=1)
