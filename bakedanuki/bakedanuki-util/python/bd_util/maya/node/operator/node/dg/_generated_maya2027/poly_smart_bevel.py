...
class GeneratedPolySmartBevel(DG):
    ...
    cutbackRelaxation = FloatField(
        default_value=0.25, min_value=0.0, max_value=1.0
    )
    cbr = cutbackRelaxation

    sequenceSmoothingIterationLimit = LongField(
        default_value=2500, min_value=0, max_value=10000
    )
    ...
    removeIsolatedArcs = BoolField(default_value=True)
    ria = removeIsolatedArcs

    weldOpposingArcs = FloatLinearField(
        default_value=0.0, min_value=0.0, soft_max_value=2.0
    )
    woa = weldOpposingArcs

    weldAllArcs = FloatLinearField(
        default_value=0.0, min_value=0.0, soft_max_value=2.0
    )
    waa = weldAllArcs
