...
from .....attr.define.node_attr_maya2026.area_light import (
    ColorField,
    LightDataValueField,
    NormalCameraField,
...
class GeneratedAreaLight(Shape):
    __slots__ = ()
    ...
    width = FloatField(default_value=0.0)
    wd = width

    height = FloatField(default_value=0.0)
    ht = height

    normalize = BoolField(default_value=True)
    nrm = normalize

    legacyIntensity = BoolField(default_value=False)
    lgi = legacyIntensity
