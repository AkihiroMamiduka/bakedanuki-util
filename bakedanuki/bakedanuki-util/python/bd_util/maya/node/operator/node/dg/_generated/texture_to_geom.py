...
class GeneratedTextureToGeom(DG):
    ...
    maxColorDiff = FloatField(
        default_value=0.125, min_value=9.999999747378752e-06, max_value=0.5
    )
    mcd = maxColorDiff

    minSegmentSize = FloatField(
        default_value=0.004999999888241291, min_value=0.0, max_value=1.0
    )
    msz = minSegmentSize
    ...
    smoothFactor = FloatField(
        ...
        max_value=0.9999900000002526,
    )
    smf = smoothFactor

    fitTolerance = FloatField(
        default_value=0.007000000216066837, min_value=0.0, max_value=4.0
    )
    ft = fitTolerance
    ...
    hardCornerMaxLength = FloatField(
        default_value=10.0, min_value=10.0, max_value=100.0
    )
    ...
    simplifyThreshold = DoubleField(
        default_value=1e-10, min_value=1e-10, max_value=1.0
    )
