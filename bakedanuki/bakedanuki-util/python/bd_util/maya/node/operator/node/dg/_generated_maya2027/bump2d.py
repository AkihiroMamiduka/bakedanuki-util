...
from ....attr.define.node_attr_maya2027.bump2d import (
    NormalCameraField,
    OutNormalField,
    PointCameraField,
    PointObjField,
...
class AiTangentSpaceTypeEnumPlugOperator(
    EnumPlugOperator["AiTangentSpaceTypeEnumAttrOperator"]
):
    __slots__ = ()
...
class AiTangentSpaceTypeEnumAttrOperator(
    EnumAttrOperator[AiTangentSpaceTypeEnumPlugOperator]
):
    __slots__ = ()
...
class AiTangentSpaceTypeEnumField(
    EnumField[
        AiTangentSpaceTypeEnumAttrOperator, AiTangentSpaceTypeEnumPlugOperator
    ]
):
    __slots__ = ()

    ATTR_CLS = AiTangentSpaceTypeEnumAttrOperator
    PLUG_CLS = AiTangentSpaceTypeEnumPlugOperator
...
class GeneratedBump2d(DG):
    ...
    aiTangentSpaceType = AiTangentSpaceTypeEnumField(
        default_value=0, category="arnold"
    )
    ai_tangent_space_type = aiTangentSpaceType
