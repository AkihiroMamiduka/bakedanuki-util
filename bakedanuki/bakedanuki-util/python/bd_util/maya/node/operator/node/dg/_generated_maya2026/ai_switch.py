...
from ....attr.define.node_attr_maya2026.ai_switch import (
    HardwareColorField,
    Input0Field,
    Input10Field,
    Input11Field,
...
class GeneratedAiSwitch(DG):
    ...
    input0A = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    input0a = input0A
    ...
    input1A = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    input1a = input1A
    ...
    input2A = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    input2a = input2A
    ...
    input4A = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    input4a = input4A
    ...
    input5A = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    input5a = input5A
    ...
    input7A = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    input7a = input7A
    ...
    input9A = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    input9a = input9A
    ...
    input10A = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    input10a = input10A
    ...
    input11A = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    input11a = input11A
    ...
    input12A = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    input12a = input12A
    ...
    input13A = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    input13a = input13A
    ...
    input14A = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    input14a = input14A
    ...
    input15A = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    input15a = input15A
    ...
    input16A = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    input16a = input16A
    ...
    input17A = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    input17a = input17A
    ...
    input18A = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    input18a = input18A
    ...
    input19A = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    input19a = input19A
