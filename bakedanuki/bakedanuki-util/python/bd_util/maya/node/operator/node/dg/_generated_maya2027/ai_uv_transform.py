...
from ....attr.define.node_attr_maya2027.ai_uv_transform import (
    CoverageField,
    NoiseField,
    OffsetField,
    OutColorField,
...
class SpaceEnumPlugOperator(EnumPlugOperator["SpaceEnumAttrOperator"]):
    __slots__ = ()
...
class SpaceEnumAttrOperator(EnumAttrOperator[SpaceEnumPlugOperator]):
    __slots__ = ()
...
class SpaceEnumField(EnumField[SpaceEnumAttrOperator, SpaceEnumPlugOperator]):
    __slots__ = ()

    ATTR_CLS = SpaceEnumAttrOperator
    PLUG_CLS = SpaceEnumPlugOperator
...
class GeneratedAiUvTransform(DG):
    ...
    space = SpaceEnumField(default_value=0)
