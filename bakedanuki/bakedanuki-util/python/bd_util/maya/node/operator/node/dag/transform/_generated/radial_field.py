...
from .....attr.define.node_attr.radial_field import (
    AxialMagnitudeField,
    CurveRadiusField,
    FalloffCurveField,
    InputDataField,
...
class GeneratedRadialField(Transform):
    __slots__ = ()

    NODE_TYPE = "radialField"
    ...
    radialType = DoubleField(default_value=0.0, min_value=0.0, max_value=1.0)
    typ = radialType
