...
from ....attr.define.node_attr.result_curve_time_to_time import (
    CurveColorField,
    KeyTimeValueField,
)
...
class GeneratedResultCurveTimeToTime(DG):
    __slots__ = ()

    NODE_TYPE = "resultCurveTimeToTime"
    ...
    inputResult = TimeField(default_value=0.0)
    ir = inputResult
