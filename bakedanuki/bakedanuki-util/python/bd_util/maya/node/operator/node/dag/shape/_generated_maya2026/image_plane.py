...
from .....attr.define.node_attr_maya2026.image_plane import (
...
class GeneratedImagePlane(Shape):
    __slots__ = ()

    NODE_TYPE = "imagePlane"
    ...
    flipInX = BoolField(default_value=False)
    fix = flipInX

    flipInY = BoolField(default_value=False)
    fiy = flipInY
