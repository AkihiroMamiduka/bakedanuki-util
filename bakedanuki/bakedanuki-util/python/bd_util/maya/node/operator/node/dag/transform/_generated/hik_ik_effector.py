...
class PinningEnumPlugOperator(EnumPlugOperator["PinningEnumAttrOperator"]):
    __slots__ = ()
...
class PinningEnumAttrOperator(EnumAttrOperator[PinningEnumPlugOperator]):
    __slots__ = ()
...
class MarkerLookEnumPlugOperator(
    EnumPlugOperator["MarkerLookEnumAttrOperator"]
):
    __slots__ = ()
...
class MarkerLookEnumAttrOperator(EnumAttrOperator[MarkerLookEnumPlugOperator]):
    __slots__ = ()
...
class GeneratedHikIKEffector(Transform):
    __slots__ = ()
    ...
    reachTranslation = DoubleField(
        default_value=0.0, min_value=0.0, max_value=1.0
    )
    rt = reachTranslation

    reachRotation = DoubleField(
        default_value=0.0, min_value=0.0, max_value=1.0
    )
    rr = reachRotation
