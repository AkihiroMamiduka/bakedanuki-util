...
from .....attr.define.node_attr_maya2027.hair_system import (
    AiHairShaderField,
...
class BendModelEnumPlugOperator(EnumPlugOperator["BendModelEnumAttrOperator"]):
    __slots__ = ()
...
class BendModelEnumAttrOperator(EnumAttrOperator[BendModelEnumPlugOperator]):
    __slots__ = ()
...
class NoiseMethodEnumPlugOperator(
    EnumPlugOperator["NoiseMethodEnumAttrOperator"]
):
    __slots__ = ()
...
class NoiseMethodEnumAttrOperator(
    EnumAttrOperator[NoiseMethodEnumPlugOperator]
):
    __slots__ = ()
...
class SubClumpMethodEnumPlugOperator(
    EnumPlugOperator["SubClumpMethodEnumAttrOperator"]
):
    __slots__ = ()
...
class SubClumpMethodEnumAttrOperator(
    EnumAttrOperator[SubClumpMethodEnumPlugOperator]
):
    __slots__ = ()
...
class GeneratedHairSystem(Shape):
    __slots__ = ()
    ...
    twistResistance = DoubleField(
        default_value=0.0, soft_min_value=0.0, soft_max_value=100.0
    )
    trs = twistResistance

    bendResistance = FloatField(
        default_value=1.0, soft_min_value=0.0, soft_max_value=200.0
    )
    bnd = bendResistance

    bendAnisotropy = DoubleField(
    ...
    collideWidthOffset = DoubleField(
    ...
    staticCling = DoubleField(
        default_value=0.0, soft_min_value=-1.0, soft_max_value=1.0
    )
    stc = staticCling

    repulsion = DoubleField(
        default_value=0.5, soft_min_value=0.0, soft_max_value=1.0
    )
    rpl = repulsion

    numCollideNeighbors = LongField(
        default_value=4, soft_min_value=1, soft_max_value=100
    )
    ncn = numCollideNeighbors

    maxSelfCollisionIterations = LongField(
        default_value=1, soft_min_value=0, soft_max_value=20
    )
    ...
    gravity = DoubleField(
        default_value=0.98, soft_min_value=0.0, soft_max_value=10.0
    )
    grv = gravity

    turbulenceStrength = DoubleField(
        default_value=0.0, min_value=0.0, soft_max_value=1.0
    )
    tst = turbulenceStrength

    turbulenceFrequency = DoubleField(
        default_value=0.2, min_value=0.0, soft_max_value=2.0
    )
    ...
    displayQuality = DoubleField(
        default_value=100.0, soft_min_value=0.0, soft_max_value=100.0
    )
    dpq = displayQuality
    ...
    clumpWidth = DoubleField(
        default_value=0.3, min_value=0.0, soft_max_value=1.0
    )
    cwd = clumpWidth
    ...
    clumpTwist = DoubleField(
        default_value=0.0, soft_min_value=-1.0, soft_max_value=1.0
    )
    ctw = clumpTwist

    clumpCurl = ClumpCurlField(multi=True, default_value=(0.0, 0.0, 0))
    clc = clumpCurl

    clumpFlatness = ClumpFlatnessField(multi=True, default_value=(0.0, 0.0, 0))
    cfl = clumpFlatness

    bendFollow = DoubleField(
        default_value=1.0, soft_min_value=0.0, soft_max_value=1.0
    )
    bnf = bendFollow

    hairWidth = DoubleField(
        default_value=0.01, min_value=0.0, soft_max_value=0.1
    )
    hwd = hairWidth

    hairWidthScale = HairWidthScaleField(
        multi=True, default_value=(0.0, 0.0, 0)
    )
    hws = hairWidthScale
    ...
    hairColor = HairColorField(
        default_value=(0.30000001192092896, 0.25, 0.15000000596046448)
    )
    hcl = hairColor
    ...
    hairsPerClump = LongField(
        default_value=10, min_value=1, soft_max_value=100
    )
    hpc = hairsPerClump

    thinning = DoubleField(
        default_value=0.0, min_value=0.0, soft_max_value=1.0
    )
    thn = thinning
    ...
    specularPower = DoubleField(
        default_value=3.0, min_value=0.0, soft_max_value=20.0
    )
    spp = specularPower
    ...
    displacementScale = DisplacementScaleField(
        multi=True, default_value=(0.0, 0.0, 0)
    )
    ...
    curlFrequency = DoubleField(
        default_value=10.0, soft_min_value=0.0001, soft_max_value=100.0
    )
    crf = curlFrequency
    ...
    detailNoise = DoubleField(
        default_value=0.0, soft_min_value=0.0, soft_max_value=1.0
    )
    dno = detailNoise

    noiseFrequency = DoubleField(
        default_value=0.4, soft_min_value=0.0, soft_max_value=2.0
    )
    nof = noiseFrequency

    noiseFrequencyU = DoubleField(
        default_value=1.0, soft_min_value=0.0, soft_max_value=2.0
    )
    nfu = noiseFrequencyU

    noiseFrequencyV = DoubleField(
        default_value=1.0, soft_min_value=0.0, soft_max_value=2.0
    )
    nfv = noiseFrequencyV

    noiseFrequencyW = DoubleField(
        default_value=1.0, soft_min_value=0.0, soft_max_value=2.0
    )
    nfw = noiseFrequencyW
    ...
    subClumping = DoubleField(
        default_value=0.0, soft_min_value=0.0, soft_max_value=10.0
    )
    scp = subClumping

    subClumpRand = DoubleField(
        default_value=0.0, soft_min_value=0.0, soft_max_value=2.0
    )
    scr = subClumpRand

    numUClumps = DoubleField(
        default_value=15.0, soft_min_value=1.0, soft_max_value=100.0
    )
    nuc = numUClumps

    numVClumps = DoubleField(
        default_value=15.0, soft_min_value=1.0, soft_max_value=100.0
    )
    nvc = numVClumps

    clumpInterpolation = DoubleField(
        default_value=0.0, soft_min_value=0.0, soft_max_value=1.0
    )
    cin = clumpInterpolation

    interpolationRange = DoubleField(
        default_value=8.0, soft_min_value=0.0, soft_max_value=20.0
    )
    ...
    aiHairShader = AiHairShaderField(
