...
class ShowManipDefaultEnumField(
    EnumField[ShowManipDefaultEnumAttrOperator, ShowManipDefaultEnumPlugOperator]
):
    __slots__ = ()
...
class Transform(DAG):
    ...
    rotatePivotTranslate = RotatePivotTranslateField(default_value=(0.0, 0.0, 0.0))
    ...
    scalePivotTranslate = ScalePivotTranslateField(default_value=(0.0, 0.0, 0.0))
    ...
    transMinusRotatePivot = TransMinusRotatePivotField(default_value=(0.0, 0.0, 0.0), writable=False)
    ...
    minTransLimitEnable = MinTransLimitEnableField(default_value=(0.0, 0.0, 0.0), min_value=(0.0, 0.0, 0.0), max_value=(1.0, 1.0, 1.0))
    ...
    maxTransLimitEnable = MaxTransLimitEnableField(default_value=(0.0, 0.0, 0.0), min_value=(0.0, 0.0, 0.0), max_value=(1.0, 1.0, 1.0))
    ...
    minRotLimit = MinRotLimitField(default_value=(-0.7853981633974483, -0.7853981633974483, -0.7853981633974483))
    mnrl = minRotLimit
    ...
    maxRotLimit = MaxRotLimitField(default_value=(0.7853981633974483, 0.7853981633974483, 0.7853981633974483))
    mxrl = maxRotLimit
    ...
    minRotLimitEnable = MinRotLimitEnableField(default_value=(0.0, 0.0, 0.0), min_value=(0.0, 0.0, 0.0), max_value=(1.0, 1.0, 1.0))
    ...
    maxRotLimitEnable = MaxRotLimitEnableField(default_value=(0.0, 0.0, 0.0), min_value=(0.0, 0.0, 0.0), max_value=(1.0, 1.0, 1.0))
    ...
    minScaleLimitEnable = MinScaleLimitEnableField(default_value=(0.0, 0.0, 0.0), min_value=(0.0, 0.0, 0.0), max_value=(1.0, 1.0, 1.0))
    ...
    maxScaleLimitEnable = MaxScaleLimitEnableField(default_value=(0.0, 0.0, 0.0), min_value=(0.0, 0.0, 0.0), max_value=(1.0, 1.0, 1.0))
    ...
    rotateQuaternion = RotateQuaternionField(default_value=(0.0, 0.0, 0.0, 0.0))
    rq = rotateQuaternion
    ...
    rotationInterpolation = RotationInterpolationEnumField(default_value=1, writable=False)
