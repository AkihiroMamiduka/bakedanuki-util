...
from ....attr.define.node_attr_maya2026.ai_skin import (
...
class GeneratedAiSkin(DG):
    ...
    shallowScatterColor = ShallowScatterColorField(
        default_value=(1.0, 0.9089999794960022, 0.7689999938011169)
    )
    ...
    shallowScatterRadius = DoubleLinearField(
    ...
    midScatterWeight = FloatField(
        default_value=0.25, min_value=0.0, soft_max_value=1.0
    )
    mid_scatter_weight = midScatterWeight

    midScatterRadius = DoubleLinearField(
        default_value=0.25, min_value=0.0, soft_max_value=1.0
    )
    ...
    deepScatterRadius = DoubleLinearField(
    ...
    specularIor = FloatField(
        default_value=1.440000057220459,
        min_value=0.0,
        soft_min_value=1.0,
        soft_max_value=5.0,
    )
    ...
    globalSssRadiusMultiplier = FloatField(
        default_value=1.0, soft_min_value=0.0, soft_max_value=20.0
    )
