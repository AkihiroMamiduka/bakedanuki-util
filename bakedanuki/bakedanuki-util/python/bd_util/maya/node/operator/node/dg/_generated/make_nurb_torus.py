...
from ....attr.define.node_attr.make_nurb_torus import (
    AxisField,
    PivotField,
)
...
class _GeneratedMakeNurbTorus(DG):
    __slots__ = ()
    ...
    minorSweep = DoubleAngleField(default_value=360.0, soft_min_value=0.0, soft_max_value=360.0)
    msw = minorSweep
