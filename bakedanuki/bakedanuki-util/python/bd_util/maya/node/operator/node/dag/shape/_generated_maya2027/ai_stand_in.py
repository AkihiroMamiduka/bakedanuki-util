...
from .....attr.define.node_attr_maya2027.ai_stand_in import (
...
class GeneratedAiStandIn(Shape):
    ...
    displayVolumes = BoolField(default_value=False)
    display_volumes = displayVolumes
    ...
    abcUseSceneMotionKeys = BoolField(default_value=False)
    abc_use_scene_motion_keys = abcUseSceneMotionKeys
