...
from ....attr.define.node_attr_maya2027.cryptomatte import (
    OutColorField,
...
class GeneratedCryptomatte(DG):
    ...
    objectSplitInstances = BoolField(default_value=False)
    object_split_instances = objectSplitInstances
