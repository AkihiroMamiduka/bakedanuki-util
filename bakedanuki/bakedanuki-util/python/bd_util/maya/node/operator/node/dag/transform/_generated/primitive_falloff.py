...
class GeneratedPrimitiveFalloff(Transform):
    __slots__ = ()
    ...
    positiveSize = PositiveSizeField(
    ...
    negativeSize = NegativeSizeField(
        default_value=(1.0, 1.0, 1.0), min_value=(0.0, 0.0, 0.0)
    )
    ns = negativeSize
    ...
    ramp = RampField(multi=True, default_value=(0.0, 0.0, 0))
    rmp = ramp
