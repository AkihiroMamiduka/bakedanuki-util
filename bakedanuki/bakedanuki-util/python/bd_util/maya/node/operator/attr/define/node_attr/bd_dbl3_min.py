...
class Input1PlugOperator(
    ...
    input1X = DoubleField(default_value=0.0)
    i1x = input1X

    input1Y = DoubleField(default_value=0.0)
    i1y = input1Y

    input1Z = DoubleField(default_value=0.0)
    i1z = input1Z
...
class Input2PlugOperator(
    ...
    input2X = DoubleField(default_value=0.0)
    i2x = input2X

    input2Y = DoubleField(default_value=0.0)
    i2y = input2Y

    input2Z = DoubleField(default_value=0.0)
    i2z = input2Z
