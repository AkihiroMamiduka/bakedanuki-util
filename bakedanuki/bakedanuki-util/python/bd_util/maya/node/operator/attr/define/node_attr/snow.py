...
class SurfaceColorPlugOperator(
    ...
    surfaceColorR = FloatField(default_value=0.5, min_value=0.0, max_value=1.0)
    sur = surfaceColorR

    surfaceColorG = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    sug = surfaceColorG

    surfaceColorB = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    sub = surfaceColorB
