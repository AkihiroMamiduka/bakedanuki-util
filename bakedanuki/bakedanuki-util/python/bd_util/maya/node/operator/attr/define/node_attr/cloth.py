...
class GapColorPlugOperator(
    ...
    gapColorR = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    gcr = gapColorR

    gapColorG = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    gcg = gapColorG

    gapColorB = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    gcb = gapColorB
...
class UColorPlugOperator(Float3CompoundBasePlugOperator["UColorAttrOperator"]):
    ...
    uColorG = FloatField(default_value=1.0, min_value=0.0, max_value=1.0)
    ucg = uColorG

    uColorB = FloatField(default_value=1.0, min_value=0.0, max_value=1.0)
    ucb = uColorB
...
class VColorPlugOperator(Float3CompoundBasePlugOperator["VColorAttrOperator"]):
    ...
    vColorG = FloatField(default_value=0.5, min_value=0.0, max_value=1.0)
    vcg = vColorG

    vColorB = FloatField(default_value=0.5, min_value=0.0, max_value=1.0)
    vcb = vColorB
