...
class DrawOverride_overrideDisplayTypeEnumPlugOperator(
    EnumPlugOperator["DrawOverride_overrideDisplayTypeEnumAttrOperator"]
):
    __slots__ = ()
...
class DrawOverride_overrideDisplayTypeEnumAttrOperator(
    EnumAttrOperator[DrawOverride_overrideDisplayTypeEnumPlugOperator]
):
    __slots__ = ()
...
class DrawOverride_overrideDisplayTypeEnumField(
    EnumField[
        DrawOverride_overrideDisplayTypeEnumAttrOperator,
        DrawOverride_overrideDisplayTypeEnumPlugOperator,
    ]
):
    __slots__ = ()

    ATTR_CLS = DrawOverride_overrideDisplayTypeEnumAttrOperator
    PLUG_CLS = DrawOverride_overrideDisplayTypeEnumPlugOperator


class DrawOverride_overrideLevelOfDetailEnumPlugOperator(
    EnumPlugOperator["DrawOverride_overrideLevelOfDetailEnumAttrOperator"]
):
    __slots__ = ()
...
class DrawOverride_overrideLevelOfDetailEnumAttrOperator(
    EnumAttrOperator[DrawOverride_overrideLevelOfDetailEnumPlugOperator]
):
    __slots__ = ()
...
class DrawOverride_overrideLevelOfDetailEnumField(
    EnumField[
        DrawOverride_overrideLevelOfDetailEnumAttrOperator,
        DrawOverride_overrideLevelOfDetailEnumPlugOperator,
    ]
):
    __slots__ = ()

    ATTR_CLS = DrawOverride_overrideLevelOfDetailEnumAttrOperator
    PLUG_CLS = DrawOverride_overrideLevelOfDetailEnumPlugOperator


class BoundingBox_boundingBoxMinPlugOperator(
    DoubleLinear3CompoundBasePlugOperator[
        "BoundingBox_boundingBoxMinAttrOperator"
    ]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
    ...
    boundingBoxMinX = DoubleLinearField(default_value=0.0, writable=False)
    bbnx = boundingBoxMinX

    boundingBoxMinY = DoubleLinearField(default_value=0.0, writable=False)
    bbny = boundingBoxMinY

    boundingBoxMinZ = DoubleLinearField(default_value=0.0, writable=False)
    bbnz = boundingBoxMinZ


class BoundingBox_boundingBoxMinAttrOperator(
    DoubleLinear3CompoundBaseAttrOperator[
        BoundingBox_boundingBoxMinPlugOperator
    ]
):
    __slots__ = ()
...
class BoundingBox_boundingBoxMinField(
    DoubleLinear3CompoundBaseField[
        BoundingBox_boundingBoxMinAttrOperator,
        BoundingBox_boundingBoxMinPlugOperator,
    ]
    ...
    ATTR_CLS = BoundingBox_boundingBoxMinAttrOperator
    PLUG_CLS = BoundingBox_boundingBoxMinPlugOperator
...
class BoundingBox_boundingBoxMaxPlugOperator(
    DoubleLinear3CompoundBasePlugOperator[
        "BoundingBox_boundingBoxMaxAttrOperator"
    ]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
    ...
    boundingBoxMaxX = DoubleLinearField(default_value=0.0, writable=False)
    bbxx = boundingBoxMaxX

    boundingBoxMaxY = DoubleLinearField(default_value=0.0, writable=False)
    bbxy = boundingBoxMaxY

    boundingBoxMaxZ = DoubleLinearField(default_value=0.0, writable=False)
    bbxz = boundingBoxMaxZ


class BoundingBox_boundingBoxMaxAttrOperator(
    DoubleLinear3CompoundBaseAttrOperator[
        BoundingBox_boundingBoxMaxPlugOperator
    ]
):
    __slots__ = ()
...
class BoundingBox_boundingBoxMaxField(
    DoubleLinear3CompoundBaseField[
        BoundingBox_boundingBoxMaxAttrOperator,
        BoundingBox_boundingBoxMaxPlugOperator,
    ]
    ...
    ATTR_CLS = BoundingBox_boundingBoxMaxAttrOperator
    PLUG_CLS = BoundingBox_boundingBoxMaxPlugOperator
...
class BoundingBox_boundingBoxSizePlugOperator(
    DoubleLinear3CompoundBasePlugOperator[
        "BoundingBox_boundingBoxSizeAttrOperator"
    ]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
    ...
    boundingBoxSizeX = DoubleLinearField(default_value=0.0, writable=False)
    bbsx = boundingBoxSizeX

    boundingBoxSizeY = DoubleLinearField(default_value=0.0, writable=False)
    bbsy = boundingBoxSizeY

    boundingBoxSizeZ = DoubleLinearField(default_value=0.0, writable=False)
    bbsz = boundingBoxSizeZ


class BoundingBox_boundingBoxSizeAttrOperator(
    DoubleLinear3CompoundBaseAttrOperator[
        BoundingBox_boundingBoxSizePlugOperator
    ]
):
    __slots__ = ()
...
class BoundingBox_boundingBoxSizeField(
    DoubleLinear3CompoundBaseField[
        BoundingBox_boundingBoxSizeAttrOperator,
        BoundingBox_boundingBoxSizePlugOperator,
    ]
    ...
    ATTR_CLS = BoundingBox_boundingBoxSizeAttrOperator
    PLUG_CLS = BoundingBox_boundingBoxSizePlugOperator
...
class InstObjGroups_objectGroupsPlugOperator(
    CompoundPlugOperator["InstObjGroups_objectGroupsAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
    ...
    objectGrpCompList = TypedField()
    gcl = objectGrpCompList

    objectGroupId = LongField(default_value=0)
    gid = objectGroupId

    objectGrpColor = ShortField(default_value=-1)
    gco = objectGrpColor


class InstObjGroups_objectGroupsAttrOperator(
    CompoundAttrOperator[InstObjGroups_objectGroupsPlugOperator]
):
    __slots__ = ()
...
class InstObjGroups_objectGroupsField(
    CompoundField[
        InstObjGroups_objectGroupsAttrOperator,
        InstObjGroups_objectGroupsPlugOperator,
    ]
):
    __slots__ = ()

    ATTR_CLS = InstObjGroups_objectGroupsAttrOperator
    PLUG_CLS = InstObjGroups_objectGroupsPlugOperator


class DrawOverride_overrideColorRGBPlugOperator(
    Float3CompoundBasePlugOperator["DrawOverride_overrideColorRGBAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("overrideColorR", "ovcr"),
    ...
    overrideColorR = FloatField(default_value=0.0)
    ovcr = overrideColorR

    overrideColorG = FloatField(default_value=0.0)
    ovcg = overrideColorG

    overrideColorB = FloatField(default_value=0.0)
    ovcb = overrideColorB


class DrawOverride_overrideColorRGBAttrOperator(
    Float3CompoundBaseAttrOperator[DrawOverride_overrideColorRGBPlugOperator]
):
    __slots__ = ()
...
class DrawOverride_overrideColorRGBField(
    Float3CompoundBaseField[
        DrawOverride_overrideColorRGBAttrOperator,
        DrawOverride_overrideColorRGBPlugOperator,
    ]
):
    __slots__ = ()

    ATTR_CLS = DrawOverride_overrideColorRGBAttrOperator
    PLUG_CLS = DrawOverride_overrideColorRGBPlugOperator
...
class BoundingBoxPlugOperator(CompoundPlugOperator["BoundingBoxAttrOperator"]):
    ...
    boundingBoxMin = BoundingBox_boundingBoxMinField(
        default_value=(0.0, 0.0, 0.0), writable=False
    )
    bbmn = boundingBoxMin

    boundingBoxMax = BoundingBox_boundingBoxMaxField(
        default_value=(0.0, 0.0, 0.0), writable=False
    )
    bbmx = boundingBoxMax

    boundingBoxSize = BoundingBox_boundingBoxSizeField(
        default_value=(0.0, 0.0, 0.0), writable=False
    )
...
class InstObjGroupsPlugOperator(
    ...
    objectGroups = InstObjGroups_objectGroupsField(multi=True)
    og = objectGroups
...
class DrawOverridePlugOperator(
    ...
    overrideDisplayType = DrawOverride_overrideDisplayTypeEnumField(
        default_value=0
    )
    ovdt = overrideDisplayType

    overrideLevelOfDetail = DrawOverride_overrideLevelOfDetailEnumField(
        default_value=0
    )
    ...
    overrideColorRGB = DrawOverride_overrideColorRGBField(
