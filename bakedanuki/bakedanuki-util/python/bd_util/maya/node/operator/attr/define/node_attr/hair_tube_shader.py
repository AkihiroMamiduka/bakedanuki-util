...
class TangentVCameraPlugOperator(
    ...
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("tangentVCameraX", "vtnx"),
        ("tangentVCameraY", "vtny"),
        ("tangentVCameraZ", "vtnz"),
    )

    tangentVCameraX = FloatField(default_value=1.0)
    vtnx = tangentVCameraX

    tangentVCameraY = FloatField(default_value=1.0)
    vtny = tangentVCameraY

    tangentVCameraZ = FloatField(default_value=1.0)
...
class ColorScalePlugOperator(CompoundPlugOperator["ColorScaleAttrOperator"]):
    ...
    CHILD_ATTR_NAMES = (
        ...
        ("colorScale_Color", "clsc"),
        ("colorScale_Interp", "clsi"),
    )

    colorScale_Position = FloatField(default_value=0.0)
    clsp = colorScale_Position

    colorScale_Color = Float3Field(default_value=(0.0, 0.0, 0.0))
    clsc = colorScale_Color

    colorScale_Interp = ColorScale_InterpEnumField(default_value=0)
...
class ColorScaleField(
    CompoundField[ColorScaleAttrOperator, ColorScalePlugOperator]
):
    __slots__ = ()

    ATTR_CLS = ColorScaleAttrOperator
    PLUG_CLS = ColorScalePlugOperator
