...
class SubsurfaceColorPlugOperator(
    ...
    subsurfaceColorR = FloatField(default_value=0.800000011920929)
    subsurface_colorr = subsurfaceColorR

    subsurfaceColorG = FloatField(default_value=0.800000011920929)
    subsurface_colorg = subsurfaceColorG

    subsurfaceColorB = FloatField(default_value=0.800000011920929)
...
class SubsurfaceRadiusScalePlugOperator(
    Float3CompoundBasePlugOperator["SubsurfaceRadiusScaleAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("subsurfaceRadiusScaleR", "subsurface_radius_scaler"),
        ("subsurfaceRadiusScaleG", "subsurface_radius_scaleg"),
        ("subsurfaceRadiusScaleB", "subsurface_radius_scaleb"),
    )

    subsurfaceRadiusScaleR = FloatField(default_value=1.0)
    subsurface_radius_scaler = subsurfaceRadiusScaleR

    subsurfaceRadiusScaleG = FloatField(default_value=0.5)
    subsurface_radius_scaleg = subsurfaceRadiusScaleG

    subsurfaceRadiusScaleB = FloatField(default_value=0.25)
    subsurface_radius_scaleb = subsurfaceRadiusScaleB


class SubsurfaceRadiusScaleAttrOperator(
    Float3CompoundBaseAttrOperator[SubsurfaceRadiusScalePlugOperator]
):
    __slots__ = ()
...
class SubsurfaceRadiusScaleField(
    Float3CompoundBaseField[
        SubsurfaceRadiusScaleAttrOperator, SubsurfaceRadiusScalePlugOperator
    ]
):
    __slots__ = ()

    ATTR_CLS = SubsurfaceRadiusScaleAttrOperator
    PLUG_CLS = SubsurfaceRadiusScalePlugOperator
...
class FuzzColorPlugOperator(
    Float3CompoundBasePlugOperator["FuzzColorAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("fuzzColorR", "fuzz_colorr"),
        ("fuzzColorG", "fuzz_colorg"),
        ("fuzzColorB", "fuzz_colorb"),
    )

    fuzzColorR = FloatField(default_value=1.0)
    fuzz_colorr = fuzzColorR

    fuzzColorG = FloatField(default_value=1.0)
    fuzz_colorg = fuzzColorG

    fuzzColorB = FloatField(default_value=1.0)
    fuzz_colorb = fuzzColorB


class FuzzColorAttrOperator(
    Float3CompoundBaseAttrOperator[FuzzColorPlugOperator]
):
    __slots__ = ()
...
class FuzzColorField(
    Float3CompoundBaseField[FuzzColorAttrOperator, FuzzColorPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = FuzzColorAttrOperator
    PLUG_CLS = FuzzColorPlugOperator
...
class GeometryTangentPlugOperator(
    Float3CompoundBasePlugOperator["GeometryTangentAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("geometryTangentX", "geometry_tangentx"),
        ("geometryTangentY", "geometry_tangenty"),
        ("geometryTangentZ", "geometry_tangentz"),
    )

    geometryTangentX = FloatField(default_value=0.0)
    geometry_tangentx = geometryTangentX

    geometryTangentY = FloatField(default_value=0.0)
    geometry_tangenty = geometryTangentY

    geometryTangentZ = FloatField(default_value=0.0)
    geometry_tangentz = geometryTangentZ


class GeometryTangentAttrOperator(
    Float3CompoundBaseAttrOperator[GeometryTangentPlugOperator]
):
    __slots__ = ()
...
class GeometryTangentField(
    Float3CompoundBaseField[
        GeometryTangentAttrOperator, GeometryTangentPlugOperator
    ]
):
    __slots__ = ()

    ATTR_CLS = GeometryTangentAttrOperator
    PLUG_CLS = GeometryTangentPlugOperator
...
class GeometryCoatNormalPlugOperator(
    Float3CompoundBasePlugOperator["GeometryCoatNormalAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("geometryCoatNormalX", "geometry_coat_normalx"),
        ("geometryCoatNormalY", "geometry_coat_normaly"),
        ("geometryCoatNormalZ", "geometry_coat_normalz"),
    )

    geometryCoatNormalX = FloatField(default_value=0.0)
    geometry_coat_normalx = geometryCoatNormalX

    geometryCoatNormalY = FloatField(default_value=0.0)
    geometry_coat_normaly = geometryCoatNormalY

    geometryCoatNormalZ = FloatField(default_value=0.0)
    geometry_coat_normalz = geometryCoatNormalZ


class GeometryCoatNormalAttrOperator(
    Float3CompoundBaseAttrOperator[GeometryCoatNormalPlugOperator]
):
    __slots__ = ()
...
class GeometryCoatNormalField(
    Float3CompoundBaseField[
        GeometryCoatNormalAttrOperator, GeometryCoatNormalPlugOperator
    ]
):
    __slots__ = ()

    ATTR_CLS = GeometryCoatNormalAttrOperator
    PLUG_CLS = GeometryCoatNormalPlugOperator
...
class GeometryCoatTangentPlugOperator(
    Float3CompoundBasePlugOperator["GeometryCoatTangentAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("geometryCoatTangentX", "geometry_coat_tangentx"),
        ("geometryCoatTangentY", "geometry_coat_tangenty"),
        ("geometryCoatTangentZ", "geometry_coat_tangentz"),
    )

    geometryCoatTangentX = FloatField(default_value=0.0)
    geometry_coat_tangentx = geometryCoatTangentX

    geometryCoatTangentY = FloatField(default_value=0.0)
    geometry_coat_tangenty = geometryCoatTangentY

    geometryCoatTangentZ = FloatField(default_value=0.0)
    geometry_coat_tangentz = geometryCoatTangentZ


class GeometryCoatTangentAttrOperator(
    Float3CompoundBaseAttrOperator[GeometryCoatTangentPlugOperator]
):
    __slots__ = ()
...
class GeometryCoatTangentField(
    Float3CompoundBaseField[
        GeometryCoatTangentAttrOperator, GeometryCoatTangentPlugOperator
    ]
):
    __slots__ = ()

    ATTR_CLS = GeometryCoatTangentAttrOperator
    PLUG_CLS = GeometryCoatTangentPlugOperator
