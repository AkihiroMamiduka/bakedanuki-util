...
class AxisAngle_axisPlugOperator(
    DoubleLinear3CompoundBasePlugOperator["AxisAngle_axisAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("axisX", "axx"),
    ...
    axisX = DoubleLinearField(default_value=0.0, writable=False)
    axx = axisX

    axisY = DoubleLinearField(default_value=0.0, writable=False)
    axy = axisY

    axisZ = DoubleLinearField(default_value=1.0, writable=False)
    axz = axisZ


class AxisAngle_axisAttrOperator(
    DoubleLinear3CompoundBaseAttrOperator[AxisAngle_axisPlugOperator]
):
    __slots__ = ()
