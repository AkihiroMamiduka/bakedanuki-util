...
class Vertex_singleVertexPlugOperator(
    DoubleLinear3CompoundBasePlugOperator["Vertex_singleVertexAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("singleVertexX", "svx"),
    ...
    singleVertexX = DoubleLinearField(default_value=0.0)
    svx = singleVertexX

    singleVertexY = DoubleLinearField(default_value=0.0)
    svy = singleVertexY

    singleVertexZ = DoubleLinearField(default_value=0.0)
    svz = singleVertexZ


class Vertex_singleVertexAttrOperator(
    DoubleLinear3CompoundBaseAttrOperator[Vertex_singleVertexPlugOperator]
):
    __slots__ = ()
...
class Vertex_singleVertexField(
    DoubleLinear3CompoundBaseField[
        Vertex_singleVertexAttrOperator, Vertex_singleVertexPlugOperator
    ]
):
    __slots__ = ()

    ATTR_CLS = Vertex_singleVertexAttrOperator
    PLUG_CLS = Vertex_singleVertexPlugOperator


class VertexTweak_singleVertexTweakPlugOperator(
    DoubleLinear3CompoundBasePlugOperator[
        "VertexTweak_singleVertexTweakAttrOperator"
    ]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("singleVertexTweakX", "stwx"),
        ("singleVertexTweakY", "stwy"),
        ("singleVertexTweakZ", "stwz"),
    )

    singleVertexTweakX = DoubleLinearField(default_value=0.0)
    stwx = singleVertexTweakX

    singleVertexTweakY = DoubleLinearField(default_value=0.0)
    stwy = singleVertexTweakY

    singleVertexTweakZ = DoubleLinearField(default_value=0.0)
    stwz = singleVertexTweakZ


class VertexTweak_singleVertexTweakAttrOperator(
    DoubleLinear3CompoundBaseAttrOperator[
        VertexTweak_singleVertexTweakPlugOperator
    ]
):
    __slots__ = ()
...
class VertexTweak_singleVertexTweakField(
    DoubleLinear3CompoundBaseField[
        VertexTweak_singleVertexTweakAttrOperator,
        VertexTweak_singleVertexTweakPlugOperator,
    ]
    ...
    ATTR_CLS = VertexTweak_singleVertexTweakAttrOperator
    PLUG_CLS = VertexTweak_singleVertexTweakPlugOperator
...
class VertexPlugOperator(CompoundPlugOperator["VertexAttrOperator"]):
    __slots__ = ()
    CHILD_ATTR_NAMES = (("singleVertex", "svt"),)

    singleVertex = Vertex_singleVertexField(
        multi=True, default_value=(0.0, 0.0, 0.0)
    )
    svt = singleVertex


class VertexAttrOperator(CompoundAttrOperator[VertexPlugOperator]):
    __slots__ = ()
...
class VertexField(CompoundField[VertexAttrOperator, VertexPlugOperator]):
    __slots__ = ()

    ATTR_CLS = VertexAttrOperator
    PLUG_CLS = VertexPlugOperator


class VertexTweakPlugOperator(CompoundPlugOperator["VertexTweakAttrOperator"]):
    __slots__ = ()
    CHILD_ATTR_NAMES = (("singleVertexTweak", "stw"),)

    singleVertexTweak = VertexTweak_singleVertexTweakField(
        multi=True, default_value=(0.0, 0.0, 0.0)
    )
    stw = singleVertexTweak


class VertexTweakAttrOperator(CompoundAttrOperator[VertexTweakPlugOperator]):
    __slots__ = ()
...
class VertexTweakField(
    CompoundField[VertexTweakAttrOperator, VertexTweakPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = VertexTweakAttrOperator
    PLUG_CLS = VertexTweakPlugOperator
