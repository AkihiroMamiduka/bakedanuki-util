...
class FieldPlugOperator(Float3CompoundBasePlugOperator["FieldAttrOperator"]):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("fieldR", "fieldr"),
        ("fieldG", "fieldg"),
    ...
    fieldR = FloatField(default_value=0.0)
    fieldr = fieldR

    fieldG = FloatField(default_value=0.0)
    fieldg = fieldG

    fieldB = FloatField(default_value=0.0)
    fieldb = fieldB


class FieldAttrOperator(Float3CompoundBaseAttrOperator[FieldPlugOperator]):
    __slots__ = ()
...
class FieldField(
    Float3CompoundBaseField[FieldAttrOperator, FieldPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = FieldAttrOperator
    PLUG_CLS = FieldPlugOperator
