...
class CenterPlugOperator(
    ...
    centerV = FloatField(default_value=-0.5, min_value=-1.0, max_value=2.0)
    cv = centerV
...
class RipplesPlugOperator(
    ...
    ripplesY = FloatField(default_value=1.0)
    ry = ripplesY

    ripplesZ = FloatField(default_value=1.0)
    rz = ripplesZ
...
class DepthPlugOperator(
    ...
    depthMax = FloatField(default_value=8.0)
    dmx = depthMax
