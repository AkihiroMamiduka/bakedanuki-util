...
class WidthRamp_widthRamp_InterpEnumPlugOperator(
    EnumPlugOperator["WidthRamp_widthRamp_InterpEnumAttrOperator"]
):
    __slots__ = ()
...
class WidthRamp_widthRamp_InterpEnumAttrOperator(
    EnumAttrOperator[WidthRamp_widthRamp_InterpEnumPlugOperator]
):
    __slots__ = ()
...
class WidthRamp_widthRamp_InterpEnumField(
    EnumField[
        WidthRamp_widthRamp_InterpEnumAttrOperator,
        WidthRamp_widthRamp_InterpEnumPlugOperator,
    ]
):
    __slots__ = ()

    ATTR_CLS = WidthRamp_widthRamp_InterpEnumAttrOperator
    PLUG_CLS = WidthRamp_widthRamp_InterpEnumPlugOperator
...
class WidthRampPlugOperator(CompoundPlugOperator["WidthRampAttrOperator"]):
    ...
    widthRamp_Interp = WidthRamp_widthRamp_InterpEnumField(default_value=1)
...
class PreSelHighlightColorPlugOperator(
    Float3CompoundBasePlugOperator["PreSelHighlightColorAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("preSelHighlightColorR", "pscr"),
        ("preSelHighlightColorG", "pscg"),
        ("preSelHighlightColorB", "pscb"),
    )

    preSelHighlightColorR = FloatField(default_value=0.44999998807907104)
    pscr = preSelHighlightColorR

    preSelHighlightColorG = FloatField(default_value=1.0)
    pscg = preSelHighlightColorG

    preSelHighlightColorB = FloatField(default_value=0.44999998807907104)
    pscb = preSelHighlightColorB


class PreSelHighlightColorAttrOperator(
    Float3CompoundBaseAttrOperator[PreSelHighlightColorPlugOperator]
):
    __slots__ = ()
...
class PreSelHighlightColorField(
    Float3CompoundBaseField[
        PreSelHighlightColorAttrOperator, PreSelHighlightColorPlugOperator
    ]
):
    __slots__ = ()

    ATTR_CLS = PreSelHighlightColorAttrOperator
    PLUG_CLS = PreSelHighlightColorPlugOperator
...
class SelectionHighlightColorPlugOperator(
    Float3CompoundBasePlugOperator["SelectionHighlightColorAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("selectionHighlightColorR", "slcr"),
        ("selectionHighlightColorG", "slcg"),
        ("selectionHighlightColorB", "slcb"),
    )

    selectionHighlightColorR = FloatField(default_value=1.0)
    slcr = selectionHighlightColorR

    selectionHighlightColorG = FloatField(default_value=1.0)
    slcg = selectionHighlightColorG

    selectionHighlightColorB = FloatField(default_value=0.0)
    slcb = selectionHighlightColorB


class SelectionHighlightColorAttrOperator(
    Float3CompoundBaseAttrOperator[SelectionHighlightColorPlugOperator]
):
    __slots__ = ()
...
class SelectionHighlightColorField(
    Float3CompoundBaseField[
        SelectionHighlightColorAttrOperator,
        SelectionHighlightColorPlugOperator,
    ]
):
    __slots__ = ()

    ATTR_CLS = SelectionHighlightColorAttrOperator
    PLUG_CLS = SelectionHighlightColorPlugOperator
...
class ShowFrozenColorPlugOperator(
    Float3CompoundBasePlugOperator["ShowFrozenColorAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("showFrozenColorR", "sfcr"),
        ("showFrozenColorG", "sfcg"),
        ("showFrozenColorB", "sfcb"),
    )

    showFrozenColorR = FloatField(default_value=0.0)
    sfcr = showFrozenColorR

    showFrozenColorG = FloatField(default_value=0.44999998807907104)
    sfcg = showFrozenColorG

    showFrozenColorB = FloatField(default_value=0.8999999761581421)
    sfcb = showFrozenColorB


class ShowFrozenColorAttrOperator(
    Float3CompoundBaseAttrOperator[ShowFrozenColorPlugOperator]
):
    __slots__ = ()
...
class ShowFrozenColorField(
    Float3CompoundBaseField[
        ShowFrozenColorAttrOperator, ShowFrozenColorPlugOperator
    ]
):
    __slots__ = ()

    ATTR_CLS = ShowFrozenColorAttrOperator
    PLUG_CLS = ShowFrozenColorPlugOperator
...
class HighlightPlacedColorPlugOperator(
    Float3CompoundBasePlugOperator["HighlightPlacedColorAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("highlightPlacedColorR", "hpcr"),
        ("highlightPlacedColorG", "hpcg"),
        ("highlightPlacedColorB", "hpcb"),
    )

    highlightPlacedColorR = FloatField(default_value=0.0)
    hpcr = highlightPlacedColorR

    highlightPlacedColorG = FloatField(default_value=0.3176470696926117)
    hpcg = highlightPlacedColorG

    highlightPlacedColorB = FloatField(default_value=0.09019608050584793)
    hpcb = highlightPlacedColorB


class HighlightPlacedColorAttrOperator(
    Float3CompoundBaseAttrOperator[HighlightPlacedColorPlugOperator]
):
    __slots__ = ()
...
class HighlightPlacedColorField(
    Float3CompoundBaseField[
        HighlightPlacedColorAttrOperator, HighlightPlacedColorPlugOperator
    ]
):
    __slots__ = ()

    ATTR_CLS = HighlightPlacedColorAttrOperator
    PLUG_CLS = HighlightPlacedColorPlugOperator
