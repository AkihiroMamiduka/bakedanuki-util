...
class AxisPlugOperator(CompoundPlugOperator["AxisAttrOperator"]):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("axisX", "axx"),
        ("axisY", "axy"),
...
class AxisAttrOperator(CompoundAttrOperator[AxisPlugOperator]):
    __slots__ = ()
...
class AxisField(CompoundField[AxisAttrOperator, AxisPlugOperator]):
    __slots__ = ()
