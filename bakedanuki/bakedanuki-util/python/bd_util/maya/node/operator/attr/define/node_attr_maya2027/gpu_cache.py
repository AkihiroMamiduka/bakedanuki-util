...
class AiNodeAttrs_attrNodeTypeEnumPlugOperator(
    EnumPlugOperator["AiNodeAttrs_attrNodeTypeEnumAttrOperator"]
):
    __slots__ = ()
...
class AiNodeAttrs_attrNodeTypeEnumAttrOperator(
    EnumAttrOperator[AiNodeAttrs_attrNodeTypeEnumPlugOperator]
):
    __slots__ = ()
...
class AiNodeAttrs_attrNodeTypeEnumField(
    EnumField[
        AiNodeAttrs_attrNodeTypeEnumAttrOperator,
        AiNodeAttrs_attrNodeTypeEnumPlugOperator,
    ]
):
    __slots__ = ()

    ATTR_CLS = AiNodeAttrs_attrNodeTypeEnumAttrOperator
    PLUG_CLS = AiNodeAttrs_attrNodeTypeEnumPlugOperator
...
class AiNodeAttrsPlugOperator(CompoundPlugOperator["AiNodeAttrsAttrOperator"]):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("attrName", "attr_name"),
        ("attrValue", "attr_value"),
        ("attrNodeType", "attr_node_type"),
    )

    attrName = DataStringField()
    attr_name = attrName

    attrValue = DataStringField()
    attr_value = attrValue

    attrNodeType = AiNodeAttrs_attrNodeTypeEnumField(default_value=0)
    attr_node_type = attrNodeType


class AiNodeAttrsAttrOperator(CompoundAttrOperator[AiNodeAttrsPlugOperator]):
    __slots__ = ()
...
class AiNodeAttrsField(
    CompoundField[AiNodeAttrsAttrOperator, AiNodeAttrsPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = AiNodeAttrsAttrOperator
    PLUG_CLS = AiNodeAttrsPlugOperator
