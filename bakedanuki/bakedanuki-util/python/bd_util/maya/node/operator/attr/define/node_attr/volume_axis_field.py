...
class TurbulenceFrequencyField(
    Double3CompoundBaseField[
        TurbulenceFrequencyAttrOperator, TurbulenceFrequencyPlugOperator
    ]
):
    __slots__ = ()
