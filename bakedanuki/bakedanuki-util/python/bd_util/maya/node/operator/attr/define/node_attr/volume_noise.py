...
class ScalePlugOperator(Float3CompoundBasePlugOperator["ScaleAttrOperator"]):
    ...
    scaleY = FloatField(default_value=1.0, min_value=0.0)
    sy = scaleY

    scaleZ = FloatField(default_value=1.0, min_value=0.0)
    sz = scaleZ
...
class OriginPlugOperator(Float3CompoundBasePlugOperator["OriginAttrOperator"]):
    ...
    originY = FloatField(default_value=0.0)
    ory = originY

    originZ = FloatField(default_value=0.0)
    orz = originZ
...
class OriginField(
    Float3CompoundBaseField[OriginAttrOperator, OriginPlugOperator]
):
    __slots__ = ()
