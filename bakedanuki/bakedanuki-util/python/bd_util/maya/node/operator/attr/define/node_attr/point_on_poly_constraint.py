...
class Target_targetUVPlugOperator(
    Double2CompoundBasePlugOperator["Target_targetUVAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("targetU", "tu"),
    ...
    targetU = DoubleField(default_value=0.0)
    tu = targetU

    targetV = DoubleField(default_value=0.0)
    tv = targetV


class Target_targetUVAttrOperator(
    Double2CompoundBaseAttrOperator[Target_targetUVPlugOperator]
):
    __slots__ = ()
...
class Target_targetUVField(
    Double2CompoundBaseField[
        Target_targetUVAttrOperator, Target_targetUVPlugOperator
    ]
):
    __slots__ = ()

    ATTR_CLS = Target_targetUVAttrOperator
    PLUG_CLS = Target_targetUVPlugOperator
...
class TargetPlugOperator(CompoundPlugOperator["TargetAttrOperator"]):
    ...
    targetUV = Target_targetUVField(default_value=(0.0, 0.0))
    tuv = targetUV
...
class OffsetTranslateField(
    DoubleLinear3CompoundBaseField[
        OffsetTranslateAttrOperator, OffsetTranslatePlugOperator
    ]
):
    __slots__ = ()
...
class OffsetRotateField(
    DoubleAngle3CompoundBaseField[
        OffsetRotateAttrOperator, OffsetRotatePlugOperator
    ]
):
    __slots__ = ()
