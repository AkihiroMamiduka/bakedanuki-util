...
class WhitenessPlugOperator(
    Float3CompoundBasePlugOperator["WhitenessAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("whitenessR", "wnr"),
    ...
    whitenessR = FloatField(default_value=0.5, min_value=0.0, max_value=1.0)
    wnr = whitenessR

    whitenessG = FloatField(default_value=0.5, min_value=0.0, max_value=1.0)
    wng = whitenessG

    whitenessB = FloatField(default_value=0.5, min_value=0.0, max_value=1.0)
    wnb = whitenessB


class WhitenessAttrOperator(
    Float3CompoundBaseAttrOperator[WhitenessPlugOperator]
):
    __slots__ = ()
...
class WhitenessField(
    Float3CompoundBaseField[WhitenessAttrOperator, WhitenessPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = WhitenessAttrOperator
    PLUG_CLS = WhitenessPlugOperator
