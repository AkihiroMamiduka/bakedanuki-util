...
class DWorldUpVectorField(
    Double3CompoundBaseField[
        DWorldUpVectorAttrOperator, DWorldUpVectorPlugOperator
    ]
):
    __slots__ = ()
...
class DWorldUpVectorEndField(
    Double3CompoundBaseField[
        DWorldUpVectorEndAttrOperator, DWorldUpVectorEndPlugOperator
    ]
):
    __slots__ = ()
...
class DTwistStartEndField(
    Double2CompoundBaseField[
        DTwistStartEndAttrOperator, DTwistStartEndPlugOperator
    ]
):
    __slots__ = ()
