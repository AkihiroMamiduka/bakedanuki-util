...
class TaperCurve_taperCurve_InterpEnumPlugOperator(
    EnumPlugOperator["TaperCurve_taperCurve_InterpEnumAttrOperator"]
):
    __slots__ = ()
...
class TaperCurve_taperCurve_InterpEnumAttrOperator(
    EnumAttrOperator[TaperCurve_taperCurve_InterpEnumPlugOperator]
):
    __slots__ = ()
...
class TaperCurve_taperCurve_InterpEnumField(
    EnumField[
        TaperCurve_taperCurve_InterpEnumAttrOperator,
        TaperCurve_taperCurve_InterpEnumPlugOperator,
    ]
):
    __slots__ = ()

    ATTR_CLS = TaperCurve_taperCurve_InterpEnumAttrOperator
    PLUG_CLS = TaperCurve_taperCurve_InterpEnumPlugOperator
...
class TaperCurvePlugOperator(CompoundPlugOperator["TaperCurveAttrOperator"]):
    ...
    taperCurve_Interp = TaperCurve_taperCurve_InterpEnumField(default_value=0)
