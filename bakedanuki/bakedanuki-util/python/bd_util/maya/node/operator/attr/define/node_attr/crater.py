...
class Channel2PlugOperator(
    ...
    channel2G = FloatField(default_value=1.0, min_value=0.0, max_value=1.0)
    c2g = channel2G

    channel2B = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    c2b = channel2B
...
class Channel3PlugOperator(
    ...
    channel3R = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    c3r = channel3R

    channel3G = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    c3g = channel3G

    channel3B = FloatField(default_value=1.0, min_value=0.0, max_value=1.0)
    c3b = channel3B
