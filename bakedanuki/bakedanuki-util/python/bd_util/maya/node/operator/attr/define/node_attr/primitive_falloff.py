...
class PositiveSizeField(
    DoubleLinear3CompoundBaseField[
        PositiveSizeAttrOperator, PositiveSizePlugOperator
    ]
):
    __slots__ = ()
...
class NegativeSizeField(
    DoubleLinear3CompoundBaseField[
        NegativeSizeAttrOperator, NegativeSizePlugOperator
    ]
):
    __slots__ = ()
...
class RampPlugOperator(CompoundPlugOperator["RampAttrOperator"]):
    ...
    ramp_Interp = Ramp_ramp_InterpEnumField(default_value=0)
    rmpi = ramp_Interp
