...
class IntersectionPlugOperator(
    Float3CompoundBasePlugOperator["IntersectionAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
    ...
    intersectionR = FloatField(default_value=0.0)
    intersectionr = intersectionR

    intersectionG = FloatField(default_value=0.0)
    intersectiong = intersectionG

    intersectionB = FloatField(default_value=0.0)
    intersectionb = intersectionB


class IntersectionAttrOperator(
    Float3CompoundBaseAttrOperator[IntersectionPlugOperator]
):
    __slots__ = ()
...
class IntersectionField(
    Float3CompoundBaseField[IntersectionAttrOperator, IntersectionPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = IntersectionAttrOperator
    PLUG_CLS = IntersectionPlugOperator
