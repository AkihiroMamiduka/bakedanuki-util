...
class PointPlugOperator(
    CompoundPlugOperator["PointAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("pointX", "px"),
...
class PointAttrOperator(
    CompoundAttrOperator[PointPlugOperator]
):
    __slots__ = ()
...
class PointField(
    CompoundField[PointAttrOperator, PointPlugOperator]
):
    __slots__ = ()
