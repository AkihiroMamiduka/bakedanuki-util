...
class PointPlugOperator(CompoundPlugOperator["PointAttrOperator"]):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("pointX", "px"),
        ("pointY", "py"),
    ...
    pointX = DoubleField(default_value=0.0)
    px = pointX

    pointY = DoubleField(default_value=0.0)
    py = pointY

    pointZ = DoubleField(default_value=0.0)
    pz = pointZ


class PointAttrOperator(CompoundAttrOperator[PointPlugOperator]):
    __slots__ = ()
...
class PointField(CompoundField[PointAttrOperator, PointPlugOperator]):
    __slots__ = ()

    ATTR_CLS = PointAttrOperator
    PLUG_CLS = PointPlugOperator
