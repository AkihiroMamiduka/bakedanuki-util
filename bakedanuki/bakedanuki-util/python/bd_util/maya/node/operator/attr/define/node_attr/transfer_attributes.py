...
class SearchScalePlugOperator(
    DoubleLinear3CompoundBasePlugOperator["SearchScaleAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("searchScaleX", "ssx"),
    ...
    searchScaleX = DoubleLinearField(default_value=1.0)
    ssx = searchScaleX

    searchScaleY = DoubleLinearField(default_value=1.0)
    ssy = searchScaleY

    searchScaleZ = DoubleLinearField(default_value=1.0)
    ssz = searchScaleZ


class SearchScaleAttrOperator(
    DoubleLinear3CompoundBaseAttrOperator[SearchScalePlugOperator]
):
    __slots__ = ()
...
class SearchScaleField(
    DoubleLinear3CompoundBaseField[SearchScaleAttrOperator, SearchScalePlugOperator]
):
    __slots__ = ()

    ATTR_CLS = SearchScaleAttrOperator
    PLUG_CLS = SearchScalePlugOperator
