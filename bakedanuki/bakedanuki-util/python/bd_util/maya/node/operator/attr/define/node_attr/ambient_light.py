...
class NormalCameraPlugOperator(
    ...
    normalCameraX = FloatField(default_value=1.0, readable=False)
    nx = normalCameraX

    normalCameraY = FloatField(default_value=1.0, readable=False)
    ny = normalCameraY

    normalCameraZ = FloatField(default_value=1.0, readable=False)
    nz = normalCameraZ
