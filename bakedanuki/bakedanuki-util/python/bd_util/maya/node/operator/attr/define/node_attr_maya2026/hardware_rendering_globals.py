...
class BatchRenderControls_renderModeEnumPlugOperator(
    EnumPlugOperator["BatchRenderControls_renderModeEnumAttrOperator"]
):
    __slots__ = ()
...
class BatchRenderControls_renderModeEnumAttrOperator(
    EnumAttrOperator[BatchRenderControls_renderModeEnumPlugOperator]
):
    __slots__ = ()
...
class BatchRenderControls_renderModeEnumField(
    EnumField[
        BatchRenderControls_renderModeEnumAttrOperator,
        BatchRenderControls_renderModeEnumPlugOperator,
    ]
):
    __slots__ = ()

    ATTR_CLS = BatchRenderControls_renderModeEnumAttrOperator
    PLUG_CLS = BatchRenderControls_renderModeEnumPlugOperator


class BatchRenderControls_lightingModeEnumPlugOperator(
    EnumPlugOperator["BatchRenderControls_lightingModeEnumAttrOperator"]
):
    __slots__ = ()
...
class BatchRenderControls_lightingModeEnumAttrOperator(
    EnumAttrOperator[BatchRenderControls_lightingModeEnumPlugOperator]
):
    __slots__ = ()
...
class BatchRenderControls_lightingModeEnumField(
    EnumField[
        BatchRenderControls_lightingModeEnumAttrOperator,
        BatchRenderControls_lightingModeEnumPlugOperator,
    ]
):
    __slots__ = ()

    ATTR_CLS = BatchRenderControls_lightingModeEnumAttrOperator
    PLUG_CLS = BatchRenderControls_lightingModeEnumPlugOperator
...
class BatchRenderControlsPlugOperator(
    ...
    renderMode = BatchRenderControls_renderModeEnumField(default_value=4)
    rm = renderMode

    lightingMode = BatchRenderControls_lightingModeEnumField(default_value=1)
    lm = lightingMode
