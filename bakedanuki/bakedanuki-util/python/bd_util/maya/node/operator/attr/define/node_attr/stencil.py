...
class ColorKeyPlugOperator(
    Float3CompoundBasePlugOperator["ColorKeyAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("colorKeyR", "ckr"),
    ...
    colorKeyR = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    ckr = colorKeyR

    colorKeyG = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    ckg = colorKeyG

    colorKeyB = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    ckb = colorKeyB


class ColorKeyAttrOperator(
    Float3CompoundBaseAttrOperator[ColorKeyPlugOperator]
):
    __slots__ = ()
...
class ColorKeyField(
    Float3CompoundBaseField[ColorKeyAttrOperator, ColorKeyPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = ColorKeyAttrOperator
    PLUG_CLS = ColorKeyPlugOperator
