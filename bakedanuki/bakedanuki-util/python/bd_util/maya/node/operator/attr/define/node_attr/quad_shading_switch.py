...
class DefaultPlugOperator(CompoundPlugOperator["DefaultAttrOperator"]):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("defTriple", "dtr"),
        ("defSingle", "dsi"),
...
class DefaultAttrOperator(CompoundAttrOperator[DefaultPlugOperator]):
    __slots__ = ()
...
class DefaultField(CompoundField[DefaultAttrOperator, DefaultPlugOperator]):
    __slots__ = ()
