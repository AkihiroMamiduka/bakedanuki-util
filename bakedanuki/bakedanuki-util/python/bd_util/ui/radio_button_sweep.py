...
class RadioButtonSweep(qt.QObject):
    ...
    def __init__(self, scope: qt.QWidget) -> None:
        ...
        self._scope = scope
        self._buttons: list[qt.QRadioButton] = []
        self._origin: qt.QRadioButton | None = None
        self._cancelled_origin: qt.QRadioButton | None = None
    ...
    def eventFilter(self, watched: qt.QObject, event: qt.QEvent) -> bool:
        ...
        if isinstance(event, qt.QtGui.QMouseEvent):
            if kind == qt.QEvent.Type.MouseButtonPress:
                ...
                if (
                    isinstance(watched, qt.QRadioButton)
    ...
    def _visit(self, position: qt.QPoint) -> None:
        ...
        candidates: list[tuple[float, qt.QRadioButton]] = []
        for button in self._buttons:
