...
class AnimBlendNodeAdditiveDL(DG):
    __slots__ = ()
    ...
    inputA = DoubleLinearField(default_value=0.0)
    ia = inputA

    inputB = DoubleLinearField(default_value=0.0)
    ib = inputB

    output = DoubleLinearField(default_value=0.0)
    o = output
