...
class SnowColorPlugOperator(
    Float3CompoundBasePlugOperator["SnowColorAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("snowColorR", "scr"),
    ...
    snowColorR = FloatField(default_value=1.0, min_value=0.0, max_value=1.0)
    scr = snowColorR

    snowColorG = FloatField(default_value=1.0, min_value=0.0, max_value=1.0)
    scg = snowColorG

    snowColorB = FloatField(default_value=1.0, min_value=0.0, max_value=1.0)
    scb = snowColorB


class SnowColorAttrOperator(
    Float3CompoundBaseAttrOperator[SnowColorPlugOperator]
):
    __slots__ = ()
...
class SnowColorField(
    Float3CompoundBaseField[SnowColorAttrOperator, SnowColorPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = SnowColorAttrOperator
    PLUG_CLS = SnowColorPlugOperator
...
class RockColorPlugOperator(
    Float3CompoundBasePlugOperator["RockColorAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("rockColorR", "rcr"),
...
class RockColorAttrOperator(
    Float3CompoundBaseAttrOperator[RockColorPlugOperator]
):
    __slots__ = ()
...
class RockColorField(
    Float3CompoundBaseField[RockColorAttrOperator, RockColorPlugOperator]
):
    __slots__ = ()
