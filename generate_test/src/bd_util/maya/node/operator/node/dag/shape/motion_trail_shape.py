...
class TrailDrawModeEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class TrailDrawModeEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class TrailPathModeEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class TrailPathModeEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class MotionTrailShape(Shape):
    ...
    fadeInoutFrames = LongField(default_value=0, min_value=0, soft_max_value=10)
    fi = fadeInoutFrames
    ...
    trailColor = TrailColorField(default_value=(0.49000000953674316, 0.09799999743700027, 0.125))
    tc = trailColor
    ...
    extraTrailColor = ExtraTrailColorField(default_value=(0.125, 0.09799999743700027, 0.49000000953674316))
    etc = extraTrailColor
    ...
    activeKeyframeColor = ActiveKeyframeColorField(default_value=(1.0, 1.0, 0.0))
    ...
    slowTrailColor = SlowTrailColorField(default_value=(0.23000000417232513, 0.07100000232458115, 0.40400001406669617))
    stc = slowTrailColor
    ...
    fastTrailColor = FastTrailColorField(default_value=(0.6119999885559082, 0.0, 0.0))
    ftc = fastTrailColor
    ...
    increment = TimeField(default_value=2.5)
    b = increment

    tangentPoints = TangentPointsField(multi=True, default_value=(0.0, 0.0, 0.0))
    tps = tangentPoints
    ...
    frameMarkerColor = FrameMarkerColorField(default_value=(0.1550000011920929, 0.5529999732971191, 0.11100000143051147))
    fc = frameMarkerColor
    ...
    extraKeyframeColor = ExtraKeyframeColorField(default_value=(0.45100000500679016, 0.45100000500679016, 0.45100000500679016))
