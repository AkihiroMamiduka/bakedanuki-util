...
from ....attr.define.node_attr.c_muscle_displace import (
    BoundingBoxField,
    CenterField,
    ColorWireframe2Field,
    ColorWireframeField,
...
class CMuscleDisplace(Shape):
    __slots__ = ()

    NODE_TYPE = "cMuscleDisplace"
    ...
    ddata = dispData
    worldMatrixDisp = dispData.worldMatrixDisp
    wmd = worldMatrixDisp
    ...
    colorWireframe = ColorWireframeField(default_value=(0.0, 0.30000001192092896, 0.8999999761581421), min_value=(0.0, 0.0, 0.0), max_value=(1.0, 1.0, 1.0))
    colw = colorWireframe
    colorWireframeR = colorWireframe.colorWireframeR
    colwr = colorWireframeR
    colorWireframeG = colorWireframe.colorWireframeG
    colwg = colorWireframeG
    colorWireframeB = colorWireframe.colorWireframeB
    colwb = colorWireframeB

    colorWireframe2 = ColorWireframe2Field(default_value=(0.0, 1.0, 0.0), min_value=(0.0, 0.0, 0.0), max_value=(1.0, 1.0, 1.0))
    colw2 = colorWireframe2
    colorWireframe2R = colorWireframe2.colorWireframe2R
    colw2r = colorWireframe2R
    colorWireframe2G = colorWireframe2.colorWireframe2G
    colw2g = colorWireframe2G
    colorWireframe2B = colorWireframe2.colorWireframe2B
    colw2b = colorWireframe2B

    nSides = LongField(default_value=18, min_value=6, max_value=42)
    sid = nSides
