...
from ....attr.define.node_attr.vortex_field import (
    AxialMagnitudeField,
    AxisField,
    CurveRadiusField,
    FalloffCurveField,
...
class VortexField(Transform):
    __slots__ = ()

    NODE_TYPE = "vortexField"
    ...
    axis = AxisField(default_value=(0.0, 0.0, 0.0), soft_min_value=(-1.0, -1.0, -1.0), soft_max_value=(1.0, 1.0, 1.0))
    ax = axis
    axisX = axis.axisX
    axx = axisX
    axisY = axis.axisY
