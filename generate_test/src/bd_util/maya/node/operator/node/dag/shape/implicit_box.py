...
from ....attr.define.node_attr.implicit_box import (
    BoundingBoxField,
    CenterField,
...
class ImplicitBox(Shape):
    __slots__ = ()

    NODE_TYPE = "implicitBox"
    ...
    box = TypedField(writable=False)
    s = box

    size = SizeField(default_value=(2.0, 2.0, 2.0), soft_min_value=(0.0, 0.0, 0.0), soft_max_value=(10.0, 10.0, 10.0))
    siz = size
    sizeX = size.sizeX
    szx = sizeX
    sizeY = size.sizeY
