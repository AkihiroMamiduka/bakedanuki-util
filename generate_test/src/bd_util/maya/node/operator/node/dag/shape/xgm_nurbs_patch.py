...
from ....attr.define.node_attr.xgm_nurbs_patch import (
    BboxCorner1Field,
    BboxCorner2Field,
    BoundingBoxField,
...
class XgmNurbsPatch(Shape):
    __slots__ = ()

    NODE_TYPE = "xgmNurbsPatch"
    ...
    geomHitOut = BoolField(default_value=False)
    go = geomHitOut

    transform = MatrixField()
    t = transform
    ...
    geometry = DataNurbsSurfaceField()
    geo = geometry
