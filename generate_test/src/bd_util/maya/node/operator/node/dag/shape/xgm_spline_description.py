...
from ....attr.define.node_attr.xgm_spline_description import (
    BoundingBoxField,
...
class XgmSplineDescription(Shape):
    __slots__ = ()
    ...
    preSelHighlightColor = PreSelHighlightColorField(default_value=(0.44999998807907104, 1.0, 0.44999998807907104))
    ...
    selectionHighlightColor = SelectionHighlightColorField(default_value=(1.0, 1.0, 0.0))
    ...
    showFrozenColor = ShowFrozenColorField(default_value=(0.0, 0.44999998807907104, 0.8999999761581421))
    sfc = showFrozenColor
    ...
    highlightPlacedColor = HighlightPlacedColorField(default_value=(0.0, 0.3176470696926117, 0.09019608050584793))
    ...
    highlightPlacedIntensity = FloatField(default_value=0.5, min_value=0.0, max_value=1.0)
    hpi = highlightPlacedIntensity

    showCVs = BoolField(default_value=False)
    scv = showCVs

    showCVsSize = FloatField(default_value=3.0, min_value=1.0, max_value=30.0, soft_max_value=10.0)
    scvs = showCVsSize

    showCVsOpacity = FloatField(default_value=0.5, min_value=0.0, max_value=1.0)
    scvo = showCVsOpacity
    ...
    renderDensityMultiplier = FloatField(default_value=1.0, min_value=0.0, soft_min_value=0.001, soft_max_value=100.0)
