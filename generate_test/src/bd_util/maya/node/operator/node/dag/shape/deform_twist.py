...
from ....attr.define.node_attr.deform_twist import (
    BoundingBoxField,
    CenterField,
    DrawOverrideField,
    GhostColorPostField,
...
class DeformTwist(Shape):
    ...
    startAngle = DoubleAngleField(default_value=0.0, soft_min_value=-859.4366926962348, soft_max_value=859.4366926962348)
    sa = startAngle

    endAngle = DoubleAngleField(default_value=0.0, soft_min_value=-859.4366926962348, soft_max_value=859.4366926962348)
    ea = endAngle
