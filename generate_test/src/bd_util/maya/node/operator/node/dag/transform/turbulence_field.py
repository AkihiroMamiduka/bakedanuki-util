...
class TurbulenceField(Transform):
    __slots__ = ()
    ...
    frequency = DoubleField(default_value=1.0, min_value=0.0, soft_max_value=100.0)
    frq = frequency

    phaseX = DoubleField(default_value=0.0, soft_min_value=-50.0, soft_max_value=50.0)
    phx = phaseX

    phaseY = DoubleField(default_value=0.0, soft_min_value=-50.0, soft_max_value=50.0)
    phy = phaseY

    phaseZ = DoubleField(default_value=0.0, soft_min_value=-50.0, soft_max_value=50.0)
    phz = phaseZ

    noiseLevel = LongField(default_value=0, soft_min_value=0, soft_max_value=8)
    nslv = noiseLevel

    noiseRatio = DoubleField(default_value=0.707, soft_min_value=0.0, soft_max_value=1.0)
    nsrt = noiseRatio
