...
from ....attr.define.node_attr.directional_light import (
    BoundingBoxField,
    CenterField,
    ColorField,
    DrawOverrideField,
...
class DirectionalLight(Shape):
    ...
    useLightPosition = BoolField(default_value=False)
    up = useLightPosition
    ...
    aiAngle = FloatField(default_value=0.0, min_value=0.0, max_value=180.0, soft_max_value=10.0, category="arnold")
    ai_angle = aiAngle
