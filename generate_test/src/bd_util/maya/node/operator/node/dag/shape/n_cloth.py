...
class BendSolverEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class BendSolverEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class InputAttractMethodEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class InputAttractMethodEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class InputAttractMethodEnumField(
    EnumField[InputAttractMethodEnumAttrOperator, InputAttractMethodEnumPlugOperator]
):
    __slots__ = ()
...
class StretchMapTypeEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class StretchMapTypeEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class CompressionMapTypeEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class CompressionMapTypeEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class CompressionMapTypeEnumField(
    EnumField[CompressionMapTypeEnumAttrOperator, CompressionMapTypeEnumPlugOperator]
):
    __slots__ = ()
...
class BendMapTypeEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class BendMapTypeEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class BendAngleDropoffMapTypeEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class BendAngleDropoffMapTypeEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class BendAngleDropoffMapTypeEnumField(
    EnumField[BendAngleDropoffMapTypeEnumAttrOperator, BendAngleDropoffMapTypeEnumPlugOperator]
):
    __slots__ = ()
...
class RestitutionAngleMapTypeEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class RestitutionAngleMapTypeEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class RestitutionAngleMapTypeEnumField(
    EnumField[RestitutionAngleMapTypeEnumAttrOperator, RestitutionAngleMapTypeEnumPlugOperator]
):
    __slots__ = ()
...
class RigidityMapTypeEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class RigidityMapTypeEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class DeformMapTypeEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class DeformMapTypeEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class InputAttractMapTypeEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class InputAttractMapTypeEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class InputAttractMapTypeEnumField(
    EnumField[InputAttractMapTypeEnumAttrOperator, InputAttractMapTypeEnumPlugOperator]
):
    __slots__ = ()
...
class RestLengthScaleMapTypeEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class RestLengthScaleMapTypeEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class RestLengthScaleMapTypeEnumField(
    EnumField[RestLengthScaleMapTypeEnumAttrOperator, RestLengthScaleMapTypeEnumPlugOperator]
):
    __slots__ = ()
...
class LiftMapTypeEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class LiftMapTypeEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class DragMapTypeEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class DragMapTypeEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class TangentialDragMapTypeEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class TangentialDragMapTypeEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class TangentialDragMapTypeEnumField(
    EnumField[TangentialDragMapTypeEnumAttrOperator, TangentialDragMapTypeEnumPlugOperator]
):
    __slots__ = ()
...
class WrinkleMapTypeEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class WrinkleMapTypeEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class CacheUsageEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class CacheUsageEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class NCloth(Shape):
    ...
    stretchResistance = FloatField(default_value=20.0, soft_min_value=0.0, soft_max_value=200.0)
    ...
    bendResistance = FloatField(default_value=0.10000000149011612, soft_min_value=0.0, soft_max_value=200.0)
    bnd = bendResistance
    ...
    restitutionTension = FloatField(default_value=1000.0, soft_min_value=0.0, soft_max_value=1000.0)
    retn = restitutionTension

    restitutionAngle = FloatAngleField(default_value=360.00001001791264, soft_min_value=0.0, soft_max_value=360.0)
    ...
    deformResistance = FloatField(default_value=0.0, soft_min_value=0.0, soft_max_value=10.0)
    ...
    inputMeshAttract = FloatField(default_value=0.0, soft_min_value=0.0, soft_max_value=1.0)
    imat = inputMeshAttract

    inputAttractMethod = InputAttractMethodEnumField(default_value=0)
    iatm = inputAttractMethod

    collideLastThreshold = FloatField(default_value=0.20000000298023224, soft_min_value=0.0, soft_max_value=1.0)
    ...
    inputMotionDrag = FloatField(default_value=0.0, soft_min_value=0.0, soft_max_value=1.0)
    ...
    wrinkleMapScale = FloatField(default_value=1.0, soft_min_value=-2.0, soft_max_value=2.0)
    wms = wrinkleMapScale
    ...
    stretchHierarchyLevels = LongField(default_value=0, min_value=0, soft_max_value=10)
    shlv = stretchHierarchyLevels

    stretchHierarchyPercent = FloatField(default_value=25.0, soft_min_value=0.0, soft_max_value=100.0)
    ...
    selfCollisionSoftness = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    scsf = selfCollisionSoftness

    selfCrossoverPush = FloatField(default_value=0.0, min_value=0.0, soft_max_value=1.0)
    ...
    startPressure = FloatField(default_value=0.0, soft_min_value=-1.0, soft_max_value=1.0)
    stpe = startPressure

    incompressibility = FloatField(default_value=5.0, soft_min_value=0.0, soft_max_value=200.0)
    incm = incompressibility

    pressureDamping = FloatField(default_value=0.0, soft_min_value=0.0, soft_max_value=1.0)
    prdg = pressureDamping

    pumpRate = FloatField(default_value=0.0, soft_min_value=-1.0, soft_max_value=1.0)
    pure = pumpRate

    airTightness = FloatField(default_value=1.0, soft_min_value=0.0, soft_max_value=1.0)
    aits = airTightness
    ...
    lift = FloatField(default_value=0.05000000074505806, soft_min_value=0.0, soft_max_value=2.0)
    lft = lift

    drag = FloatField(default_value=0.05000000074505806, soft_min_value=0.0, soft_max_value=2.0)
    drg = drag

    tangentialDrag = FloatField(default_value=0.0, soft_min_value=0.0, soft_max_value=1.0)
    tdrg = tangentialDrag
