...
from ....attr.define.node_attr.c_muscle_keep_out import (
    BoundingBoxField,
    CenterField,
...
class CMuscleKeepOut(Shape):
    __slots__ = ()

    NODE_TYPE = "cMuscleKeepOut"
    ...
    en = enable
    worldMatrixAim = inputData.worldMatrixAim
    wma = worldMatrixAim
    inDirection = inputData.inDirection
    od = inDirection
    ...
    userScaleX = DoubleField()
    usx = userScaleX

    userScaleY = DoubleField()
    usy = userScaleY

    userScaleZ = DoubleField()
    usz = userScaleZ
    ...
    ot = outTranslate
    outTranslateLocal = outputData.outTranslateLocal
