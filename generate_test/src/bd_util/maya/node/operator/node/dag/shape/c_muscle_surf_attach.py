...
from ....attr.define.node_attr.c_muscle_surf_attach import (
    BoundingBoxField,
    CenterField,
...
class CMuscleSurfAttach(Shape):
    __slots__ = ()

    NODE_TYPE = "cMuscleSurfAttach"
    ...
    idat = inputData
    surfIn = inputData.surfIn
    surf = surfIn
    inRotOrder = inputData.inRotOrder
    irord = inRotOrder
    uLoc = inputData.uLoc
    ul = uLoc
    vLoc = inputData.vLoc
    vl = vLoc
    edgeIdx1 = inputData.edgeIdx1
    ei1 = edgeIdx1
    edgeIdx2 = inputData.edgeIdx2
    ei2 = edgeIdx2
    fixPolyFlip = inputData.fixPolyFlip
    fply = fixPolyFlip
    size = inputData.size
    siz = size

    outputData = OutputDataField()
    odat = outputData
    outTranslate = outputData.outTranslate
    ot = outTranslate
    outRotate = outputData.outRotate
    or_ = outRotate
    outTangent = outputData.outTangent
    otg = outTangent
    outUp = outputData.outUp
    ou = outUp
