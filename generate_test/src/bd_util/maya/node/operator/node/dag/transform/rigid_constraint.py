...
class RelativeToEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class RelativeToEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class RigidConstraint(Transform):
    ...
    angularVelocity = AngularVelocityField(default_value=(0.0, 0.0, 0.0), writable=False)
    avl = angularVelocity
    ...
    springStiffness = DoubleField(default_value=5.0, min_value=0.0, soft_max_value=5.0)
    sst = springStiffness

    springDamping = DoubleField(default_value=0.1, min_value=-100.0, max_value=100.0, soft_min_value=-10.0, soft_max_value=10.0)
    dmp = springDamping

    springRestLength = DoubleField(default_value=1.0, soft_min_value=0.0, soft_max_value=100.0)
    ...
    userDefinedPosition = UserDefinedPositionField(default_value=(0.0, 0.0, 0.0))
