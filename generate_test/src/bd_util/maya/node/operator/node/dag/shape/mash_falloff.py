...
from ....attr.define.node_attr.mash_falloff import (
    BoundingBoxField,
    CenterField,
    ColourField,
...
class FalloffShapeEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class FalloffShapeEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class FalloffShapeEnumField(
    EnumField[FalloffShapeEnumAttrOperator, FalloffShapeEnumPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = FalloffShapeEnumAttrOperator
    PLUG_CLS = FalloffShapeEnumPlugOperator


class FalloffEventTypeEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class FalloffEventTypeEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class FalloffEventTypeEnumField(
    EnumField[FalloffEventTypeEnumAttrOperator, FalloffEventTypeEnumPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = FalloffEventTypeEnumAttrOperator
    PLUG_CLS = FalloffEventTypeEnumPlugOperator


class MeshModeEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class MeshModeEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class MeshModeEnumField(
    EnumField[MeshModeEnumAttrOperator, MeshModeEnumPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = MeshModeEnumAttrOperator
    PLUG_CLS = MeshModeEnumPlugOperator


class ComponentReadTypeEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class ComponentReadTypeEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class ComponentReadTypeEnumField(
    EnumField[ComponentReadTypeEnumAttrOperator, ComponentReadTypeEnumPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = ComponentReadTypeEnumAttrOperator
    PLUG_CLS = ComponentReadTypeEnumPlugOperator


class MASH_Falloff(Shape):
    __slots__ = ()

    NODE_TYPE = "MASH_Falloff"
    ...
    falloffOut = GenericField()

    inMatrix = MatrixField()

    shapeMatrix = MatrixField()

    falloffIn = GenericField()

    shapeIn = GenericField()

    enable = BoolField(default_value=True)

    invertFalloff = BoolField(default_value=False)

    excludeInterior = BoolField(default_value=False)

    raytrace = BoolField(default_value=False)

    searchRadius = FloatField(default_value=1.0, min_value=0.001, soft_max_value=50.0)

    fade = FloatField(default_value=0.0, soft_min_value=0.0, soft_max_value=0.1)

    innerRadius = FloatField(default_value=0.30000001192092896, min_value=0.0, max_value=1.0)

    falloffShape = FalloffShapeEnumField(default_value=1)

    falloffEventType = FalloffEventTypeEnumField(default_value=1)

    meshMode = MeshModeEnumField(default_value=1)

    componentReadType = ComponentReadTypeEnumField(default_value=1)

    falloffRamp = FalloffRampField(multi=True, default_value=(0.0, 0.0, 1.0))
    falloffR = falloffRamp

    vertexColour = VertexColourField(default_value=(1.0, 0.3499999940395355, 0.699999988079071))
    vertexColourR = vertexColour.vertexColourR
    vertexColourr = vertexColourR
    vertexColourG = vertexColour.vertexColourG
    vertexColourg = vertexColourG
    vertexColourB = vertexColour.vertexColourB
    vertexColourb = vertexColourB

    colour = ColourField(default_value=(0.699999988079071, 0.8500000238418579, 1.0))
    colourR = colour.colourR
    colourr = colourR
    colourG = colour.colourG
    colourg = colourG
    colourB = colour.colourB
    colourb = colourB
