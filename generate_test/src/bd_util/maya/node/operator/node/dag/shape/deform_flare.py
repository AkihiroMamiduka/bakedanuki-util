...
from ....attr.define.node_attr.deform_flare import (
    BoundingBoxField,
    CenterField,
    DrawOverrideField,
    GhostColorPostField,
...
class DeformFlare(Shape):
    ...
    lowBound = DoubleField(default_value=-1.0, max_value=0.0, soft_min_value=-10.0, soft_max_value=0.0)
    lb = lowBound

    highBound = DoubleField(default_value=1.0, min_value=0.0, soft_min_value=0.0, soft_max_value=10.0)
    hb = highBound

    startFlareX = DoubleField(default_value=1.0, soft_min_value=0.0, soft_max_value=10.0)
    sfx = startFlareX

    startFlareZ = DoubleField(default_value=1.0, soft_min_value=0.0, soft_max_value=10.0)
    sfz = startFlareZ

    endFlareX = DoubleField(default_value=1.0, soft_min_value=0.0, soft_max_value=10.0)
    efx = endFlareX

    endFlareZ = DoubleField(default_value=1.0, soft_min_value=0.0, soft_max_value=10.0)
    efz = endFlareZ

    curve = DoubleField(default_value=0.0, soft_min_value=-3.0, soft_max_value=3.0)
    crv = curve
