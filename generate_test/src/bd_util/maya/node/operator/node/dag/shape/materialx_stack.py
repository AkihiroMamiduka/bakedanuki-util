...
from ....attr.define.node_attr.materialx_stack import (
    BoundingBoxField,
    CenterField,
...
class MaterialxStack(Shape):
    __slots__ = ()

    NODE_TYPE = "materialxStack"
    ...
    documents = DataStringField()
    docs = documents

    stack = TypedField(writable=False)
    sk = stack
