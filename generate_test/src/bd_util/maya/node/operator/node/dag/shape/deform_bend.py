...
from ....attr.define.node_attr.deform_bend import (
    BoundingBoxField,
    CenterField,
    DrawOverrideField,
    GhostColorPostField,
...
class DeformBend(Shape):
    ...
    curvature = DoubleAngleField(default_value=0.0, soft_min_value=-179.9998479605043, soft_max_value=179.9998479605043)
    cur = curvature
