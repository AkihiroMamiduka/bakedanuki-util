...
from ....attr.define.node_attr.spring import (
    BoundingBoxField,
    CenterField,
    DrawOverrideField,
    GhostColorPostField,
...
class Spring(Shape):
    ...
    stiffness = DoubleField(default_value=1.0, min_value=0.0, soft_max_value=20.0)
    s = stiffness

    damping = DoubleField(default_value=0.2, min_value=0.0, soft_max_value=20.0)
    d = damping

    restLength = DoubleField(default_value=0.0, min_value=0.0, soft_max_value=20.0)
    r = restLength
