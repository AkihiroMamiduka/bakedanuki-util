...
from ....attr.define.node_attr.pxr_hd_imaging_shape import (
    BoundingBoxField,
...
class SelectionResolutionEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class SelectionResolutionEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
    ...
    NAME_MAP = {
        ...
        _4096X4096: "4096x4096",
    }


class SelectionResolutionEnumField(
    EnumField[SelectionResolutionEnumAttrOperator, SelectionResolutionEnumPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = SelectionResolutionEnumAttrOperator
    PLUG_CLS = SelectionResolutionEnumPlugOperator


class PxrHdImagingShape(Shape):
    __slots__ = ()

    NODE_TYPE = "pxrHdImagingShape"
    ...
    selectionResolution = SelectionResolutionEnumField(default_value=256)
    sr = selectionResolution

    enableDepthSelection = BoolField(default_value=False)
    eds = enableDepthSelection
