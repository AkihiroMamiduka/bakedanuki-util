...
from ....attr.define.node_attr.newton_field import (
    AxialMagnitudeField,
    CurveRadiusField,
    FalloffCurveField,
    InputDataField,
...
class NewtonField(Transform):
    __slots__ = ()

    NODE_TYPE = "newtonField"
    ...
    minDistance = DoubleField(default_value=0.0, min_value=0.0, soft_min_value=0.0, soft_max_value=100.0)
    min = minDistance

    ownerMassData = DataDoubleArrayField()
    omd = ownerMassData
