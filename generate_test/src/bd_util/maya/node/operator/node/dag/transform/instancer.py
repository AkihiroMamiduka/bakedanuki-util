...
class RotationAngleUnitsEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class RotationAngleUnitsEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class RotationAngleUnitsEnumField(
    EnumField[RotationAngleUnitsEnumAttrOperator, RotationAngleUnitsEnumPlugOperator]
):
    __slots__ = ()
...
class CycleEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class CycleEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class CycleEnumField(
    EnumField[CycleEnumAttrOperator, CycleEnumPlugOperator]
):
    __slots__ = ()
...
class CycleStepUnitEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class CycleStepUnitEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class Instancer(Transform):
    ...
    displayPercentage = DoubleField(default_value=100.0, min_value=0.0, max_value=100.0, soft_min_value=0.0, soft_max_value=100.0)
