...
class MayaUsdProxyShape(Shape):
    ...
    complexity = LongField(default_value=0, min_value=0, max_value=8, soft_max_value=4)
    cplx = complexity
    ...
    forceCompute = BoolField(default_value=False, readable=False)
