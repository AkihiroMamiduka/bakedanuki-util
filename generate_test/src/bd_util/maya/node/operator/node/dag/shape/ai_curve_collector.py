...
class AiCurveCollector(Shape):
    ...
    aiCurveWidth = FloatField(default_value=0.009999999776482582, min_value=0.0, soft_min_value=0.0, soft_max_value=1.0, category="arnold")

    aiSampleRate = LongField(default_value=5, min_value=1, soft_min_value=1, soft_max_value=20, category="arnold")
    ...
    aiWidthProfile = AiWidthProfileField(multi=True, default_value=(0.0, 0.0, 1.0))
