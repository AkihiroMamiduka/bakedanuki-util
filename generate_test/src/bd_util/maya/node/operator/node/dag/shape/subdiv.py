...
class DisplayFilterEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class DisplayFilterEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class ScalingHierarchyEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class ScalingHierarchyEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class ScalingHierarchyEnumField(
    EnumField[ScalingHierarchyEnumAttrOperator, ScalingHierarchyEnumPlugOperator]
):
    __slots__ = ()
...
class Subdiv(Shape):
    ...
    dispResolution = LongField(default_value=1, min_value=0, max_value=3, soft_min_value=0, soft_max_value=3)
    dr = dispResolution
    ...
    depth = LongField(default_value=2, min_value=0, max_value=7, soft_min_value=0, soft_max_value=5)
    d = depth

    sampleCount = LongField(default_value=4, min_value=1, max_value=50, soft_min_value=1, soft_max_value=5)
    sc = sampleCount
