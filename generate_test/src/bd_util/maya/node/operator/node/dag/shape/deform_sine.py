...
from ....attr.define.node_attr.deform_sine import (
    BoundingBoxField,
    CenterField,
    DrawOverrideField,
    GhostColorPostField,
...
class DeformSine(Shape):
    ...
    wavelength = DoubleField(default_value=2.0, min_value=0.001, soft_min_value=0.1, soft_max_value=10.0)
    wav = wavelength
