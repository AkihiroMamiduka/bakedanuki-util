...
from ....attr.define.node_attr.dropoff_locator import (
    BoundingBoxField,
    CenterField,
...
class DropoffLocator(Shape):
    __slots__ = ()

    NODE_TYPE = "dropoffLocator"
    ...
    percent = FloatField(default_value=1.0, min_value=0.0, max_value=10.0, soft_min_value=0.0, soft_max_value=1.0)
    pc = percent

    param = FloatField(default_value=0.0)
    pr = param
