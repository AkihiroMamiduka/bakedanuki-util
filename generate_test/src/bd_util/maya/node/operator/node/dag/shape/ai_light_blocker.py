...
class GeometryTypeEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class GeometryTypeEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class RampAxisEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class RampAxisEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class AiLightBlocker(Shape):
    ...
    density = FloatField(default_value=0.0, soft_min_value=0.0, soft_max_value=1.0)
    dens = density
    ...
    roundness = FloatField(default_value=0.0, soft_min_value=0.0, soft_max_value=1.0)
    rnds = roundness

    widthEdge = FloatField(default_value=0.0, soft_min_value=0.0, soft_max_value=1.0)
    width_edge = widthEdge

    heightEdge = FloatField(default_value=0.0, soft_min_value=0.0, soft_max_value=1.0)
    height_edge = heightEdge

    ramp = FloatField(default_value=0.0, soft_min_value=0.0, soft_max_value=1.0)
    rmp = ramp
