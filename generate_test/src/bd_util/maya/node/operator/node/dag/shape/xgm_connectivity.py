...
from ....attr.define.node_attr.xgm_connectivity import (
    BoundingBoxField,
    CenterField,
...
class XgmConnectivity(Shape):
    __slots__ = ()

    NODE_TYPE = "xgmConnectivity"
    ...
    guides = DataStringField()
    gi = guides

    description = DataStringField()
    de = description

    rebuildList = BoolField(default_value=False)
    rl = rebuildList
