...
from ....attr.define.node_attr.implicit_cone import (
    BoundingBoxField,
    CenterField,
...
class ImplicitCone(Shape):
    __slots__ = ()

    NODE_TYPE = "implicitCone"
    ...
    cone = TypedField(writable=False)
    cn = cone

    coneAngle = DoubleAngleField(default_value=39.99999995429334, min_value=0.0)
    ca = coneAngle

    coneCap = DoubleField(default_value=10.0, min_value=0.0)
    cap = coneCap
