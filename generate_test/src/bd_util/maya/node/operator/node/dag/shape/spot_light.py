...
class SpotLight(Shape):
    ...
    coneAngle = DoubleAngleField(default_value=40.0, min_value=0.005729577951308232, max_value=179.9942704220487)
    ca = coneAngle

    penumbraAngle = DoubleAngleField(default_value=0.0, min_value=-179.9942704220487, max_value=179.9942704220487, soft_min_value=-10.0, soft_max_value=10.0)
    pa = penumbraAngle

    dropoff = DoubleField(default_value=0.0, min_value=0.0, soft_max_value=255.0)
    dro = dropoff

    barnDoors = BoolField(default_value=False)
    bd = barnDoors

    leftBarnDoor = DoubleAngleField(default_value=20.0, min_value=-89.99713521102434, max_value=89.99713521102434)
    lbd = leftBarnDoor

    rightBarnDoor = DoubleAngleField(default_value=20.0, min_value=-89.99713521102434, max_value=89.99713521102434)
    rbd = rightBarnDoor

    topBarnDoor = DoubleAngleField(default_value=20.0, min_value=-89.99713521102434, max_value=89.99713521102434)
    tbd = topBarnDoor

    bottomBarnDoor = DoubleAngleField(default_value=20.0, min_value=-89.99713521102434, max_value=89.99713521102434)
    bbd = bottomBarnDoor
    ...
    endDistance3 = FloatLinearField(default_value=10.0, soft_min_value=0.0, soft_max_value=100.0)
    ed3 = endDistance3

    fogSpread = FloatField(default_value=1.0, soft_min_value=0.0, soft_max_value=5.0)
    fsp = fogSpread
    ...
    rayDirection = RayDirectionField(default_value=(0.0, 0.0, 0.0), readable=False)
    rad = rayDirection
    ...
    psIllumSamples = ShortField(default_value=1, soft_min_value=1, soft_max_value=50)
    pis = psIllumSamples
    ...
    aiAspectRatio = FloatField(default_value=1.0, min_value=0.0, max_value=100.0, soft_min_value=0.0, soft_max_value=1.0, category="arnold")
    ai_aspect_ratio = aiAspectRatio

    aiRadius = FloatField(default_value=0.0, min_value=0.0, soft_max_value=10.0, category="arnold")
    ai_radius = aiRadius

    aiLensRadius = FloatField(default_value=0.0, min_value=0.0, soft_min_value=0.0, soft_max_value=10.0, category="arnold")
    ai_lens_radius = aiLensRadius

    aiRoundness = FloatField(default_value=1.0, min_value=0.0, max_value=1.0, category="arnold")
