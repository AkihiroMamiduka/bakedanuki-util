...
class MotionBlurModeEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class MotionBlurModeEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class XgmDescription(Shape):
    ...
    motionBlurMode = MotionBlurModeEnumField(default_value=3, category="arnold")
