...
from ....attr.define.node_attr.bezier_curve import (
    AiCurveShaderField,
    BoundingBoxField,
    CenterField,
    ColorSetField,
...
class AnchorSmoothnessEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class AnchorSmoothnessEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class AnchorSmoothnessEnumField(
    EnumField[AnchorSmoothnessEnumAttrOperator, AnchorSmoothnessEnumPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = AnchorSmoothnessEnumAttrOperator
    PLUG_CLS = AnchorSmoothnessEnumPlugOperator


class AnchorWeightingEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class AnchorWeightingEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class AnchorWeightingEnumField(
    EnumField[AnchorWeightingEnumAttrOperator, AnchorWeightingEnumPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = AnchorWeightingEnumAttrOperator
    PLUG_CLS = AnchorWeightingEnumPlugOperator


class BezierCurve(Shape):
    __slots__ = ()

    NODE_TYPE = "bezierCurve"
    ...
    worldNormal = WorldNormalField(multi=True, default_value=(0.0, 0.0, 0.0), writable=False)
    wn = worldNormal
    ...
    editPoints = EditPointsField(multi=True, default_value=(0.0, 0.0, 0.0), writable=False)
    eps = editPoints
    ...
    aiCurveWidth = FloatField(default_value=0.009999999776482582, min_value=0.0, soft_max_value=1.0, category="arnold")
    cwdth = aiCurveWidth

    aiSampleRate = LongField(default_value=5, min_value=1, soft_max_value=20, category="arnold")
    srate = aiSampleRate

    aiCurveShader = AiCurveShaderField(default_value=(0.0, 0.0, 0.0), category="arnold")
    ...
    anchorSmoothness = AnchorSmoothnessEnumField(multi=True, default_value=0)
    asmo = anchorSmoothness

    anchorWeighting = AnchorWeightingEnumField(multi=True, default_value=0)
    awei = anchorWeighting
