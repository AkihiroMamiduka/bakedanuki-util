...
class ProfileLinesEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class ProfileLinesEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class BorderLinesEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class BorderLinesEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class LocalOcclusionEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class LocalOcclusionEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class PfxToon(Shape):
    ...
    lineWidth = DoubleField(default_value=0.1, soft_min_value=0.0, soft_max_value=1.0)
    lwd = lineWidth

    lineWidthMap = DoubleField(default_value=0.5, soft_min_value=0.0, soft_max_value=0.1)
    lwm = lineWidthMap

    lineOpacity = DoubleField(default_value=1.0, min_value=0.0, max_value=1.0)
    lop = lineOpacity

    lineOpacityMap = DoubleField(default_value=1.0, min_value=0.0, max_value=1.0)
    lpm = lineOpacityMap

    localOcclusion = LocalOcclusionEnumField(default_value=0)
    lcl = localOcclusion

    occlusionTolerance = DoubleField(default_value=0.01, soft_min_value=0.0, soft_max_value=1.0)
    otl = occlusionTolerance

    depthBias = DoubleField(default_value=0.0, soft_min_value=0.0, soft_max_value=1.0)
    dbs = depthBias

    profileLineWidth = DoubleField(default_value=1.0, soft_min_value=0.0, soft_max_value=10.0)
    plw = profileLineWidth

    creaseLineWidth = DoubleField(default_value=1.0, soft_min_value=0.0, soft_max_value=10.0)
    clw = creaseLineWidth

    borderLineWidth = DoubleField(default_value=1.0, soft_min_value=0.0, soft_max_value=10.0)
    blw = borderLineWidth

    intersectionLineWidth = DoubleField(default_value=1.0, soft_min_value=0.0, soft_max_value=10.0)
    ilw = intersectionLineWidth

    lineOffset = DoubleField(default_value=0.0, soft_min_value=0.0, soft_max_value=10.0)
    lof = lineOffset

    lineOffsetMap = DoubleField(default_value=0.0, soft_min_value=0.0, soft_max_value=0.1)
    lom = lineOffsetMap
    ...
    depthOffset = DoubleField(default_value=0.0, soft_min_value=0.0, soft_max_value=10.0)
    dff = depthOffset

    creaseAngleMin = DoubleField(default_value=20.0, soft_min_value=0.0, soft_max_value=180.0)
    amn = creaseAngleMin

    creaseAngleMax = DoubleField(default_value=90.0, soft_min_value=0.0, soft_max_value=180.0)
    amx = creaseAngleMax
    ...
    intersectionAngleMin = DoubleField(default_value=1.0, soft_min_value=0.0, soft_max_value=180.0)
    imn = intersectionAngleMin

    intersectionAngleMax = DoubleField(default_value=1.0, soft_min_value=0.0, soft_max_value=180.0)
    ...
    curvatureWidth = CurvatureWidthField(multi=True, default_value=(0.0, 0.0, 0.0))
    cwd = curvatureWidth

    profileWidthModulation = DoubleField(default_value=0.0, soft_min_value=0.0, soft_max_value=2.0)
    pwm = profileWidthModulation

    creaseWidthModulation = DoubleField(default_value=0.0, soft_min_value=0.0, soft_max_value=2.0)
    cwm = creaseWidthModulation

    borderWidthModulation = DoubleField(default_value=0.5, soft_min_value=0.0, soft_max_value=2.0)
    bwm = borderWidthModulation

    intersectionWidthModulation = DoubleField(default_value=0.0, soft_min_value=0.0, soft_max_value=2.0)
    imd = intersectionWidthModulation

    profileBreakAngle = DoubleField(default_value=180.0, min_value=0.0, max_value=180.0)
    pba = profileBreakAngle

    creaseBreakAngle = DoubleField(default_value=80.0, min_value=0.0, max_value=180.0)
    cba = creaseBreakAngle

    borderBreakAngle = DoubleField(default_value=80.0, min_value=0.0, max_value=180.0)
    bba = borderBreakAngle

    intersectionBreakAngle = DoubleField(default_value=180.0, min_value=0.0, max_value=180.0)
    iba = intersectionBreakAngle

    removeFlushBorders = BoolField(default_value=False)
    rfb = removeFlushBorders

    flushTolerance = DoubleField(default_value=0.01, min_value=0.0, soft_max_value=0.1)
    tfl = flushTolerance

    flushAngleMax = DoubleField(default_value=4.0, min_value=0.0, soft_max_value=180.0)
    fmx = flushAngleMax

    lineEndThinning = DoubleField(default_value=0.0, soft_min_value=0.0, soft_max_value=10.0)
    let = lineEndThinning

    lineExtend = DoubleField(default_value=0.0, soft_min_value=0.0, soft_max_value=10.0)
    lex = lineExtend
    ...
    maxSegmentLength = DoubleField(default_value=0.5, min_value=1e-05, soft_min_value=0.01, soft_max_value=1.0)
    msl = maxSegmentLength

    minSegmentLength = DoubleField(default_value=0.0, min_value=0.0, soft_min_value=0.0, soft_max_value=1.0)
    mns = minSegmentLength

    screenSpaceResampling = DoubleField(default_value=0.0, soft_min_value=0.0, soft_max_value=1.0)
