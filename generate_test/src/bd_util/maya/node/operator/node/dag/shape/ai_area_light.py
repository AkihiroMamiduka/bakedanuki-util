...
class AiAreaLight(Shape):
    ...
    intensity = FloatField(default_value=1.0, min_value=0.0, soft_min_value=0.0, soft_max_value=10.0)
    ...
    exposure = FloatField(default_value=0.0, soft_min_value=-5.0, soft_max_value=5.0, category="arnold")
    ...
    normalize = BoolField(default_value=True, category="arnold")
    ai_normalize = normalize
    ...
    aiSpread = FloatField(default_value=1.0, min_value=0.0, max_value=1.0, category="arnold")
    ai_spread = aiSpread

    aiRoundness = FloatField(default_value=0.0, min_value=0.0, max_value=1.0, category="arnold")
    ai_roundness = aiRoundness

    aiSoftEdge = FloatField(default_value=0.0, min_value=0.0, max_value=1.0, category="arnold")
    ...
    attributeAliasList = TypedField()
    aal = attributeAliasList
