...
class LineModifier(Shape):
    ...
    widthScale = DoubleField(default_value=5.0, soft_min_value=0.0, soft_max_value=10.0)
    wsc = widthScale

    widthOffset = DoubleField(default_value=0.0, soft_min_value=0.0, soft_max_value=1.0)
    wof = widthOffset

    opacityScale = DoubleField(default_value=1.0, soft_min_value=0.0, soft_max_value=1.0)
    osc = opacityScale

    opacityOffset = DoubleField(default_value=0.0, soft_min_value=0.0, soft_max_value=1.0)
    oof = opacityOffset

    surfaceOffset = DoubleField(default_value=0.0, soft_min_value=0.0, soft_max_value=1.0)
    sof = surfaceOffset

    lineExtend = DoubleField(default_value=0.0, soft_min_value=0.0, soft_max_value=1.0)
    lex = lineExtend
    ...
    tubeScale = DoubleField(default_value=1.0, soft_min_value=0.0, soft_max_value=10.0)
    tus = tubeScale

    tubeDropout = DoubleField(default_value=0.0, soft_min_value=0.0, soft_max_value=1.0)
    tud = tubeDropout
    ...
    flowerDropout = DoubleField(default_value=0.0, soft_min_value=0.0, soft_max_value=1.0)
    fdp = flowerDropout

    leafScale = DoubleField(default_value=1.0, min_value=0.0, soft_max_value=5.0)
    lsc = leafScale

    flowerScale = DoubleField(default_value=1.0, min_value=0.0, soft_max_value=5.0)
    fsc = flowerScale

    force = DoubleField(default_value=0.0, soft_min_value=-1.0, soft_max_value=1.0)
    frc = force

    directionalForce = DoubleField(default_value=0.0, soft_min_value=0.0, soft_max_value=1.0)
    dfc = directionalForce

    displacement = DoubleField(default_value=0.0, soft_min_value=-1.0, soft_max_value=1.0)
    dsp = displacement

    directionalDisplacement = DoubleField(default_value=0.0, soft_min_value=0.0, soft_max_value=1.0)
    ddc = directionalDisplacement

    dropoffNoise = DoubleField(default_value=0.0, soft_min_value=0.0, soft_max_value=1.0)
    don = dropoffNoise

    noiseFrequency = DoubleField(default_value=0.2, soft_min_value=0.0, soft_max_value=1.0)
    nfr = noiseFrequency

    dropoff = DropoffField(multi=True, default_value=(0.0, 0.0, 0.0))
    drp = dropoff

    occupyGridResolution = LongField(default_value=50, min_value=1, soft_max_value=200)
    ...
    attractRadiusScale = DoubleField(default_value=2.0, soft_min_value=0.0, soft_max_value=10.0)
    ...
    occupyRadiusScale = DoubleField(default_value=1.0, soft_min_value=0.0, soft_max_value=10.0)
