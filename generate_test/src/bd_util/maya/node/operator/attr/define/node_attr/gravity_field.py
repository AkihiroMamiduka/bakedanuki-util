...
class DirectionPlugOperator(
    CompoundPlugOperator["DirectionAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("directionX", "dx"),
    ...
    directionX = DoubleField(default_value=0.0, soft_min_value=-1.0, soft_max_value=1.0)
    dx = directionX

    directionY = DoubleField(default_value=0.0, soft_min_value=-1.0, soft_max_value=1.0)
    dy = directionY

    directionZ = DoubleField(default_value=0.0, soft_min_value=-1.0, soft_max_value=1.0)
    dz = directionZ


class DirectionAttrOperator(
    CompoundAttrOperator[DirectionPlugOperator]
):
    __slots__ = ()
