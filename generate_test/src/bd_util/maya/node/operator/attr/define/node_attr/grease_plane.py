...
class RenderPlaneTranslatePlugOperator(
    ...
    renderPlaneTranslateX = DoubleLinearField(default_value=0.0, writable=False)
    rptx = renderPlaneTranslateX

    renderPlaneTranslateY = DoubleLinearField(default_value=0.0, writable=False)
    rpty = renderPlaneTranslateY

    renderPlaneTranslateZ = DoubleLinearField(default_value=0.0, writable=False)
...
class RenderPlaneTranslateField(
    DoubleLinear3CompoundBaseField[RenderPlaneTranslateAttrOperator, RenderPlaneTranslatePlugOperator]
):
    __slots__ = ()
...
class SourcePlaneTranslatePlugOperator(
    ...
    sourcePlaneTranslateX = DoubleLinearField(default_value=0.0, writable=False)
    sptx = sourcePlaneTranslateX

    sourcePlaneTranslateY = DoubleLinearField(default_value=0.0, writable=False)
    spty = sourcePlaneTranslateY

    sourcePlaneTranslateZ = DoubleLinearField(default_value=0.0, writable=False)
...
class SourcePlaneTranslateField(
    DoubleLinear3CompoundBaseField[SourcePlaneTranslateAttrOperator, SourcePlaneTranslatePlugOperator]
):
    __slots__ = ()
...
class RenderPlaneRotateField(
    DoubleAngle3CompoundBaseField[RenderPlaneRotateAttrOperator, RenderPlaneRotatePlugOperator]
):
    __slots__ = ()
...
class SourcePlaneRotateField(
    DoubleAngle3CompoundBaseField[SourcePlaneRotateAttrOperator, SourcePlaneRotatePlugOperator]
):
    __slots__ = ()
...
class RenderPlaneScaleField(
    Double3CompoundBaseField[RenderPlaneScaleAttrOperator, RenderPlaneScalePlugOperator]
):
    __slots__ = ()
...
class SourcePlaneScaleField(
    Double3CompoundBaseField[SourcePlaneScaleAttrOperator, SourcePlaneScalePlugOperator]
):
    __slots__ = ()
