...
class BboxCorner1PlugOperator(
    Double3CompoundBasePlugOperator["BboxCorner1AttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("bboxCorner10", "bb10"),
    ...
    bboxCorner10 = DoubleField(default_value=0.0, writable=False)
    bb10 = bboxCorner10

    bboxCorner11 = DoubleField(default_value=0.0, writable=False)
    bb11 = bboxCorner11

    bboxCorner12 = DoubleField(default_value=0.0, writable=False)
    bb12 = bboxCorner12


class BboxCorner1AttrOperator(
    Double3CompoundBaseAttrOperator[BboxCorner1PlugOperator]
):
    __slots__ = ()
...
class BboxCorner1Field(
    Double3CompoundBaseField[BboxCorner1AttrOperator, BboxCorner1PlugOperator]
):
    __slots__ = ()

    ATTR_CLS = BboxCorner1AttrOperator
    PLUG_CLS = BboxCorner1PlugOperator
...
class BboxCorner2PlugOperator(
    Double3CompoundBasePlugOperator["BboxCorner2AttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("bboxCorner20", "bb20"),
    ...
    bboxCorner20 = DoubleField(default_value=0.0, writable=False)
    bb20 = bboxCorner20

    bboxCorner21 = DoubleField(default_value=0.0, writable=False)
    bb21 = bboxCorner21

    bboxCorner22 = DoubleField(default_value=0.0, writable=False)
    bb22 = bboxCorner22


class BboxCorner2AttrOperator(
    Double3CompoundBaseAttrOperator[BboxCorner2PlugOperator]
):
    __slots__ = ()
...
class BboxCorner2Field(
    Double3CompoundBaseField[BboxCorner2AttrOperator, BboxCorner2PlugOperator]
):
    __slots__ = ()

    ATTR_CLS = BboxCorner2AttrOperator
    PLUG_CLS = BboxCorner2PlugOperator
