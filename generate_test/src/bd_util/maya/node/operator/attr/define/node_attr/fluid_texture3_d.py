...
class Opacity_InterpEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class Opacity_InterpEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class Opacity_InterpEnumField(
    EnumField[Opacity_InterpEnumAttrOperator, Opacity_InterpEnumPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = Opacity_InterpEnumAttrOperator
    PLUG_CLS = Opacity_InterpEnumPlugOperator
...
class ResolutionPlugOperator(
    CompoundPlugOperator["ResolutionAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("resolutionW", "rw"),
...
class ResolutionAttrOperator(
    CompoundAttrOperator[ResolutionPlugOperator]
):
    __slots__ = ()
...
class DimensionsPlugOperator(
    CompoundPlugOperator["DimensionsAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("dimensionsW", "dw"),
...
class DimensionsAttrOperator(
    CompoundAttrOperator[DimensionsPlugOperator]
):
    __slots__ = ()
...
class FieldListPlugOperator(
    CompoundPlugOperator["FieldListAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("fieldFunction", "frf"),
    ...
    fieldFunction = CompoundField()
    frf = fieldFunction


class FieldListAttrOperator(
    CompoundAttrOperator[FieldListPlugOperator]
):
    __slots__ = ()
...
class EmissionListPlugOperator(
    ...
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("emissionFunction", "emf"),
    )

    emissionFunction = CompoundField()
    emf = emissionFunction


class EmissionListAttrOperator(
    CompoundAttrOperator[EmissionListPlugOperator]
):
    __slots__ = ()
...
class VelocityScaleField(
    Float3CompoundBaseField[VelocityScaleAttrOperator, VelocityScalePlugOperator]
):
    __slots__ = ()
...
class OpacityPlugOperator(
    CompoundPlugOperator["OpacityAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
    ...
    opacity_Interp = Opacity_InterpEnumField(default_value=0)
    opai = opacity_Interp


class OpacityAttrOperator(
    CompoundAttrOperator[OpacityPlugOperator]
):
    __slots__ = ()
...
class OpacityField(
    CompoundField[OpacityAttrOperator, OpacityPlugOperator]
):
    __slots__ = ()
...
class FluidLightColorField(
    Float3CompoundBaseField[FluidLightColorAttrOperator, FluidLightColorPlugOperator]
):
    __slots__ = ()
...
class DirectionalLightField(
    Float3CompoundBaseField[DirectionalLightAttrOperator, DirectionalLightPlugOperator]
):
    __slots__ = ()
...
class TextureOriginPlugOperator(
    ...
    textureOriginX = FloatField(default_value=0.0, soft_min_value=-100.0, soft_max_value=100.0)
    torx = textureOriginX

    textureOriginY = FloatField(default_value=0.0, soft_min_value=-100.0, soft_max_value=100.0)
    tory = textureOriginY

    textureOriginZ = FloatField(default_value=0.0, soft_min_value=-100.0, soft_max_value=100.0)
    torz = textureOriginZ
...
class TextureOriginField(
    Float3CompoundBaseField[TextureOriginAttrOperator, TextureOriginPlugOperator]
):
    __slots__ = ()
...
class TextureRotateField(
    Float3CompoundBaseField[TextureRotateAttrOperator, TextureRotatePlugOperator]
):
    __slots__ = ()
...
class AiVolumeTextureField(
    Float3CompoundBaseField[AiVolumeTextureAttrOperator, AiVolumeTexturePlugOperator]
):
    __slots__ = ()
...
class RefPointCameraPlugOperator(
    ...
    refPointCameraX = FloatField(default_value=1.0)
    rcx = refPointCameraX

    refPointCameraY = FloatField(default_value=1.0)
    rcy = refPointCameraY

    refPointCameraZ = FloatField(default_value=1.0)
    rcz = refPointCameraZ
...
class OutCoordPlugOperator(
    Float3CompoundBasePlugOperator["OutCoordAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("oucx", "ocx"),
    ...
    oucx = FloatField(default_value=0.0, writable=False)
    ocx = oucx

    oucy = FloatField(default_value=0.0, writable=False)
    ocy = oucy

    oucz = FloatField(default_value=0.0, writable=False)
    ocz = oucz


class OutCoordAttrOperator(
    Float3CompoundBaseAttrOperator[OutCoordPlugOperator]
):
    __slots__ = ()
...
class OutCoordField(
    Float3CompoundBaseField[OutCoordAttrOperator, OutCoordPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = OutCoordAttrOperator
    PLUG_CLS = OutCoordPlugOperator
