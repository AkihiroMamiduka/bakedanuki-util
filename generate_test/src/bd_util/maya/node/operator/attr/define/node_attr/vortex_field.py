...
class AxisPlugOperator(
    CompoundPlugOperator["AxisAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("axisX", "axx"),
    ...
    axisX = DoubleField(default_value=0.0, soft_min_value=-1.0, soft_max_value=1.0)
    axx = axisX

    axisY = DoubleField(default_value=0.0, soft_min_value=-1.0, soft_max_value=1.0)
    axy = axisY

    axisZ = DoubleField(default_value=0.0, soft_min_value=-1.0, soft_max_value=1.0)
    axz = axisZ


class AxisAttrOperator(
    CompoundAttrOperator[AxisPlugOperator]
):
    __slots__ = ()
...
class AxisField(
    CompoundField[AxisAttrOperator, AxisPlugOperator]
):
    __slots__ = ()
