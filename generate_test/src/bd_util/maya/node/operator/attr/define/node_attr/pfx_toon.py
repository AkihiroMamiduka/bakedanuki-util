...
class CurvatureWidth_InterpEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class CurvatureWidth_InterpEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class CurvatureWidth_InterpEnumField(
    EnumField[CurvatureWidth_InterpEnumAttrOperator, CurvatureWidth_InterpEnumPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = CurvatureWidth_InterpEnumAttrOperator
    PLUG_CLS = CurvatureWidth_InterpEnumPlugOperator
...
class InputSurfaceAttrOperator(
    CompoundAttrOperator[InputSurfacePlugOperator]
):
    __slots__ = ()
...
class CurvatureWidthPlugOperator(
    ...
    curvatureWidth_Interp = CurvatureWidth_InterpEnumField(default_value=0)
...
class IntersectionColorField(
    Float3CompoundBaseField[IntersectionColorAttrOperator, IntersectionColorPlugOperator]
):
    __slots__ = ()
