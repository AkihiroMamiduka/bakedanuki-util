...
class TranslateOffsetField(
    DoubleLinear3CompoundBaseField[TranslateOffsetAttrOperator, TranslateOffsetPlugOperator]
):
    __slots__ = ()
...
class RotateOffsetField(
    DoubleAngle3CompoundBaseField[RotateOffsetAttrOperator, RotateOffsetPlugOperator]
):
    __slots__ = ()
