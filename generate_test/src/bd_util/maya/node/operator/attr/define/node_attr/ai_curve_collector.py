...
class AiWidthProfile_InterpEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class AiWidthProfile_InterpEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class AiWidthProfile_InterpEnumField(
    EnumField[AiWidthProfile_InterpEnumAttrOperator, AiWidthProfile_InterpEnumPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = AiWidthProfile_InterpEnumAttrOperator
    PLUG_CLS = AiWidthProfile_InterpEnumPlugOperator
...
class AiCurveShaderField(
    Float3CompoundBaseField[AiCurveShaderAttrOperator, AiCurveShaderPlugOperator]
):
    __slots__ = ()
...
class AiWidthProfilePlugOperator(
    ...
    aiWidthProfile_Interp = AiWidthProfile_InterpEnumField(default_value=1)
