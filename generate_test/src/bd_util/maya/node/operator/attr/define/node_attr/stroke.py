...
class PressureScale_InterpEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class PressureScale_InterpEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class PressureScale_InterpEnumField(
    EnumField[PressureScale_InterpEnumAttrOperator, PressureScale_InterpEnumPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = PressureScale_InterpEnumAttrOperator
    PLUG_CLS = PressureScale_InterpEnumPlugOperator
...
class NormalPlugOperator(
    ...
    normalX = DoubleField(default_value=0.0, soft_min_value=-1.0, soft_max_value=1.0)
    nmx = normalX

    normalY = DoubleField(default_value=0.0, soft_min_value=-1.0, soft_max_value=1.0)
    nmy = normalY

    normalZ = DoubleField(default_value=1.0, soft_min_value=-1.0, soft_max_value=1.0)
    nmz = normalZ


class NormalAttrOperator(
    Double3CompoundBaseAttrOperator[NormalPlugOperator]
):
    __slots__ = ()
...
class PathCurvePlugOperator(
    CompoundPlugOperator["PathCurveAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("curve", "crv"),
...
class PathCurveAttrOperator(
    CompoundAttrOperator[PathCurvePlugOperator]
):
    __slots__ = ()
...
class PressureScalePlugOperator(
    ...
    pressureScale_Interp = PressureScale_InterpEnumField(default_value=0)
