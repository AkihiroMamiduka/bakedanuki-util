...
class ConnectionDensityRange_InterpEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class ConnectionDensityRange_InterpEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class ConnectionDensityRange_InterpEnumField(
    EnumField[ConnectionDensityRange_InterpEnumAttrOperator, ConnectionDensityRange_InterpEnumPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = ConnectionDensityRange_InterpEnumAttrOperator
    PLUG_CLS = ConnectionDensityRange_InterpEnumPlugOperator


class StrengthDropoff_InterpEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class StrengthDropoff_InterpEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class StrengthDropoff_InterpEnumField(
    EnumField[StrengthDropoff_InterpEnumAttrOperator, StrengthDropoff_InterpEnumPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = StrengthDropoff_InterpEnumAttrOperator
    PLUG_CLS = StrengthDropoff_InterpEnumPlugOperator
...
class ConnectionDensityRangePlugOperator(
    ...
    connectionDensityRange_Interp = ConnectionDensityRange_InterpEnumField(default_value=0)
...
class ConnectionDensityRangeField(
    CompoundField[ConnectionDensityRangeAttrOperator, ConnectionDensityRangePlugOperator]
):
    __slots__ = ()
...
class StrengthDropoffPlugOperator(
    ...
    strengthDropoff_Interp = StrengthDropoff_InterpEnumField(default_value=0)
