...
class AiShutterCurvePlugOperator(
    ...
    aiShutterCurveX = FloatField(default_value=3.957190478076633e-13)
    ai_shutter_curvex = aiShutterCurveX

    aiShutterCurveY = FloatField(default_value=6.6982066594726256e-43)
...
class ZeroParallaxColorPlugOperator(
    Float3CompoundBasePlugOperator["ZeroParallaxColorAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("zeroParallaxColorRed", "zpcr"),
        ("zeroParallaxColorGreen", "zpcg"),
        ("zeroParallaxColorBlue", "zpcb"),
    )

    zeroParallaxColorRed = FloatField(default_value=0.8299999833106995)
    zpcr = zeroParallaxColorRed

    zeroParallaxColorGreen = FloatField(default_value=0.23000000417232513)
    zpcg = zeroParallaxColorGreen

    zeroParallaxColorBlue = FloatField(default_value=0.10000000149011612)
    zpcb = zeroParallaxColorBlue


class ZeroParallaxColorAttrOperator(
    Float3CompoundBaseAttrOperator[ZeroParallaxColorPlugOperator]
):
    __slots__ = ()
...
class ZeroParallaxColorField(
    Float3CompoundBaseField[ZeroParallaxColorAttrOperator, ZeroParallaxColorPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = ZeroParallaxColorAttrOperator
    PLUG_CLS = ZeroParallaxColorPlugOperator
...
class SafeVolumeColorPlugOperator(
    Float3CompoundBasePlugOperator["SafeVolumeColorAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("safeVolumeColorRed", "svcr"),
        ("safeVolumeColorGreen", "svcg"),
        ("safeVolumeColorBlue", "svcb"),
    )

    safeVolumeColorRed = FloatField(default_value=0.23800000548362732)
    svcr = safeVolumeColorRed

    safeVolumeColorGreen = FloatField(default_value=0.8080000281333923)
    svcg = safeVolumeColorGreen

    safeVolumeColorBlue = FloatField(default_value=1.0)
    svcb = safeVolumeColorBlue


class SafeVolumeColorAttrOperator(
    Float3CompoundBaseAttrOperator[SafeVolumeColorPlugOperator]
):
    __slots__ = ()
...
class SafeVolumeColorField(
    Float3CompoundBaseField[SafeVolumeColorAttrOperator, SafeVolumeColorPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = SafeVolumeColorAttrOperator
    PLUG_CLS = SafeVolumeColorPlugOperator
