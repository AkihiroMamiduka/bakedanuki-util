...
class LightDataPlugOperator(
    ...
    lightDirection = Float3Field(default_value=(0.0, -1.0, 0.0), writable=False)
    ld = lightDirection

    lightIntensity = Float3Field(default_value=(1.0, 0.5, 0.20000000298023224), writable=False)
    li = lightIntensity
