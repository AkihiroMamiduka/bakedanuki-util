...
class Dropoff_InterpEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class Dropoff_InterpEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class Dropoff_InterpEnumField(
    EnumField[Dropoff_InterpEnumAttrOperator, Dropoff_InterpEnumPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = Dropoff_InterpEnumAttrOperator
    PLUG_CLS = Dropoff_InterpEnumPlugOperator
...
class DropoffPlugOperator(
    CompoundPlugOperator["DropoffAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
    ...
    dropoff_Interp = Dropoff_InterpEnumField(default_value=0)
    drpi = dropoff_Interp


class DropoffAttrOperator(
    CompoundAttrOperator[DropoffPlugOperator]
):
    __slots__ = ()
...
class DropoffField(
    CompoundField[DropoffAttrOperator, DropoffPlugOperator]
):
    __slots__ = ()
