...
class FalloffRampPlugOperator(
    ...
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("falloffRamp_Position", "falloffRp"),
        ("falloffRamp_FloatValue", "falloffRfv"),
        ("falloffRamp_Interp", "falloffRi"),
    )

    falloffRamp_Position = FloatField(default_value=0.0)
    falloffRp = falloffRamp_Position

    falloffRamp_FloatValue = FloatField(default_value=0.0)
    falloffRfv = falloffRamp_FloatValue

    falloffRamp_Interp = FalloffRamp_InterpEnumField(default_value=1)
    falloffRi = falloffRamp_Interp
...
class VertexColourPlugOperator(
    Float3CompoundBasePlugOperator["VertexColourAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
    ...
    vertexColourR = FloatField(default_value=1.0)
    vertexColourr = vertexColourR

    vertexColourG = FloatField(default_value=0.3499999940395355)
    vertexColourg = vertexColourG

    vertexColourB = FloatField(default_value=0.699999988079071)
    vertexColourb = vertexColourB


class VertexColourAttrOperator(
    Float3CompoundBaseAttrOperator[VertexColourPlugOperator]
):
    __slots__ = ()
...
class VertexColourField(
    Float3CompoundBaseField[VertexColourAttrOperator, VertexColourPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = VertexColourAttrOperator
    PLUG_CLS = VertexColourPlugOperator
...
class ColourPlugOperator(
    Float3CompoundBasePlugOperator["ColourAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("colourR", "colourr"),
    ...
    colourR = FloatField(default_value=0.699999988079071)
    colourr = colourR

    colourG = FloatField(default_value=0.8500000238418579)
    colourg = colourG

    colourB = FloatField(default_value=1.0)
    colourb = colourB


class ColourAttrOperator(
    Float3CompoundBaseAttrOperator[ColourPlugOperator]
):
    __slots__ = ()
...
class ColourField(
    Float3CompoundBaseField[ColourAttrOperator, ColourPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = ColourAttrOperator
    PLUG_CLS = ColourPlugOperator
