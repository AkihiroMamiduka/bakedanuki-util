...
class ColorRange_InterpEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class ColorRange_InterpEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class ColorRange_InterpEnumField(
    EnumField[ColorRange_InterpEnumAttrOperator, ColorRange_InterpEnumPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = ColorRange_InterpEnumAttrOperator
    PLUG_CLS = ColorRange_InterpEnumPlugOperator


class Penumbra_InterpEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class Penumbra_InterpEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class Penumbra_InterpEnumField(
    EnumField[Penumbra_InterpEnumAttrOperator, Penumbra_InterpEnumPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = Penumbra_InterpEnumAttrOperator
    PLUG_CLS = Penumbra_InterpEnumPlugOperator
...
class ColorRangePlugOperator(
    CompoundPlugOperator["ColorRangeAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
    ...
    colorRange_Color = Float3Field(default_value=(0.0, 0.0, 0.0))
    crgc = colorRange_Color

    colorRange_Interp = ColorRange_InterpEnumField(default_value=0)
    crgi = colorRange_Interp


class ColorRangeAttrOperator(
    CompoundAttrOperator[ColorRangePlugOperator]
):
    __slots__ = ()
...
class PenumbraPlugOperator(
    CompoundPlugOperator["PenumbraAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
    ...
    penumbra_Interp = Penumbra_InterpEnumField(default_value=0)
    peni = penumbra_Interp


class PenumbraAttrOperator(
    CompoundAttrOperator[PenumbraPlugOperator]
):
    __slots__ = ()
...
class PenumbraField(
    CompoundField[PenumbraAttrOperator, PenumbraPlugOperator]
):
    __slots__ = ()
