...
class InRotOrderEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class InRotOrderEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class InRotOrderEnumField(
    EnumField[InRotOrderEnumAttrOperator, InRotOrderEnumPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = InRotOrderEnumAttrOperator
    PLUG_CLS = InRotOrderEnumPlugOperator
...
class InputDataPlugOperator(
    ...
    inRotOrder = InRotOrderEnumField(default_value=0)
    irord = inRotOrder

    uLoc = DoubleField(default_value=0.0)
    ul = uLoc

    vLoc = DoubleField(default_value=0.0)
    vl = vLoc

    edgeIdx1 = LongField(default_value=0, min_value=0)
    ei1 = edgeIdx1

    edgeIdx2 = LongField(default_value=0, min_value=0)
    ei2 = edgeIdx2

    fixPolyFlip = BoolField(default_value=False)
    fply = fixPolyFlip

    size = DoubleField(default_value=1.0)
    siz = size
