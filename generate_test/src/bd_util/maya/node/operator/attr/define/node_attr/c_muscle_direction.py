...
class DirDataPlugOperator(
    ...
    strength = DoubleField(default_value=1.0, min_value=0.0)
    str = strength

    falloffInner = DoubleField(default_value=0.25, min_value=0.0)
    fi = falloffInner

    falloffOuter = DoubleField(default_value=1.0, min_value=0.0)
    fo = falloffOuter
...
class InColorPlugOperator(
    ...
    inColorR = FloatField(default_value=1.0, min_value=0.0, max_value=1.0)
    icolr = inColorR

    inColorG = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    icolg = inColorG

    inColorB = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    icolb = inColorB
...
class OutColorPlugOperator(
    ...
    outColorR = FloatField(default_value=1.0, min_value=0.0, max_value=1.0)
    ocolr = outColorR

    outColorG = FloatField(default_value=0.8799999952316284, min_value=0.0, max_value=1.0)
    ocolg = outColorG

    outColorB = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    ocolb = outColorB
