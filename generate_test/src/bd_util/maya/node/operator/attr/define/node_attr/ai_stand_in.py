...
class MinBoundingBoxPlugOperator(
    Float3CompoundBasePlugOperator["MinBoundingBoxAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("MinBoundingBox0", "min0"),
        ("MinBoundingBox1", "min1"),
        ("MinBoundingBox2", "min2"),
    )

    MinBoundingBox0 = FloatField(default_value=-1.0)
    min0 = MinBoundingBox0

    MinBoundingBox1 = FloatField(default_value=-1.0)
    min1 = MinBoundingBox1

    MinBoundingBox2 = FloatField(default_value=-1.0)
    min2 = MinBoundingBox2


class MinBoundingBoxAttrOperator(
    Float3CompoundBaseAttrOperator[MinBoundingBoxPlugOperator]
):
    __slots__ = ()
...
class MinBoundingBoxField(
    Float3CompoundBaseField[MinBoundingBoxAttrOperator, MinBoundingBoxPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = MinBoundingBoxAttrOperator
    PLUG_CLS = MinBoundingBoxPlugOperator
...
class MaxBoundingBoxPlugOperator(
    Float3CompoundBasePlugOperator["MaxBoundingBoxAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("MaxBoundingBox0", "max0"),
        ("MaxBoundingBox1", "max1"),
        ("MaxBoundingBox2", "max2"),
    )

    MaxBoundingBox0 = FloatField(default_value=1.0)
    max0 = MaxBoundingBox0

    MaxBoundingBox1 = FloatField(default_value=1.0)
    max1 = MaxBoundingBox1

    MaxBoundingBox2 = FloatField(default_value=1.0)
    max2 = MaxBoundingBox2


class MaxBoundingBoxAttrOperator(
    Float3CompoundBaseAttrOperator[MaxBoundingBoxPlugOperator]
):
    __slots__ = ()
...
class MaxBoundingBoxField(
    Float3CompoundBaseField[MaxBoundingBoxAttrOperator, MaxBoundingBoxPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = MaxBoundingBoxAttrOperator
    PLUG_CLS = MaxBoundingBoxPlugOperator
