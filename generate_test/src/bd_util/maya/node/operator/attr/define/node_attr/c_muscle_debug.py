...
class EdgePathPlugOperator(
    CompoundPlugOperator["EdgePathAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("edgeClosed", "ecls"),
    ...
    edgeClosed = BoolField(default_value=False)
    ecls = edgeClosed

    edgeWidth = FloatField(default_value=1.0)
    ew = edgeWidth

    edgeColor = CompoundField(default_value=(0.0, 0.0, 0.0))
    ec = edgeColor

    edgePoint = CompoundField(multi=True, default_value=(0.0, 0.0, 0.0))
    ep = edgePoint


class EdgePathAttrOperator(
    CompoundAttrOperator[EdgePathPlugOperator]
):
    __slots__ = ()
...
class EdgePathField(
    CompoundField[EdgePathAttrOperator, EdgePathPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = EdgePathAttrOperator
    PLUG_CLS = EdgePathPlugOperator


class PointGroupPlugOperator(
    CompoundPlugOperator["PointGroupAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("pointWidth", "pw"),
    ...
    pointWidth = FloatField(default_value=1.0)
    pw = pointWidth

    pointColor = CompoundField(default_value=(0.0, 0.0, 0.0))
    pc = pointColor

    point = CompoundField(multi=True, default_value=(0.0, 0.0, 0.0))
    p = point


class PointGroupAttrOperator(
    CompoundAttrOperator[PointGroupPlugOperator]
):
    __slots__ = ()
...
class PointGroupField(
    CompoundField[PointGroupAttrOperator, PointGroupPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = PointGroupAttrOperator
    PLUG_CLS = PointGroupPlugOperator
