...
class VertexPlugOperator(
    CompoundPlugOperator["VertexAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("singleVertex", "svt"),
    ...
    singleVertex = Double3Field(multi=True, default_value=(0.0, 0.0, 0.0))
    svt = singleVertex


class VertexAttrOperator(
    CompoundAttrOperator[VertexPlugOperator]
):
    __slots__ = ()
...
class VertexField(
    CompoundField[VertexAttrOperator, VertexPlugOperator]
):
    __slots__ = ()
...
class VertexTweakPlugOperator(
    CompoundPlugOperator["VertexTweakAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("singleVertexTweak", "stw"),
    )

    singleVertexTweak = Double3Field(multi=True, default_value=(0.0, 0.0, 0.0))
    stw = singleVertexTweak


class VertexTweakAttrOperator(
    CompoundAttrOperator[VertexTweakPlugOperator]
):
    __slots__ = ()
