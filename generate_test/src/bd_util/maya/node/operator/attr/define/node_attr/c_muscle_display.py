...
class ColorAPlugOperator(
    ...
    colorAR = FloatField(default_value=1.0, min_value=0.0, max_value=1.0)
    colAr = colorAR

    colorAG = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    colAg = colorAG

    colorAB = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    colAb = colorAB
...
class ColorBPlugOperator(
    ...
    colorBR = FloatField(default_value=1.0, min_value=0.0, max_value=1.0)
    colBr = colorBR

    colorBG = FloatField(default_value=1.0, min_value=0.0, max_value=1.0)
    colBg = colorBG

    colorBB = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    colBb = colorBB
...
class ColorCPlugOperator(
    Float3CompoundBasePlugOperator["ColorCAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("colorCR", "colCr"),
    ...
    colorCR = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    colCr = colorCR

    colorCG = FloatField(default_value=0.30000001192092896, min_value=0.0, max_value=1.0)
    colCg = colorCG

    colorCB = FloatField(default_value=0.5, min_value=0.0, max_value=1.0)
    colCb = colorCB


class ColorCAttrOperator(
    Float3CompoundBaseAttrOperator[ColorCPlugOperator]
):
    __slots__ = ()
...
class ColorCField(
    Float3CompoundBaseField[ColorCAttrOperator, ColorCPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = ColorCAttrOperator
    PLUG_CLS = ColorCPlugOperator
...
class PtPosPlugOperator(
    Float3CompoundBasePlugOperator["PtPosAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("ptPosX", "posx"),
    ...
    ptPosX = FloatField(default_value=0.0)
    posx = ptPosX

    ptPosY = FloatField(default_value=0.0)
    posy = ptPosY

    ptPosZ = FloatField(default_value=0.0)
    posz = ptPosZ


class PtPosAttrOperator(
    Float3CompoundBaseAttrOperator[PtPosPlugOperator]
):
    __slots__ = ()
...
class PtPosField(
    Float3CompoundBaseField[PtPosAttrOperator, PtPosPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = PtPosAttrOperator
    PLUG_CLS = PtPosPlugOperator
