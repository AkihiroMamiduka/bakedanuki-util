...
class SizePlugOperator(
    Double3CompoundBasePlugOperator["SizeAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("sizeX", "szx"),
    ...
    sizeX = DoubleField(default_value=2.0, soft_min_value=0.0, soft_max_value=10.0)
    szx = sizeX

    sizeY = DoubleField(default_value=2.0, soft_min_value=0.0, soft_max_value=10.0)
    szy = sizeY

    sizeZ = DoubleField(default_value=2.0, soft_min_value=0.0, soft_max_value=10.0)
    szz = sizeZ


class SizeAttrOperator(
    Double3CompoundBaseAttrOperator[SizePlugOperator]
):
    __slots__ = ()
...
class SizeField(
    Double3CompoundBaseField[SizeAttrOperator, SizePlugOperator]
):
    __slots__ = ()
