...
class BboxCorner1PlugOperator(
    Float3CompoundBasePlugOperator["BboxCorner1AttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("bboxCorner10", "bb10"),
    ...
    bboxCorner10 = FloatField(default_value=0.0)
    bb10 = bboxCorner10

    bboxCorner11 = FloatField(default_value=0.0)
    bb11 = bboxCorner11

    bboxCorner12 = FloatField(default_value=0.0)
    bb12 = bboxCorner12


class BboxCorner1AttrOperator(
    Float3CompoundBaseAttrOperator[BboxCorner1PlugOperator]
):
    __slots__ = ()
...
class BboxCorner1Field(
    Float3CompoundBaseField[BboxCorner1AttrOperator, BboxCorner1PlugOperator]
):
    __slots__ = ()
...
class BboxCorner2PlugOperator(
    Float3CompoundBasePlugOperator["BboxCorner2AttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("bboxCorner20", "bb20"),
    ...
    bboxCorner20 = FloatField(default_value=0.0)
    bb20 = bboxCorner20

    bboxCorner21 = FloatField(default_value=0.0)
    bb21 = bboxCorner21

    bboxCorner22 = FloatField(default_value=0.0)
    bb22 = bboxCorner22


class BboxCorner2AttrOperator(
    Float3CompoundBaseAttrOperator[BboxCorner2PlugOperator]
):
    __slots__ = ()
...
class BboxCorner2Field(
    Float3CompoundBaseField[BboxCorner2AttrOperator, BboxCorner2PlugOperator]
):
    __slots__ = ()
