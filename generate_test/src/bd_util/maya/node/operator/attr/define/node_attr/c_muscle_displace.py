...
class DispDataPlugOperator(
    ...
    length = FloatField(default_value=1.0, min_value=0.0)
    len = length

    sizeRadius = FloatField(default_value=0.5, min_value=0.0)
    siz = sizeRadius

    amplitude = FloatField(default_value=0.10000000149011612)
    amp = amplitude

    falloff = FloatField(default_value=0.5, min_value=0.0)
    fal = falloff
...
class ColorWireframePlugOperator(
    Float3CompoundBasePlugOperator["ColorWireframeAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("colorWireframeR", "colwr"),
        ("colorWireframeG", "colwg"),
        ("colorWireframeB", "colwb"),
    )

    colorWireframeR = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    colwr = colorWireframeR

    colorWireframeG = FloatField(default_value=0.30000001192092896, min_value=0.0, max_value=1.0)
    colwg = colorWireframeG

    colorWireframeB = FloatField(default_value=0.8999999761581421, min_value=0.0, max_value=1.0)
    colwb = colorWireframeB


class ColorWireframeAttrOperator(
    Float3CompoundBaseAttrOperator[ColorWireframePlugOperator]
):
    __slots__ = ()
...
class ColorWireframeField(
    Float3CompoundBaseField[ColorWireframeAttrOperator, ColorWireframePlugOperator]
):
    __slots__ = ()

    ATTR_CLS = ColorWireframeAttrOperator
    PLUG_CLS = ColorWireframePlugOperator
...
class ColorWireframe2PlugOperator(
    Float3CompoundBasePlugOperator["ColorWireframe2AttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("colorWireframe2R", "colw2r"),
        ("colorWireframe2G", "colw2g"),
        ("colorWireframe2B", "colw2b"),
    )

    colorWireframe2R = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    colw2r = colorWireframe2R

    colorWireframe2G = FloatField(default_value=1.0, min_value=0.0, max_value=1.0)
    colw2g = colorWireframe2G

    colorWireframe2B = FloatField(default_value=0.0, min_value=0.0, max_value=1.0)
    colw2b = colorWireframe2B


class ColorWireframe2AttrOperator(
    Float3CompoundBaseAttrOperator[ColorWireframe2PlugOperator]
):
    __slots__ = ()
...
class ColorWireframe2Field(
    Float3CompoundBaseField[ColorWireframe2AttrOperator, ColorWireframe2PlugOperator]
):
    __slots__ = ()

    ATTR_CLS = ColorWireframe2AttrOperator
    PLUG_CLS = ColorWireframe2PlugOperator
