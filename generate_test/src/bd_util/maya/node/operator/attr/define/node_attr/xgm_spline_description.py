...
class PreSelHighlightColorField(
    Float3CompoundBaseField[PreSelHighlightColorAttrOperator, PreSelHighlightColorPlugOperator]
):
    __slots__ = ()
...
class SelectionHighlightColorField(
    Float3CompoundBaseField[SelectionHighlightColorAttrOperator, SelectionHighlightColorPlugOperator]
):
    __slots__ = ()
...
class ShowFrozenColorField(
    Float3CompoundBaseField[ShowFrozenColorAttrOperator, ShowFrozenColorPlugOperator]
):
    __slots__ = ()
...
class HighlightPlacedColorField(
    Float3CompoundBaseField[HighlightPlacedColorAttrOperator, HighlightPlacedColorPlugOperator]
):
    __slots__ = ()
