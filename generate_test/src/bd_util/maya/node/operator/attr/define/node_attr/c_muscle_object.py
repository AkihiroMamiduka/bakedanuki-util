...
class MuscleDataPlugOperator(
    ...
    stickyStrength = DoubleField(default_value=1.0, soft_min_value=0.0, soft_max_value=1.0)
    stkstr = stickyStrength

    slidingStrength = DoubleField(default_value=1.0, soft_min_value=0.0, soft_max_value=1.0)
...
class WirecolorPlugOperator(
    Float3CompoundBasePlugOperator["WirecolorAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("wirecolorR", "wcolr"),
    ...
    wirecolorR = FloatField(default_value=1.0, min_value=0.0, max_value=1.0)
    wcolr = wirecolorR

    wirecolorG = FloatField(default_value=0.20000000298023224, min_value=0.0, max_value=1.0)
    wcolg = wirecolorG

    wirecolorB = FloatField(default_value=0.20000000298023224, min_value=0.0, max_value=1.0)
    wcolb = wirecolorB


class WirecolorAttrOperator(
    Float3CompoundBaseAttrOperator[WirecolorPlugOperator]
):
    __slots__ = ()
...
class WirecolorField(
    Float3CompoundBaseField[WirecolorAttrOperator, WirecolorPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = WirecolorAttrOperator
    PLUG_CLS = WirecolorPlugOperator
...
class ShadecolorPlugOperator(
    Float3CompoundBasePlugOperator["ShadecolorAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("shadecolorR", "scolr"),
    ...
    shadecolorR = FloatField(default_value=0.699999988079071, min_value=0.0, max_value=1.0)
    scolr = shadecolorR

    shadecolorG = FloatField(default_value=0.20000000298023224, min_value=0.0, max_value=1.0)
    scolg = shadecolorG

    shadecolorB = FloatField(default_value=0.25, min_value=0.0, max_value=1.0)
    scolb = shadecolorB


class ShadecolorAttrOperator(
    Float3CompoundBaseAttrOperator[ShadecolorPlugOperator]
):
    __slots__ = ()
...
class ShadecolorField(
    Float3CompoundBaseField[ShadecolorAttrOperator, ShadecolorPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = ShadecolorAttrOperator
    PLUG_CLS = ShadecolorPlugOperator
