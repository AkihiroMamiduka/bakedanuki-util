...
class MinMaxRangeUField(
    Double2CompoundBaseField[MinMaxRangeUAttrOperator, MinMaxRangeUPlugOperator]
):
    __slots__ = ()
...
class MinMaxRangeVField(
    Double2CompoundBaseField[MinMaxRangeVAttrOperator, MinMaxRangeVPlugOperator]
):
    __slots__ = ()
...
class SpansUVAttrOperator(
    Long2CompoundBaseAttrOperator[SpansUVPlugOperator]
):
    __slots__ = ()
