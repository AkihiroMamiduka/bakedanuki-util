...
class AttrNodeTypeEnumPlugOperator(EnumPlugOperator):
    __slots__ = ()
...
class AttrNodeTypeEnumAttrOperator(EnumAttrOperator):
    __slots__ = ()
...
class AttrNodeTypeEnumField(
    EnumField[AttrNodeTypeEnumAttrOperator, AttrNodeTypeEnumPlugOperator]
):
    __slots__ = ()

    ATTR_CLS = AttrNodeTypeEnumAttrOperator
    PLUG_CLS = AttrNodeTypeEnumPlugOperator
...
class AiNodeAttrsPlugOperator(
    CompoundPlugOperator["AiNodeAttrsAttrOperator"]
):
    __slots__ = ()
    CHILD_ATTR_NAMES = (
        ("attrName", "attr_name"),
    ...
    attrNodeType = AttrNodeTypeEnumField(default_value=0)
    attr_node_type = attrNodeType


class AiNodeAttrsAttrOperator(
    CompoundAttrOperator[AiNodeAttrsPlugOperator]
):
    __slots__ = ()
