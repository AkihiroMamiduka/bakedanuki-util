...
class StartPointField(
    DoubleLinear3CompoundBaseField[StartPointAttrOperator, StartPointPlugOperator]
):
    __slots__ = ()
...
class MiddlePointField(
    DoubleLinear3CompoundBaseField[MiddlePointAttrOperator, MiddlePointPlugOperator]
):
    __slots__ = ()
