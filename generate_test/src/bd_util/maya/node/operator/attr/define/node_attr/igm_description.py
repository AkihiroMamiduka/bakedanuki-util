...
class BaseColorPlugOperator(
    ...
    baseColorR = FloatField(default_value=0.46700000762939453)
    bclr = baseColorR

    baseColorG = FloatField(default_value=0.31299999356269836)
    bclg = baseColorG

    baseColorB = FloatField(default_value=0.3100000023841858)
    bclb = baseColorB
...
class TipColorPlugOperator(
    ...
    tipColorR = FloatField(default_value=0.9210000038146973)
    tclr = tipColorR

    tipColorG = FloatField(default_value=0.8330000042915344)
    tclg = tipColorG

    tipColorB = FloatField(default_value=0.017000000923871994)
    tclb = tipColorB
