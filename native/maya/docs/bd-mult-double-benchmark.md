# bdDouble Multiplication Benchmark

`bdMultDoublePair` の左結合チェーンと `bdMultDoubleMulti` の境界を確認するための
Maya 2025 実測結果です。
...
- 配列版は全factorを1個の `bdMultDoubleMulti` へ接続します。
