...
可変長入力ノード、single / multi-source Quaternion orientation RBF interpolative / falloff weight、Bend-Twist falloff weight、single / multi-source position RBF interpolative / falloff weight、RBF weightによるTRS pose blend、空入力、sparse 配列、logical index 順、除数epsilon、`NaN`、無限値、
