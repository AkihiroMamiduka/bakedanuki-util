...
可変長入力ノード、Quaternion RBF interpolative / pose falloff / Bend-Twist falloff weight、position RBF interpolative / falloff weight、RBF weightによるTRS pose blend、空入力、sparse 配列、logical index 順、除数epsilon、`NaN`、無限値、
