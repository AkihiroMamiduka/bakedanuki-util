...
const MString BdMultDoubleMultiNode::typeName("bdMultDoubleMulti");
const MTypeId BdMultDoubleMultiNode::typeId(0x0007F003);

MObject BdMultDoubleMultiNode::input;
MObject BdMultDoubleMultiNode::output;

void* BdMultDoubleMultiNode::creator() {
    return new BdMultDoubleMultiNode();
}

MStatus BdMultDoubleMultiNode::initialize() {
...
MStatus BdMultDoubleMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdMultDoubleMultiNode::schedulingType() const {
