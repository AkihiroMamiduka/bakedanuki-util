...
const MString BdSubDoublePairNode::typeName("bdSubDoublePair");
const MTypeId BdSubDoublePairNode::typeId(0x0007F00C);

MObject BdSubDoublePairNode::input1;
MObject BdSubDoublePairNode::input2;
MObject BdSubDoublePairNode::output;

void* BdSubDoublePairNode::creator() {
    return new BdSubDoublePairNode();
}

MStatus BdSubDoublePairNode::initialize() {
...
MStatus BdSubDoublePairNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdSubDoublePairNode::schedulingType() const {
