...
const MString BdDoubleDivMultiNode::typeName("bdDoubleDivMulti");
const MTypeId BdDoubleDivMultiNode::typeId(0x0007F00F);

MObject BdDoubleDivMultiNode::input;
MObject BdDoubleDivMultiNode::output;

void* BdDoubleDivMultiNode::creator() {
    return new BdDoubleDivMultiNode();
}

MStatus BdDoubleDivMultiNode::initialize() {
...
MStatus BdDoubleDivMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDoubleDivMultiNode::schedulingType() const {
