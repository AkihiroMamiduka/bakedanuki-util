...
const MString BdMultDoublePairNode::typeName("bdMultDoublePair");
const MTypeId BdMultDoublePairNode::typeId(0x0007F004);

MObject BdMultDoublePairNode::input1;
MObject BdMultDoublePairNode::input2;
MObject BdMultDoublePairNode::output;

void* BdMultDoublePairNode::creator() {
    return new BdMultDoublePairNode();
}

MStatus BdMultDoublePairNode::initialize() {
...
MStatus BdMultDoublePairNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdMultDoublePairNode::schedulingType() const {
