...
const MString BdPowDoublePairNode::typeName("bdPowDoublePair");
const MTypeId BdPowDoublePairNode::typeId(0x0007F014);

MObject BdPowDoublePairNode::input1;
MObject BdPowDoublePairNode::input2;
MObject BdPowDoublePairNode::output;

void* BdPowDoublePairNode::creator() {
    return new BdPowDoublePairNode();
}

MStatus BdPowDoublePairNode::initialize() {
...
MStatus BdPowDoublePairNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdPowDoublePairNode::schedulingType() const {
