...
const MString BdDoubleAddNode::typeName("bdDoubleAdd");
const MTypeId BdDoubleAddNode::typeId(0x0007F008);

MObject BdDoubleAddNode::input1;
MObject BdDoubleAddNode::input2;
MObject BdDoubleAddNode::output;

void* BdDoubleAddNode::creator() {
    return new BdDoubleAddNode();
}

MStatus BdDoubleAddNode::initialize() {
...
MStatus BdDoubleAddNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDoubleAddNode::schedulingType() const {
