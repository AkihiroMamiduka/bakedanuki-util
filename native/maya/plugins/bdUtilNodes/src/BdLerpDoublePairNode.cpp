...
const MString BdLerpDoublePairNode::typeName("bdLerpDoublePair");
const MTypeId BdLerpDoublePairNode::typeId(0x0007F018);

MObject BdLerpDoublePairNode::input1;
MObject BdLerpDoublePairNode::input2;
MObject BdLerpDoublePairNode::weight;
MObject BdLerpDoublePairNode::output;

void* BdLerpDoublePairNode::creator() {
    return new BdLerpDoublePairNode();
}

MStatus BdLerpDoublePairNode::initialize() {
...
MStatus BdLerpDoublePairNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdLerpDoublePairNode::schedulingType() const {
