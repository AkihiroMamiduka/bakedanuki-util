...
MObject BdDbl3DivNode::input1X;
MObject BdDbl3DivNode::input1Y;
MObject BdDbl3DivNode::input1Z;

MObject BdDbl3DivNode::input2;
MObject BdDbl3DivNode::input2X;
MObject BdDbl3DivNode::input2Y;
MObject BdDbl3DivNode::input2Z;

MObject BdDbl3DivNode::output;
MObject BdDbl3DivNode::outputX;
MObject BdDbl3DivNode::outputY;
MObject BdDbl3DivNode::outputZ;

void* BdDbl3DivNode::creator() {
    return new BdDbl3DivNode();
}

MStatus BdDbl3DivNode::initialize() {
...
MPxNode::SchedulingType BdDbl3DivNode::schedulingType() const {
