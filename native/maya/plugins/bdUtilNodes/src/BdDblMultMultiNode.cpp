...
const MString BdDblMultMultiNode::typeName("bdDbl_MultMulti");
const MTypeId BdDblMultMultiNode::typeId(0x0007F003);

MObject BdDblMultMultiNode::input;
MObject BdDblMultMultiNode::output;

void* BdDblMultMultiNode::creator() {
    return new BdDblMultMultiNode();
}

MStatus BdDblMultMultiNode::initialize() {
...
MStatus BdDblMultMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDblMultMultiNode::schedulingType() const {
