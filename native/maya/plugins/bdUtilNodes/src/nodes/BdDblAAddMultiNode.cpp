...
const MString BdDblAAddMultiNode::typeName("bdDblA_AddMulti");
const MTypeId BdDblAAddMultiNode::typeId(0x0007F06C);

MObject BdDblAAddMultiNode::input;
MObject BdDblAAddMultiNode::output;

void* BdDblAAddMultiNode::creator() {
    return new BdDblAAddMultiNode();
}

MStatus BdDblAAddMultiNode::initialize() {
...
MStatus BdDblAAddMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDblAAddMultiNode::schedulingType() const {
