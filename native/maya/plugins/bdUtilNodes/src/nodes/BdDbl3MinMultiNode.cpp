...
const MString BdDbl3MinMultiNode::typeName("bdDbl3_MinMulti");
const MTypeId BdDbl3MinMultiNode::typeId(0x0007F01B);

MObject BdDbl3MinMultiNode::input;
MObject BdDbl3MinMultiNode::inputX;
MObject BdDbl3MinMultiNode::inputY;
MObject BdDbl3MinMultiNode::inputZ;

MObject BdDbl3MinMultiNode::output;
MObject BdDbl3MinMultiNode::outputX;
MObject BdDbl3MinMultiNode::outputY;
MObject BdDbl3MinMultiNode::outputZ;

void* BdDbl3MinMultiNode::creator() {
    return new BdDbl3MinMultiNode();
}

MStatus BdDbl3MinMultiNode::initialize() {
...
MStatus BdDbl3MinMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDbl3MinMultiNode::schedulingType() const {
