...
const MString BdDblLWeightedAverageMultiNode::typeName(
    "bdDblL_WeightedAverageMulti"
);
const MTypeId BdDblLWeightedAverageMultiNode::typeId(0x001426D6);

MObject BdDblLWeightedAverageMultiNode::input;
MObject BdDblLWeightedAverageMultiNode::value;
MObject BdDblLWeightedAverageMultiNode::weight;
MObject BdDblLWeightedAverageMultiNode::output;

void* BdDblLWeightedAverageMultiNode::creator() {
    return new BdDblLWeightedAverageMultiNode();
}

MStatus BdDblLWeightedAverageMultiNode::initialize() {
...
MStatus BdDblLWeightedAverageMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDblLWeightedAverageMultiNode::schedulingType() const {
