...
MObject BdDblLDivideNode::output;

void* BdDblLDivideNode::creator() {
    return new BdDblLDivideNode();
}

MStatus BdDblLDivideNode::initialize() {
...
MStatus BdDblLDivideNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDblLDivideNode::schedulingType() const {
