...
const MString BdAnyConditionDblNode::typeName("bdAny_ConditionDbl");
const MTypeId BdAnyConditionDblNode::typeId(0x001426AD);

MObject BdAnyConditionDblNode::input;
MObject BdAnyConditionDblNode::operation;
MObject BdAnyConditionDblNode::compare;
MObject BdAnyConditionDblNode::extra;
MObject BdAnyConditionDblNode::logic;
MObject BdAnyConditionDblNode::comparison;
MObject BdAnyConditionDblNode::compareValue;
MObject BdAnyConditionDblNode::trueValue;
MObject BdAnyConditionDblNode::falseValue;
MObject BdAnyConditionDblNode::output;

void* BdAnyConditionDblNode::creator() {
    return new BdAnyConditionDblNode();
}

MStatus BdAnyConditionDblNode::initialize() {
...
MStatus BdAnyConditionDblNode::compute(
    const MPlug& plug,
    ...
    status = bd_util_nodes::evaluateExtraConditions(
        ...
        logic,
        comparison,
        BdAnyConditionDblNode::compareValue,
        conditionResult
    );
    if (!status) {
        return status;
...
MPxNode::SchedulingType BdAnyConditionDblNode::schedulingType() const {
