...
const MString BdDblADivideNode::typeName("bdDblA_Divide");
const MTypeId BdDblADivideNode::typeId(0x001426F2);

MObject BdDblADivideNode::input;
MObject BdDblADivideNode::factor;
MObject BdDblADivideNode::output;

void* BdDblADivideNode::creator() {
    return new BdDblADivideNode();
}

MStatus BdDblADivideNode::initialize() {
...
MStatus BdDblADivideNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDblADivideNode::schedulingType() const {
