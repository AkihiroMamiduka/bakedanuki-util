...
const MString BdAnyConditionDblLNode::typeName("bdAny_ConditionDblL");
const MTypeId BdAnyConditionDblLNode::typeId(0x0007F059);

MObject BdAnyConditionDblLNode::input;
MObject BdAnyConditionDblLNode::operation;
MObject BdAnyConditionDblLNode::compare;
MObject BdAnyConditionDblLNode::extra;
MObject BdAnyConditionDblLNode::logic;
MObject BdAnyConditionDblLNode::comparison;
MObject BdAnyConditionDblLNode::compareValue;
MObject BdAnyConditionDblLNode::trueValue;
MObject BdAnyConditionDblLNode::falseValue;
MObject BdAnyConditionDblLNode::output;

void* BdAnyConditionDblLNode::creator() {
    return new BdAnyConditionDblLNode();
}

MStatus BdAnyConditionDblLNode::initialize() {
...
MStatus BdAnyConditionDblLNode::compute(
    const MPlug& plug,
    ...
    status = bd_util_nodes::evaluateExtraConditions(
        ...
        logic,
        comparison,
        BdAnyConditionDblLNode::compareValue,
        conditionResult
    );
    if (!status) {
        return status;
...
MPxNode::SchedulingType BdAnyConditionDblLNode::schedulingType() const {
