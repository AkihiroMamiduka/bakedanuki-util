...
MObject BdDbl3PowerMultiNode::inputY;
MObject BdDbl3PowerMultiNode::inputZ;

MObject BdDbl3PowerMultiNode::output;
MObject BdDbl3PowerMultiNode::outputX;
MObject BdDbl3PowerMultiNode::outputY;
MObject BdDbl3PowerMultiNode::outputZ;

void* BdDbl3PowerMultiNode::creator() {
    return new BdDbl3PowerMultiNode();
}

MStatus BdDbl3PowerMultiNode::initialize() {
...
MStatus BdDbl3PowerMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDbl3PowerMultiNode::schedulingType() const {
