...
const MString BdDbl3SubtractNode::typeName("bdDbl3_Subtract");
const MTypeId BdDbl3SubtractNode::typeId(0x0007F00A);

MObject BdDbl3SubtractNode::input1;
MObject BdDbl3SubtractNode::input1X;
MObject BdDbl3SubtractNode::input1Y;
MObject BdDbl3SubtractNode::input1Z;

MObject BdDbl3SubtractNode::input2;
MObject BdDbl3SubtractNode::input2X;
MObject BdDbl3SubtractNode::input2Y;
MObject BdDbl3SubtractNode::input2Z;

MObject BdDbl3SubtractNode::output;
MObject BdDbl3SubtractNode::outputX;
MObject BdDbl3SubtractNode::outputY;
MObject BdDbl3SubtractNode::outputZ;

void* BdDbl3SubtractNode::creator() {
    return new BdDbl3SubtractNode();
}

MStatus BdDbl3SubtractNode::initialize() {
...
MStatus BdDbl3SubtractNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDbl3SubtractNode::schedulingType() const {
