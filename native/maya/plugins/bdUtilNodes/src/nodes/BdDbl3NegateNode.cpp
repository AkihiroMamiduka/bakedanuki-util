...
const MString BdDbl3NegateNode::typeName("bdDbl3_Negate");
const MTypeId BdDbl3NegateNode::typeId(0x001426A8);

MObject BdDbl3NegateNode::input;
MObject BdDbl3NegateNode::inputX;
MObject BdDbl3NegateNode::inputY;
MObject BdDbl3NegateNode::inputZ;

MObject BdDbl3NegateNode::output;
MObject BdDbl3NegateNode::outputX;
MObject BdDbl3NegateNode::outputY;
MObject BdDbl3NegateNode::outputZ;

void* BdDbl3NegateNode::creator() {
    return new BdDbl3NegateNode();
}

MStatus BdDbl3NegateNode::initialize() {
...
MStatus BdDbl3NegateNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDbl3NegateNode::schedulingType() const {
