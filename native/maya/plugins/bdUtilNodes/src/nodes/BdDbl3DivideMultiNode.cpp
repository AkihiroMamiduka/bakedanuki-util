...
const MString BdDbl3DivideMultiNode::typeName("bdDbl3_DivideMulti");
const MTypeId BdDbl3DivideMultiNode::typeId(0x0007F00D);

MObject BdDbl3DivideMultiNode::input;
MObject BdDbl3DivideMultiNode::inputX;
MObject BdDbl3DivideMultiNode::inputY;
MObject BdDbl3DivideMultiNode::inputZ;

MObject BdDbl3DivideMultiNode::output;
MObject BdDbl3DivideMultiNode::outputX;
MObject BdDbl3DivideMultiNode::outputY;
MObject BdDbl3DivideMultiNode::outputZ;

void* BdDbl3DivideMultiNode::creator() {
    return new BdDbl3DivideMultiNode();
}

MStatus BdDbl3DivideMultiNode::initialize() {
...
MStatus BdDbl3DivideMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDbl3DivideMultiNode::schedulingType() const {
