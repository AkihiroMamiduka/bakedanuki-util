...
const MString BdDblAWeightedSumMultiNode::typeName("bdDblA_WeightedSumMulti");
const MTypeId BdDblAWeightedSumMultiNode::typeId(0x001426FD);

MObject BdDblAWeightedSumMultiNode::input;
MObject BdDblAWeightedSumMultiNode::value;
MObject BdDblAWeightedSumMultiNode::weight;
MObject BdDblAWeightedSumMultiNode::output;

void* BdDblAWeightedSumMultiNode::creator() {
    return new BdDblAWeightedSumMultiNode();
}

MStatus BdDblAWeightedSumMultiNode::initialize() {
...
MStatus BdDblAWeightedSumMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDblAWeightedSumMultiNode::schedulingType() const {
