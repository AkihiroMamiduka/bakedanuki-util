...
MObject BdDblSubtractNode::output;

void* BdDblSubtractNode::creator() {
    return new BdDblSubtractNode();
}

MStatus BdDblSubtractNode::initialize() {
...
MStatus BdDblSubtractNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDblSubtractNode::schedulingType() const {
