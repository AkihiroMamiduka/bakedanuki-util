...
const MString BdDblAAverageMultiNode::typeName("bdDblA_AverageMulti");
const MTypeId BdDblAAverageMultiNode::typeId(0x0007F07D);

MObject BdDblAAverageMultiNode::input;
MObject BdDblAAverageMultiNode::output;

void* BdDblAAverageMultiNode::creator() {
    return new BdDblAAverageMultiNode();
}

MStatus BdDblAAverageMultiNode::initialize() {
...
MStatus BdDblAAverageMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDblAAverageMultiNode::schedulingType() const {
