...
const MString BdDblAMaxMultiNode::typeName("bdDblA_MaxMulti");
const MTypeId BdDblAMaxMultiNode::typeId(0x0007F07B);

MObject BdDblAMaxMultiNode::input;
MObject BdDblAMaxMultiNode::output;

void* BdDblAMaxMultiNode::creator() {
    return new BdDblAMaxMultiNode();
}

MStatus BdDblAMaxMultiNode::initialize() {
...
MStatus BdDblAMaxMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDblAMaxMultiNode::schedulingType() const {
