...
MObject BdAnyConditionDblAMultiNode::operation;
MObject BdAnyConditionDblAMultiNode::compare;
MObject BdAnyConditionDblAMultiNode::extra;
MObject BdAnyConditionDblAMultiNode::logic;
MObject BdAnyConditionDblAMultiNode::comparison;
MObject BdAnyConditionDblAMultiNode::compareValue;
MObject BdAnyConditionDblAMultiNode::value;
MObject BdAnyConditionDblAMultiNode::elseValue;
MObject BdAnyConditionDblAMultiNode::output;

void* BdAnyConditionDblAMultiNode::creator() {
    return new BdAnyConditionDblAMultiNode();
}

MStatus BdAnyConditionDblAMultiNode::initialize() {
...
MStatus BdAnyConditionDblAMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdAnyConditionDblAMultiNode::schedulingType() const {
