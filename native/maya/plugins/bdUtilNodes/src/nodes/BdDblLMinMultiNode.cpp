...
const MString BdDblLMinMultiNode::typeName("bdDblL_MinMulti");
const MTypeId BdDblLMinMultiNode::typeId(0x001426C3);

MObject BdDblLMinMultiNode::input;
MObject BdDblLMinMultiNode::output;

void* BdDblLMinMultiNode::creator() {
    return new BdDblLMinMultiNode();
}

MStatus BdDblLMinMultiNode::initialize() {
...
MStatus BdDblLMinMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDblLMinMultiNode::schedulingType() const {
