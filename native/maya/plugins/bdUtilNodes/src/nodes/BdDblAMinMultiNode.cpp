...
void* BdDblAMinMultiNode::creator() {
    return new BdDblAMinMultiNode();
}

MStatus BdDblAMinMultiNode::initialize() {
...
MStatus BdDblAMinMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDblAMinMultiNode::schedulingType() const {
