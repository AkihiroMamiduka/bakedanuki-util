...
const MString BdDblMinMultiNode::typeName("bdDbl_MinMulti");
const MTypeId BdDblMinMultiNode::typeId(0x0007F01D);

MObject BdDblMinMultiNode::input;
MObject BdDblMinMultiNode::output;

void* BdDblMinMultiNode::creator() {
    return new BdDblMinMultiNode();
}

MStatus BdDblMinMultiNode::initialize() {
...
MStatus BdDblMinMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDblMinMultiNode::schedulingType() const {
