...
const MString BdDbl3SubtractMultiNode::typeName("bdDbl3_SubtractMulti");
const MTypeId BdDbl3SubtractMultiNode::typeId(0x0007F009);

MObject BdDbl3SubtractMultiNode::input;
MObject BdDbl3SubtractMultiNode::inputX;
MObject BdDbl3SubtractMultiNode::inputY;
MObject BdDbl3SubtractMultiNode::inputZ;

MObject BdDbl3SubtractMultiNode::output;
MObject BdDbl3SubtractMultiNode::outputX;
MObject BdDbl3SubtractMultiNode::outputY;
MObject BdDbl3SubtractMultiNode::outputZ;

void* BdDbl3SubtractMultiNode::creator() {
    return new BdDbl3SubtractMultiNode();
}

MStatus BdDbl3SubtractMultiNode::initialize() {
...
MStatus BdDbl3SubtractMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDbl3SubtractMultiNode::schedulingType() const {
