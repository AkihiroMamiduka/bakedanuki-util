...
MObject BdDblL3MaxNode::input1Y;
MObject BdDblL3MaxNode::input1Z;

MObject BdDblL3MaxNode::input2;
MObject BdDblL3MaxNode::input2X;
MObject BdDblL3MaxNode::input2Y;
MObject BdDblL3MaxNode::input2Z;

MObject BdDblL3MaxNode::output;
MObject BdDblL3MaxNode::outputX;
MObject BdDblL3MaxNode::outputY;
MObject BdDblL3MaxNode::outputZ;

void* BdDblL3MaxNode::creator() {
    return new BdDblL3MaxNode();
}

MStatus BdDblL3MaxNode::initialize() {
...
MStatus BdDblL3MaxNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDblL3MaxNode::schedulingType() const {
