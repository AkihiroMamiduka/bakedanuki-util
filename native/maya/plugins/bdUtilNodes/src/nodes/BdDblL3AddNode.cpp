...
const MString BdDblL3AddNode::typeName("bdDblL3_Add");
const MTypeId BdDblL3AddNode::typeId(0x001426B8);

MObject BdDblL3AddNode::input1;
MObject BdDblL3AddNode::input1X;
MObject BdDblL3AddNode::input1Y;
MObject BdDblL3AddNode::input1Z;

MObject BdDblL3AddNode::input2;
MObject BdDblL3AddNode::input2X;
MObject BdDblL3AddNode::input2Y;
MObject BdDblL3AddNode::input2Z;

MObject BdDblL3AddNode::output;
MObject BdDblL3AddNode::outputX;
MObject BdDblL3AddNode::outputY;
MObject BdDblL3AddNode::outputZ;

void* BdDblL3AddNode::creator() {
    return new BdDblL3AddNode();
}

MStatus BdDblL3AddNode::initialize() {
...
MStatus BdDblL3AddNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDblL3AddNode::schedulingType() const {
