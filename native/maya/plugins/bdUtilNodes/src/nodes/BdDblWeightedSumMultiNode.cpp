...
const MString BdDblWeightedSumMultiNode::typeName("bdDbl_WeightedSumMulti");
const MTypeId BdDblWeightedSumMultiNode::typeId(0x0007F01A);

MObject BdDblWeightedSumMultiNode::input;
MObject BdDblWeightedSumMultiNode::value;
MObject BdDblWeightedSumMultiNode::weight;
MObject BdDblWeightedSumMultiNode::output;

void* BdDblWeightedSumMultiNode::creator() {
    return new BdDblWeightedSumMultiNode();
}

MStatus BdDblWeightedSumMultiNode::initialize() {
...
MStatus BdDblWeightedSumMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDblWeightedSumMultiNode::schedulingType() const {
