...
void* BdDblSubtractMultiNode::creator() {
    return new BdDblSubtractMultiNode();
}

MStatus BdDblSubtractMultiNode::initialize() {
...
MStatus BdDblSubtractMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDblSubtractMultiNode::schedulingType() const {
