...
const MString BdDoubleSubMultiNode::typeName("bdDoubleSubMulti");
const MTypeId BdDoubleSubMultiNode::typeId(0x0007F00B);

MObject BdDoubleSubMultiNode::input;
MObject BdDoubleSubMultiNode::output;

void* BdDoubleSubMultiNode::creator() {
    return new BdDoubleSubMultiNode();
}

MStatus BdDoubleSubMultiNode::initialize() {
...
MStatus BdDoubleSubMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDoubleSubMultiNode::schedulingType() const {
