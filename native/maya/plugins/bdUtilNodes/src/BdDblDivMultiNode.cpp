...
const MString BdDblDivMultiNode::typeName("bdDbl_DivMulti");
const MTypeId BdDblDivMultiNode::typeId(0x0007F00F);

MObject BdDblDivMultiNode::input;
MObject BdDblDivMultiNode::output;

void* BdDblDivMultiNode::creator() {
    return new BdDblDivMultiNode();
}

MStatus BdDblDivMultiNode::initialize() {
...
MStatus BdDblDivMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDblDivMultiNode::schedulingType() const {
