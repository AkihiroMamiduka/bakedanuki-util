...
const MString BdDbl3SubMultiNode::typeName("bdDbl3_SubMulti");
const MTypeId BdDbl3SubMultiNode::typeId(0x0007F009);

MObject BdDbl3SubMultiNode::input;
MObject BdDbl3SubMultiNode::inputX;
MObject BdDbl3SubMultiNode::inputY;
MObject BdDbl3SubMultiNode::inputZ;

MObject BdDbl3SubMultiNode::output;
MObject BdDbl3SubMultiNode::outputX;
MObject BdDbl3SubMultiNode::outputY;
MObject BdDbl3SubMultiNode::outputZ;

void* BdDbl3SubMultiNode::creator() {
    return new BdDbl3SubMultiNode();
}

MStatus BdDbl3SubMultiNode::initialize() {
...
MStatus BdDbl3SubMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDbl3SubMultiNode::schedulingType() const {
