...
const MString BdSubDoubleMultiNode::typeName("bdSubDoubleMulti");
const MTypeId BdSubDoubleMultiNode::typeId(0x0007F00B);

MObject BdSubDoubleMultiNode::input;
MObject BdSubDoubleMultiNode::output;

void* BdSubDoubleMultiNode::creator() {
    return new BdSubDoubleMultiNode();
}

MStatus BdSubDoubleMultiNode::initialize() {
...
MStatus BdSubDoubleMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdSubDoubleMultiNode::schedulingType() const {
