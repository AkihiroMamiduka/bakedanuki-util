...
const MString BdDouble3DivNode::typeName("bdDouble3Div");
const MTypeId BdDouble3DivNode::typeId(0x0007F00E);

MObject BdDouble3DivNode::input1;
MObject BdDouble3DivNode::input1X;
MObject BdDouble3DivNode::input1Y;
MObject BdDouble3DivNode::input1Z;

MObject BdDouble3DivNode::input2;
MObject BdDouble3DivNode::input2X;
MObject BdDouble3DivNode::input2Y;
MObject BdDouble3DivNode::input2Z;

MObject BdDouble3DivNode::output;
MObject BdDouble3DivNode::outputX;
MObject BdDouble3DivNode::outputY;
MObject BdDouble3DivNode::outputZ;

void* BdDouble3DivNode::creator() {
    return new BdDouble3DivNode();
}

MStatus BdDouble3DivNode::initialize() {
...
MStatus BdDouble3DivNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDouble3DivNode::schedulingType() const {
