...
MObject BdDblDivNode::input2;
MObject BdDblDivNode::output;

void* BdDblDivNode::creator() {
    return new BdDblDivNode();
}

MStatus BdDblDivNode::initialize() {
...
MPxNode::SchedulingType BdDblDivNode::schedulingType() const {
