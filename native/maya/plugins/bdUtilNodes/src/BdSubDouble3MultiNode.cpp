...
const MString BdSubDouble3MultiNode::typeName("bdSubDouble3Multi");
const MTypeId BdSubDouble3MultiNode::typeId(0x0007F009);

MObject BdSubDouble3MultiNode::input;
MObject BdSubDouble3MultiNode::inputX;
MObject BdSubDouble3MultiNode::inputY;
MObject BdSubDouble3MultiNode::inputZ;

MObject BdSubDouble3MultiNode::output;
MObject BdSubDouble3MultiNode::outputX;
MObject BdSubDouble3MultiNode::outputY;
MObject BdSubDouble3MultiNode::outputZ;

void* BdSubDouble3MultiNode::creator() {
    return new BdSubDouble3MultiNode();
}

MStatus BdSubDouble3MultiNode::initialize() {
...
MStatus BdSubDouble3MultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdSubDouble3MultiNode::schedulingType() const {
