...
const MString BdAddDoublePairNode::typeName("bdAddDoublePair");
const MTypeId BdAddDoublePairNode::typeId(0x0007F008);

MObject BdAddDoublePairNode::input1;
MObject BdAddDoublePairNode::input2;
MObject BdAddDoublePairNode::output;

void* BdAddDoublePairNode::creator() {
    return new BdAddDoublePairNode();
}

MStatus BdAddDoublePairNode::initialize() {
...
MStatus BdAddDoublePairNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdAddDoublePairNode::schedulingType() const {
