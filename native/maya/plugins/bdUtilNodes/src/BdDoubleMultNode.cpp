...
const MString BdDoubleMultNode::typeName("bdDoubleMult");
const MTypeId BdDoubleMultNode::typeId(0x0007F004);

MObject BdDoubleMultNode::input1;
MObject BdDoubleMultNode::input2;
MObject BdDoubleMultNode::output;

void* BdDoubleMultNode::creator() {
    return new BdDoubleMultNode();
}

MStatus BdDoubleMultNode::initialize() {
...
MStatus BdDoubleMultNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDoubleMultNode::schedulingType() const {
