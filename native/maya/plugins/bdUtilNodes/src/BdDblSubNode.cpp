...
const MString BdDblSubNode::typeName("bdDbl_Sub");
const MTypeId BdDblSubNode::typeId(0x0007F00C);

MObject BdDblSubNode::input1;
MObject BdDblSubNode::input2;
MObject BdDblSubNode::output;

void* BdDblSubNode::creator() {
    return new BdDblSubNode();
}

MStatus BdDblSubNode::initialize() {
...
MPxNode::SchedulingType BdDblSubNode::schedulingType() const {
