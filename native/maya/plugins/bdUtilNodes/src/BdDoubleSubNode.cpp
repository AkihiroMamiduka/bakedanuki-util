...
const MString BdDoubleSubNode::typeName("bdDoubleSub");
const MTypeId BdDoubleSubNode::typeId(0x0007F00C);

MObject BdDoubleSubNode::input1;
MObject BdDoubleSubNode::input2;
MObject BdDoubleSubNode::output;

void* BdDoubleSubNode::creator() {
    return new BdDoubleSubNode();
}

MStatus BdDoubleSubNode::initialize() {
...
MStatus BdDoubleSubNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDoubleSubNode::schedulingType() const {
