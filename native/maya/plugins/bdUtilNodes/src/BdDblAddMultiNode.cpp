...
const MString BdDblAddMultiNode::typeName("bdDblAddMulti");
const MTypeId BdDblAddMultiNode::typeId(0x0007F007);

MObject BdDblAddMultiNode::input;
MObject BdDblAddMultiNode::output;

void* BdDblAddMultiNode::creator() {
    return new BdDblAddMultiNode();
}

MStatus BdDblAddMultiNode::initialize() {
...
MStatus BdDblAddMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDblAddMultiNode::schedulingType() const {
