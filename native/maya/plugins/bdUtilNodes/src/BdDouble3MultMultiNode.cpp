...
MObject BdDouble3MultMultiNode::input;
MObject BdDouble3MultMultiNode::inputX;
MObject BdDouble3MultMultiNode::inputY;
MObject BdDouble3MultMultiNode::inputZ;

MObject BdDouble3MultMultiNode::output;
MObject BdDouble3MultMultiNode::outputX;
MObject BdDouble3MultMultiNode::outputY;
MObject BdDouble3MultMultiNode::outputZ;

void* BdDouble3MultMultiNode::creator() {
    return new BdDouble3MultMultiNode();
}

MStatus BdDouble3MultMultiNode::initialize() {
...
MStatus BdDouble3MultMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDouble3MultMultiNode::schedulingType() const {
