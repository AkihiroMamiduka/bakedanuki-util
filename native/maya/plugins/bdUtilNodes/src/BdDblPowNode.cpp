...
const MString BdDblPowNode::typeName("bdDbl_Pow");
const MTypeId BdDblPowNode::typeId(0x0007F014);

MObject BdDblPowNode::input1;
MObject BdDblPowNode::input2;
MObject BdDblPowNode::output;

void* BdDblPowNode::creator() {
    return new BdDblPowNode();
}

MStatus BdDblPowNode::initialize() {
...
MPxNode::SchedulingType BdDblPowNode::schedulingType() const {
