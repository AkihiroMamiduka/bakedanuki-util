...
const MString BdDoubleAddMultiNode::typeName("bdDoubleAddMulti");
const MTypeId BdDoubleAddMultiNode::typeId(0x0007F007);

MObject BdDoubleAddMultiNode::input;
MObject BdDoubleAddMultiNode::output;

void* BdDoubleAddMultiNode::creator() {
    return new BdDoubleAddMultiNode();
}

MStatus BdDoubleAddMultiNode::initialize() {
...
MStatus BdDoubleAddMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDoubleAddMultiNode::schedulingType() const {
