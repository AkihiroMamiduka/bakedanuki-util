...
const MString BdPowDoubleMultiNode::typeName("bdPowDoubleMulti");
const MTypeId BdPowDoubleMultiNode::typeId(0x0007F013);

MObject BdPowDoubleMultiNode::input;
MObject BdPowDoubleMultiNode::output;

void* BdPowDoubleMultiNode::creator() {
    return new BdPowDoubleMultiNode();
}

MStatus BdPowDoubleMultiNode::initialize() {
...
MStatus BdPowDoubleMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdPowDoubleMultiNode::schedulingType() const {
