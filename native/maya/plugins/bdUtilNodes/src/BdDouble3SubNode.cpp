...
const MString BdDouble3SubNode::typeName("bdDouble3Sub");
const MTypeId BdDouble3SubNode::typeId(0x0007F00A);

MObject BdDouble3SubNode::input1;
MObject BdDouble3SubNode::input1X;
MObject BdDouble3SubNode::input1Y;
MObject BdDouble3SubNode::input1Z;

MObject BdDouble3SubNode::input2;
MObject BdDouble3SubNode::input2X;
MObject BdDouble3SubNode::input2Y;
MObject BdDouble3SubNode::input2Z;

MObject BdDouble3SubNode::output;
MObject BdDouble3SubNode::outputX;
MObject BdDouble3SubNode::outputY;
MObject BdDouble3SubNode::outputZ;

void* BdDouble3SubNode::creator() {
    return new BdDouble3SubNode();
}

MStatus BdDouble3SubNode::initialize() {
...
MStatus BdDouble3SubNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDouble3SubNode::schedulingType() const {
