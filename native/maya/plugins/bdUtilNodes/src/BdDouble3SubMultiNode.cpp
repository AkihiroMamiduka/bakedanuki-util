...
const MString BdDouble3SubMultiNode::typeName("bdDouble3SubMulti");
const MTypeId BdDouble3SubMultiNode::typeId(0x0007F009);

MObject BdDouble3SubMultiNode::input;
MObject BdDouble3SubMultiNode::inputX;
MObject BdDouble3SubMultiNode::inputY;
MObject BdDouble3SubMultiNode::inputZ;

MObject BdDouble3SubMultiNode::output;
MObject BdDouble3SubMultiNode::outputX;
MObject BdDouble3SubMultiNode::outputY;
MObject BdDouble3SubMultiNode::outputZ;

void* BdDouble3SubMultiNode::creator() {
    return new BdDouble3SubMultiNode();
}

MStatus BdDouble3SubMultiNode::initialize() {
...
MStatus BdDouble3SubMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDouble3SubMultiNode::schedulingType() const {
