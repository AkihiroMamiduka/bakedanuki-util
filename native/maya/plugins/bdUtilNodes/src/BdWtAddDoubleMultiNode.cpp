...
const MString BdWtAddDoubleMultiNode::typeName("bdWtAddDoubleMulti");
const MTypeId BdWtAddDoubleMultiNode::typeId(0x0007F01A);

MObject BdWtAddDoubleMultiNode::input;
MObject BdWtAddDoubleMultiNode::value;
MObject BdWtAddDoubleMultiNode::weight;
MObject BdWtAddDoubleMultiNode::output;

void* BdWtAddDoubleMultiNode::creator() {
    return new BdWtAddDoubleMultiNode();
}

MStatus BdWtAddDoubleMultiNode::initialize() {
...
MStatus BdWtAddDoubleMultiNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdWtAddDoubleMultiNode::schedulingType() const {
