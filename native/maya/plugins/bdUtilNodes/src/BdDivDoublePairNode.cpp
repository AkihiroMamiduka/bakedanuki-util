...
const MString BdDivDoublePairNode::typeName("bdDivDoublePair");
const MTypeId BdDivDoublePairNode::typeId(0x0007F010);

MObject BdDivDoublePairNode::input1;
MObject BdDivDoublePairNode::input2;
MObject BdDivDoublePairNode::output;

void* BdDivDoublePairNode::creator() {
    return new BdDivDoublePairNode();
}

MStatus BdDivDoublePairNode::initialize() {
...
MStatus BdDivDoublePairNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDivDoublePairNode::schedulingType() const {
