...
const MString BdDbl3MultNode::typeName("bdDbl3_Mult");
const MTypeId BdDbl3MultNode::typeId(0x0007F002);

MObject BdDbl3MultNode::input1;
MObject BdDbl3MultNode::input1X;
MObject BdDbl3MultNode::input1Y;
MObject BdDbl3MultNode::input1Z;

MObject BdDbl3MultNode::input2;
MObject BdDbl3MultNode::input2X;
MObject BdDbl3MultNode::input2Y;
MObject BdDbl3MultNode::input2Z;

MObject BdDbl3MultNode::output;
MObject BdDbl3MultNode::outputX;
MObject BdDbl3MultNode::outputY;
MObject BdDbl3MultNode::outputZ;

void* BdDbl3MultNode::creator() {
    return new BdDbl3MultNode();
}

MStatus BdDbl3MultNode::initialize() {
...
MStatus BdDbl3MultNode::compute(
    const MPlug& plug,
...
MPxNode::SchedulingType BdDbl3MultNode::schedulingType() const {
