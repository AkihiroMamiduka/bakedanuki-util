...
assert_type(slider.setValueRequestHandler(lambda value: True), None)
assert_type(slider.editStarted, qt.QtCore.SignalInstance)
assert_type(slider.editFinished, qt.QtCore.SignalInstance)
