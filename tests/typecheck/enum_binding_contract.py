...
def check_contract(owner: qt.QObject, widget: qt.QWidget) -> None:
    ...
    combo = EnumComboBox(binding, widget, wheel_requires_focus=True)
    assert_type(combo.view_model, EnumViewModel)
    assert_type(combo.wheel_requires_focus(), bool)
    assert_type(combo.set_wheel_requires_focus(False), None)
